sub EVENT_SAY {
  if($text=~/hail/i) {
    plugin::Whisper("Brrrrrr!! Grr.. Grreetings. It is freezing out here!!");
  }
}

sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 13241 => 1)) { #Full Bottle of Elixir
    plugin::Whisper("Mmmm.. I feel much warmer. Thank you. You should now find Bryndin McMill. He could use a swig also. I saw him hanging around two other guards.");
    quest::exp(125);
