sub EVENT_SAY {
  if($text=~/Hail/i){
    plugin::Whisper("H-ha.. H-hai.. Hail!! It is v-v-very.. C-cold out here. You sh-sh-should light a c-c-campfire.");
  }
}
...
sub EVENT_ITEM {
  ...
  if ($itemcount{13242} == 1){
    plugin::Whisper("Ahhh!! I feel warm all over. Thanks. You should go give Arnis McLish a drink of this elixir. Last time I saw him he was headed toward Blackburrow.");
    quest::exp(125);
