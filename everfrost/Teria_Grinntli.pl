...
#lore section
      ...
      if($mir_wins < 2) {
         ...
         plugin::Whisper("I spent some time with a good friend of mine, Ubzial Iyeaql, in the Qeynos Hills. He has the whole story about Miragul and is probably better suited to telling you the whole story. I'm certain he would be pleased to share the tale with you. Take care on your journey, friend.");
         $client->Message(15, "You have received an invaluable piece of information!");
         if ($mir_wins >= 16) {
         ...
         # theme done
         plugin::Whisper("I would wager that you know more about those lost dungeons than I do at this stage, $name. I have no more to tell you.");
      }
      else {
