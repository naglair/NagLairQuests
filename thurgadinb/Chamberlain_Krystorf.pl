sub EVENT_SAY { 
if($text=~/Hail/i){
plugin::Whisper("Greetings and welcome to Thurgadin, $name. I am Chamberlain Krystorf and it is my duty to assist the Dain in the management of Icewell Keep and the Royal Court. One could say that Seneschal Aldikar is the Sword of the Dain while I am the Shield, protecting all of his interests and those of the kingdom."); 
}
 }
sub EVENT_ITEM {
if(plugin::check_handin(\%itemcount, 29062 => 4)){
  plugin::Whisper("Well done, $name, the Dain is pleased with your efforts. With a few more brave allies like you, we'll soon be tearing down the halls of Kael Drakkel.");
  ...
  quest::givecash(0,0,0,20);
      ...
      if ($mob) {
         plugin::Whisper("The Dain has been waiting for you, show your shawl to him."); #text made up.
         quest::summonitem(8895);
      } else {
         plugin::Whisper("One moment the Dain has been waiting for you. I will call for him.. oh here he is now, show your shawl to him.");
         quest::summonitem(8895);
