...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount, 20878 => 1)) {
    plugin::Whisper("This does speak highly of you, my friend, an award from Kithicor does not come easy. But I must see more of your skills before I can consider teaching you. Lily's brother Devin is my current pupil - I need you to gather some equipment for me so I can properly train him. I require the following items of you - a smoldering sash, an adamantine ring and a blade forged of electrum. I also need a favor. Take this credit slip to Aanina Rockfinder. She is a merchant from whom I purchased a gift for Lily; it should be ready by now.");
    quest::summonitem(20879);
  }
  if (plugin::check_handin(\%itemcount, 20881 => 1, 20880 => 1, 10151 => 1, 5408 => 1)) {
    plugin::Whisper("You have done well. I sense the one I have been hunting in the distance. As your final test, you must track him down and destroy him.");
    quest::faction( 99, 50);
    quest::faction( 178, 50);
    quest::faction( 43, 50);
    quest::faction( 304, 50);
  ...
  if (plugin::check_handin(\%itemcount, 20882 => 1)) {
    plugin::Whisper("You, $name, are a worthy forester. It brings me great pride to present you this scroll that I have only passed to the finest in all of Norrath. Now you, too, may call the flames.");
