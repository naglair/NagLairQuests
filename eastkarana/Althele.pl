...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    plugin::Whisper("Hello, friend. Beautiful is what I would call such a day normally but lately?");
  }
  if ($text=~/your eyes/i) {
    plugin::Whisper("Yes. I cannot see any longer, my sight long since lost in the march of years. By the blessings of Tunare and Karana, though, I still make myself useful.");
  }
}
...
sub EVENT_TIMER {  
  if ($timer eq "prep") { # gives the last druid, teloa, time to walk to the gathering
    ...
    plugin::Whisper("Great mother of life and father of sky, growth and spirit, Tunare and Karana. Innoruuk once again schemes and we have failed in our duties to protect our land. We give our powers in sacrifice for your help. Heed our call and send us your wisdom.");
