...
sub EVENT_SAY {
  if ($ulevel >= 15) {
    if (defined($qglobals{Wayfarer}) && ($qglobals{Wayfarer} == 1)) { #PC has spoken to home town Wayfarer recruiter but not received Adventurer's Stone
      if ($text=~/hail/i) {
        plugin::Whisper("Welcome stranger. I'm afraid you must answer some questions before I can consider opening our wealth of skill and knowledge to you. First, what does the Wayfarers Brotherhood call the tasks they will ask you to do for them?");
      }
      if ($text=~/adventures/i) {
        $client->Message(15, "You have completed a step toward becoming a great adventurer. Well done!");
        plugin::Whisper("We will reward based on your improving position with the Wayfarers Brotherhood. We keep a certain type of log that records how often and well you help us. What is it called?");
      }
      if ($text=~/favor journal/i) {
        $client->Message(15, "You have completed a step toward becoming a great adventurer. Well done!");
        plugin::Whisper("Who discovered that some treasures have strange magical properties by poking one with his dagger?");
      }
      if ($text=~/morden rasp/i) {
        $client->Message(15, "You have completed a step toward becoming a great adventurer. Well done!");
        plugin::Whisper("Our brilliant magi use a special kind of magic to help teleport us between camps. What is it called?");
      }
      if ($text=~/farstone/i) {
        $client->Message(15, "You have completed a step toward becoming a great adventurer. Well done!");
        plugin::Whisper("Congratulations! I believe now that you are trustworthy enough to take on some of the adventures the Wayfarers Brotherhood have to give. We will be able to continue with our discussions once you complete some adventures. We can also help you with travel between our camps. Be well, fair $name. I'm sure, someday, you will be a great addition to the Wayfarers Brotherhood.");
        quest::faction(356,50); #Wayfarers Brotherhood
        quest::setglobal("Wayfarer",2,5,"F");
        plugin::Whisper("Take this Adventurer Stone with you on your journeys into the dungeons. You will find it useful. Should you lose it somehow, come talk to me and I'll replace it.");
      ...
      if (!plugin::check_hasitem($client,41000)) { #PC does not have an Adventurer's Stone
        ...
        if ($ruj_wins < 2) {
          ...
          plugin::Whisper("Perfect timing. I just put down my lute. Did you know the orcs were created by Rallos-Zek? Oh yes! They were bred for battle. Mighty creatures indeed and very determined. They rely on slaves, whether they be orcs or other creatures. Each orc seemingly belongs to another! Return soon for more $name. I'm sure we will spend a lot of time together!");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($ruj_wins >= 8) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::Whisper("Just finishing up some bread. Let's make this quick. As I said before, each orc belongs to another. We know it's true. This makes the social order of the orcs very simple to follow. Each orc is property, all the way to the highest ranks. The highest ranks relate to one another a bit differently though. Unfortunately, I don't have much more detail that that! I wonder if this will help you defeat them? I don't know that, but I do think knowledge can be a weapon.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($ruj_wins >= 10) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::Whisper("I've come to a part in my song that will have to move the audience to great anticipation! I think I shall use minor chords for that part, hm. So, yes $name, as Rujark face was bandaged until her scars healed, she easily fit among the male goblins. She refrained from speaking and loyally took orders from her battle master. They would often raid the orcs. In every fight, Rujark killed twice as many orcs as the rest. Rumors and fanciful stories began to get passed around the caves under the spine of the world. Must go, $name. I really want to finish this portion of my song.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($ruj_wins >= 40) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::Whisper("Sorry to have ended so abruptly last time, my friend, but my song is better for it! As you most likely surmised, during the meeting of the nobles, Givlikk blurted out that Rujark was female. At first they didn't know what to make of the news. They were not certain Givlikk told the truth. Seeing the true motivations and greed of Rujark's brother, they began to believe him. They did accept that Rujark belonged on the battlefield, but they could not condone a female leading an army to war against the orcs. So, they sent a messenger to tell Rujark the nobles requested her presence. I fear I may need to write two songs to tell this story, my friend.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($ruj_wins >= 50) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::Whisper("Hail $name. Well, the story about Rujark has a bit of a bitter ending which makes it perfect for my song. Over the years that Rujark trained and improved the goblins as the leader in the Rujarkian Hills, her brother Givlikk grew so envious that he became obsessed with ending his sister's life. Givlikk was shamed and punished for trying to sell his sister too. After all, to the goblins, Rujark was very much their divine mother that had been touched by the gods. Rujark kept her brother near to her because she trusted him. Hm, I need to add more notes to this part of the song.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($ruj_wins >= 58) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
      ...
      plugin::Whisper("Well, I must say I'm impressed! You know as much as the Wayfarers Brotherhood about these dungeons that have been uncovered. Nicely done, $name!"); #text copied from Vual's completed MMC line until we know what it should be
    }
      ...
      plugin::Whisper("I see you may have lost or misplaced your emblem. Here, take this replacement."); #Text made up
      quest::summonitem(40999); #Wayfarers Brotherhood Emblem
    }
    else { #PC has not talked to hometown Wayfarer recruiter yet
      plugin::Whisper("You will have to excuse me, I am quite busy. Maybe you can talk to a Wayfarer in your home town?"); #Text made up
    }
  }
  else {
    plugin::Whisper("You will have to excuse me, I am quite busy."); #Text made up
  }
}
