...
sub EVENT_SAY {
  if($text =~ /Hail/i) {
    plugin::Whisper("He.. Hello. Wou.. would you like to buy something? Be quick or [Kizdean] will return!");
  }
  if($text =~ /Kizdean/i) {
    plugin::Whisper("Sshhh..Please..save me. Get..rid..of..him.");
  }
}
