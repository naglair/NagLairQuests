...
sub EVENT_SAY {
   if ($text=~/hail/i && defined($qglobals{GUKtalk}) && plugin::check_hasitem($client, 41000)) {
      ...
      if ($guk_wins == 0) {
         ...
         plugin::Whisper("Right, where was I. Ah yes. Well, as I said, the trolls were meant to be united under the powerful troll they referred to as The Grozmok. The troll shamans believed in the prophecy so completely that they wrote it in blood on a strong stone tablet, which was supposedly blessed by both Innoruuk, the prince of Hate, and Cazic-Thule, the god of Fear. They called this artifact the Grozmok Stone. I understand that it will take a while to absorb all of this information. I'll just leave you to mull over that for now.");
         $client->Message(15, "You have received an invaluable piece of information!");
         if ($guk_wins >= 16) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again."); # red message
         }
         ...
         plugin::Whisper("Greetings once more, $name. Right, more of the story. As you know, when individuals gain celebrity some strange things can happen. As I was saying before, Ykesha came to believe he was The Grozmok. He became insanely paranoid and holed himself up deep within his fortress in the Innothule Swamp, which is now Guk. Seeing the weakness in the Ykesha clan's leadership, the forces of the rival clans moved in to take the Grozmok Stone. The Broken Skull clan won possession of the stone and the Ykesha clan was destroyed.");
         $client->Message(15, "You have received an invaluable piece of information!");
         if ($guk_wins >= 24) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again."); # red message
         }
