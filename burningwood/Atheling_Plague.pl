...
sub EVENT_SAY
{
   ...
   {
      plugin::Whisper("Ahh!! A conversationalist. How good to meet you, Cradossk. Yes. I have heard of you. Go ahead and ask for that which has brought you to my tower and emboldened you to slay my weaker minions.");
   }
   if($text=~/Give me the skull of the sisters of scale/i && $shmskullquest >= 8)
   {
      plugin::Whisper("What a coincidence! I, too, seek a skull. Perhaps you might help me [obtain the skull]. Perhaps then you shall have the skull you desire.");
   }
   if($text=~/I will help you obtain the skull/i && $shmskullquest >= 8)
   {
      plugin::Whisper("I am sure you would not mind removing the head of a scaled mystic. I hope not. There is an old Iksar who once called me slave. Now he shall adorn my wall, mounted on a fine plaque. His name is Digalis. Find him. Do not return until your task is complete.");
   }
}
