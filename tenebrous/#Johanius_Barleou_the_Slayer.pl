sub EVENT_SPAWN {
	plugin::Whisper("Who is the most fearless [vampyre slayer] of your fellowship?");
...
sub EVENT_ITEM {
	if(plugin::check_handin(\%itemcount, 2690 => 1)) {
		plugin::Whisper("On behalf of the citizens of Katta Castellum I extend our gratitude for your assistance in our war with the Coterie of the Eternal Night!");
