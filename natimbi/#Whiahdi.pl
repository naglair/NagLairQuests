...
sub EVENT_ITEM {
  if((defined($qglobals{Soulwhisper}) && ($qglobals{Soulwhisper} == 2)) && plugin::check_handin(\%itemcount, 11174 => 1)) { #Whiahdi's Earthly Possessions
    ...
    plugin::Whisper("Take this weapon for helping me. I regret giving away a weapon of such power, but having it near me was most unsettling. Do not ask how I obtained it.");
...
#    quest::giveAA(5);
    ...
    plugin::Whisper("It is against my better judgment to rebuild this staff, but I agreed to help you, if you helped me.");
