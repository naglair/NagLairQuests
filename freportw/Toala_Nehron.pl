...
sub EVENT_SAY
{
 ...
 if($text =~ /Hail/i)
 {
	plugin::Whisper("I am Toala Nehron. You must be A another Young warrior aspiring to join the ranks of the Steel Warriors. We welcome all who should try. When you [have time] there is A friend of mine I would like you to check on.");
 }

if($text =~ /have time/i && $class == "Warrior")
 {
	plugin::Whisper("I have A friend by the name of [Lenka Stoutheart]. She reported to me that her ship was broken into and someone stold A pouch of hers. Could you go look into it for me. Just tell her Toala sent you . Oh... And pay No mind to the walking mountain by her. That will only be Bronto her navigator. Thanks friend.");
 }
