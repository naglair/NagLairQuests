sub EVENT_SAY {
  if($text=~/Hail/i)
  {
    plugin::Whisper("Aaaarghhh!!.. Buggl n gump.. Figgle and fump..");
  }
...
sub EVENT_ITEM
{
  ...
  {
    plugin::Whisper("Bog n Goo.. Blanket too!!");
    plugin::Whisper("Bog n Goo.. Blanket too!!");
    plugin::Whisper("Hide, hide, safe, cee.. lerk has the clue.. Must travel.. Travel.. Travel.. Tunaria's corridor..");
