...
sub EVENT_SAY
{
    if($text=~/Hail/i)
    {
        plugin::Whisper("Greetings. I am Puab Closk, Master of the Ashen Order.  Our home is your home, friend. Feel free to stay as long as you like.  Learn our ways as many have done in the past.  To fight like the tiger and strike like the cobra are your goals.");
    }
    ...
    if($faction < 4)
    {
        ...
        {
            plugin::Whisper("You desire the treant fists?  I have them and I will offer them to any [skilled monk of the Ashen House].");
        }
    
        if($text=~/skilled monk of the Ashen House/i)
        {
            plugin::Whisper("Then you shall aid our family. My former pupil [Clawfist] has been banished by his people. You will go to him and hand him this token as proof of your origin. He shall be expecting you.");
            # Puab's Token ID-12369
        ...
        if($text=~/Clawfist/i)
        {
            plugin::Whisper("Clawfist is a Kerran, a catman. He braved the dangers of Norrath to reach the Ashen Order. He sought knowledge of our disiples. He learned well.");
        }
    
        if($text=~/Where is Clawfist/i)
        {
            plugin::Whisper("Clawfist has been banished by the Kerrans of Odus. Where they have sent him I am unsure");
        }
    }
}
...
sub EVENT_ITEM
{
    ...
    {
        quest::ding();
        plugin::Whisper("You have performed a great service to one who is your brother. Your loyalty shines brightly, as does your skill. Take the treant fists. They are yours now.");
        # Treant Fists ID-12344
