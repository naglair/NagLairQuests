...
sub EVENT_SAY
{
    ...
    if($text=~/Hail/i)
    {
 plugin::Whisper("Ah. hello there. friend!  Me an' Rebby here. we're a just couple o' regular merchants.  Though we've got nothin' to sell right now. we'd gladly take any donations.  Them's the breaks. I suppose.");
    }
}
...
sub EVENT_ITEM
{
 ...
 plugin::Whisper("Please make sure that Harkin Duskfoot gets this right away...
if you lose it . it could mean both of our heads. ");
 }
 else
 {
 plugin::Whisper("Thanks for the donations $name.");
 }
