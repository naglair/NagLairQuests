...
sub EVENT_ITEM {
  if($class eq "Warrior") {
    ...
    plugin::Whisper("Only members of the guild may do these quests.");
    plugin::return_items(\%itemcount);
  }
}
