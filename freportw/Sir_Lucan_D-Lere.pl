...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount, 13926 => 1 )) {
    plugin::Whisper("Thank you for your loyalty");  #need live text and reward
