...
sub EVENT_SAY{
  if ($text=~/hail/i){
    plugin::Whisper("Oh, hello there. Sorry I didn't notice you before I was thinking of an [old friend]. This used to be his room. I guess no one else has been assigned to these quarters.");
  }
  if ($text=~/old friend/i) {
    plugin::Whisper("His name was Bregun Dorey. What a funny little halfling he was. He had a good heart and worked hard. That is up until one day he just started acting odd, very nervous like he was hiding something. Then all he would talk about was Bixie Treats and then show off some weird heirloom charm bracelet. His time for the question came and due to his odd behavior he was sent to Marus Seru. I sure wish I knew how he was doing.");
  }
}
sub EVENT_ITEM{
  # receive bixie charm
  if (plugin::check_handin(\%itemcount,29852=>1)) {
    plugin::Whisper("Bregun is still alive!? Amazing, I thought in his fragile state he wouldn't last long in Marus Seru or the Lair of the Netherbians for that matter. Here, before anyone hears us talking, take this note to him. I believe he was onto something big and I must know what it was.");
