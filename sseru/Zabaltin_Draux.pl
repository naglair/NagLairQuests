...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 14058 => 4)) {
    ...
    plugin::Whisper("Ha! His gaudy ring! You have done well young rogue. Perhaps you would be an asset to the Eye after all. You can have his nasty ring back, I am sure that it is worthless. Darn thing weighs as much as a Netherbian and is twice as ugly!");
