sub EVENT_SAY
{
	if($text=~/hail/i)
		{
		plugin::Whisper("Welcome to my home, my apologies for being untidy. I have been preoccupied with the thought of my brother lately. I love Seru and I love this town do not get me wrong, but it still makes me sad to see someone cast out. He was forced to submit to the Question when he was found to be supplying [Recuso] with food, water, and medical supplies. Because of the power of the question, they soon found this out, and now he has to live amongst the very people he was helping.");
		}
	if($text=~/Recuso/i)
		{
		plugin::Whisper("Yes, they are a landless people, usually found to be in Marus Seru."); #Text made up
		}
}
