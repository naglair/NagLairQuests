...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount,29803=>1)) {
    plugin::Whisper("Well it's about time Barkhem got around to us, and he couldn't even be bothered to come himself. Please get this back to me as soon as you can... you do know that we are here to guard the city, right?"); 
  ...
  if (plugin::check_handin(\%itemcount,29808=>1)) {
    plugin::Whisper("Thank you very much $name, and I must apologize for the way I spoke to you earlier. We just got word of some [poachers] out in the Thicket, they really get me angry. In any case, you have done a fine job, worthy of Barkhem himself.");
