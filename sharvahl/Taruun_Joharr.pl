...
if(plugin::check_handin(\%itemcount,3466=>1)){
   ...
   plugin::Whisper("I suppose assumin' you were sent here by Harbin isn't too far from the reality
...
if(plugin::check_handin(\%itemcount,5563=>1)){
   ...
   plugin::Whisper("This sandwich is almost worth the wait.");
   quest::emote("rubs the crumbs from his mouth");
   plugin::Whisper("hope that you've been practicin' with those daggers. Elder Ternq came by while
...
if(plugin::check_handin(\%itemcount,5568=>1)){
   plugin::Whisper("Very good, $name! Elder Ternq will be very pleased with the results of your
