...
if(plugin::check_handin(\%itemcount,5564=>1)){
   plugin::Whisper("I see that Joharr introduced you to our cavern dwelling friends. This report
...
if(plugin::check_handin(\%itemcount,5566=>1, 3465=>1)){
   plugin::Whisper("Very well done,$name. Take this cloak and wear it with pride. May it keep your
...
if (plugin::check_handin(\%itemcount, 5558 =>1, 6158 =>1 )) {
  plugin::Whisper("Well done.  Take this new cloak and wear it with pride.  You can now be called journeyman!");
