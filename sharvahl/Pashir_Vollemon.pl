...
if($text=~/hail/i){
	plugin::Whisper("Greetings. If you follow the ways of the [berserker], I can perhaps be of assistance.
 If not, then I do not have much to say to you.");
}
if($text=~/I am a berserker/i){
	plugin::Whisper("I thought I saw the gleam of rage in your eyes. If you are truly dedicated to our way 
...
if($text=~/armor/i){
	plugin::Whisper("It is a special suit of armor that does not constrict our ability to fight. It is not
...
if($text=~/ready/i){
	plugin::Whisper("Take this assembly kit. With this kit, you will be able to combine the various components
...
if($text=~/boots/i){
	plugin::Whisper("To craft Savageclaw boots, you must obtain two small pieces of ore, one low quality
...
if($text=~/leggings/i){
	plugin::Whisper("To craft Savageclaw Leggings, you must obtain two small pieces of ore, one low quality
...
if($text=~/bracers/i){
	plugin::Whisper("To craft a Savageclaw Bracer, you must obtain one small piece of ore, one shadeling silk,
...
if($text=~/coif/i){
	plugin::Whisper("To make a Savageclaw Coif, you must obtain two small pieces of ore, one low quality
...
if($text=~/gorget/i){
	plugin::Whisper("To make a Savageclaw Gorget, you must obtain one small piece of ore, one medium
...
if($text=~/gloves/i){
	plugin::Whisper("To make Savageclaw Gloves, you must obtain one small piece of ore, one needle thin claw,
...
if($text=~/tunic/i){ 
	plugin::Whisper("To make a Savageclaw Tunic, you must obtain two small pieces of ore, one medium quality
...
if($text=~/task/i){
	plugin::Whisper("If you are truly ready, I will need you to travel to the Hollowshade Moor and bring me
...
if(plugin::check_handin(\%itemcount,30660=>4)){
	plugin::Whisper("Congratulations, $name!  You are truly on your way to being a legendary berzerker.  Use
