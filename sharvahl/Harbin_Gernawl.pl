...
plugin::Whisper("Hello $name. It is my pleasure to meet you."); }
...
plugin::Whisper("Your progress will be rewarded, $name. Soon all will recognize you as a recruit of the cunning Taruun! Speak with Merchant Rytan. When he is through with you return to me with his seal, your buckler, your initiate's cloak and this seal.");
quest::summonitem("3460");
}

elsif (plugin::check_handin(\%itemcount, 3460 => 1, 3464 => 1,  2878 => 1, 3456 => 1)) {
plugin::Whisper("Your hard work is pleasing to the Taruun, $name, which now accepts you as an official recruit. Wear this cloak with pride. Your buckler has been treated with a special epoxy and should protect you more effectively now. Show the buckler to Taruun Joharr and he will continue to guide you on your sacred path. I sense a strong spirit in you, young one. May it guide you to greatness!");
