...
{
  if($text=~/Hail/i){
    plugin::Whisper("Hello. $name. I am Mignah. a humble acrylia specialist. If you have a form of acrylia that merchants will not buy please hand it to me and I will pay you whatever it may be worth.");
  }
  if($text=~/acrylia slate/i){
    ...
    plugin::Whisper("This may hurt a bit, but it'll heal.");
