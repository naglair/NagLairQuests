...
if($text=~/hail/i){
plugin::Whisper("Hello $name, I trust all is well with you today. Come in and have a look around, just
...
if($text=~/citizen/i){
plugin::Whisper("Wonderful! Please, show me your acrylia slate and I'll disclose my errand.");
}

if($text=~/grimling fang darts/i){
plugin::Whisper("A grimling fang combined with a bone shard will make a dart slightly better than the
 xakra tooth dart, which will also sell for slightly more.");
}

if($text=~/grimling fangs/i){
plugin::Whisper("The grimlings are the beings who attack our people around the Acrylia mines. They have
...
plugin::Whisper("Rockhopper talon darts are slightly better than grimling fang darts and will sell for
...
plugin::Whisper("Here's my dilemma, I am low on darts to sell and I need to replenish my supply.
...
quest::exp(1000);
plugin::Whisper("Here are the three darts I promised you and a seal of mine.
...
quest::exp(1000);
plugin::Whisper("I thank you for your continued assistance, $name. Here is a fletching tool that will enable
...
plugin::Whisper("I assume you are ready to make more challenging darts. Very well, attach this shaft to your
...
plugin::Whisper("Your skill is increasing rapidly, $name. Here is a hook to place on the end of your crafting
...
plugin::Whisper("Here is a special handle to attach to your crafting tool. This is the final improvement
