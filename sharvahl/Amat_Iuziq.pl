...
if (plugin::check_handin(\%itemcount, 6265 =>1 )) {
  plugin::Whisper("Ah so there you are we've been expecting you. Take this spear and go speak with Arms Historian Qua. He can provide further instructions.");
  quest::summonitem(6147);
}
if (plugin::check_handin(\%itemcount, 5544 =>1, 6268 =>1 )) {
  plugin::Whisper("Well done #name!  You have proven your worth and can now be considered a Dar Khura Journeyman!");
