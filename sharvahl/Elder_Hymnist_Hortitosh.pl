...
sub EVENT_SAY { 
if($text=~/Hail/i){
plugin::Whisper("Hail. are you here to assist with something specific or just looking for something to do.");}
...
if(($text=~/cloak/i) && ($qglobals{Shar_Vahl_Cit} == 7)){
  plugin::Whisper("Someone found this under a table at the one of the pubs. Try not to lose it this time.");
  quest::summonitem(2878);}
  if ($text=~/essence of sonnet/i) {
  quest::emote("stops what he is doing and looks at you, most surprised");
    plugin::Whisper("An essence of sonnet? I have never produced such a thing my friend, though the fact that you would even request one from me is very flattering.' His eyes leave your face and settle off in the distance somewhere as he continues, 'I was present once when one was created... it was beautiful. I was only a child, but there was no mistaking the significance. Oh how I would love to produce such a thing myself- an accomplishment without peer for one of my art. They say that the inspiration must be genuine, should you know of something that could inspire me so then by all means, I will see if I have an essence of sonnet within me.");
  }
}
sub EVENT_ITEM { 
if (plugin::check_handin(\%itemcount, 18324 =>1 )) {
  plugin::Whisper("Thanks, $name!  That is a wonderful story of inspiration.");
  quest::summonitem(5991);
}
if(plugin::check_handin(\%itemcount,18552 => 1)){
plugin::Whisper("Our newest instrumentalist arrives! You have grown strong in the safety of our city and it is time now for you to repay our society. The Jharin. keepers of our history. accept you and deem you to be worthy of our training. Take this application to Registrar Bindarah and return to me with proof of your citizenship.");
plugin::Whisper("I know that you may be nervous right now... after all. this should be a very exciting first step for you.  If you happen to get lost while looking for the registrar. just ask one of the other citizens or guards for directions.  They will most likely know where to find the place or person that you are looking for.");
...
plugin::Whisper("This item. by itself. means nothing to me.");
plugin::Whisper("$name. citizen of Shar Vahl. accept this cloak as a symbol of your loyalty and service to our noble people. It will grow with you. young initiate. and like you it has incredible potential. Present your slate of citizenship to Gherik and he will guide you through your early training. May your songs inspire us all!");
quest::setglobal("Shar_Vahl_Cit",7,5,"F");
quest::summonitem("2878");
} 
if(plugin::check_handin(\%itemcount, 3920=>1)){
plugin::Whisper("These are finely crafted indeed, $name. Merchant Fahaar told me you were quite the prodigy,
