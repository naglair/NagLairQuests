...
sub EVENT_SAY {
  ...
  if(($text=~/certificate/i) && ($qglobals{Shar_Vahl_Cit} == 2)){
    plugin::Whisper("Luckily for you, someone found this blowing around the plaza.");
    quest::summonitem(2874);}
  if(($text=~/note/i) && ($qglobals{Shar_Vahl_Cit} == 4)){
    plugin::Whisper("Luckily for you, someone found this stuck in a bush.");
    quest::summonitem(18299);}
  if(($text=~/application/i) && ($qglobals{Shar_Vahl_Cit} == 6)){
    plugin::Whisper("Luckily for you, someone found this on the floor in the bakery.");
...
sub EVENT_ITEM
{
  ...
  {
    plugin::Whisper("Young $name, I will be happy to process your registration for you. While I etch your name on our people's book of records I will require you to run a couple of errands. Take this certificate to the tax collector and obtain his seal. While you're out doing that, have Mignah create your personal Acrylia slate for you. Bring both the seal and the slate to me as soon as you can.");
  ...
  {
    plugin::Whisper("Ahh, there you are. I was about to send someone looking for you. Everything seems to be in order here, only one task remains. You must gain audience with the king and swear fealty to his highness by handing him this document. Return to me when this is done.");
  ...
  {
    plugin::Whisper("Well done, $name, I am honored to be the first to welcome you to citizenship of Shar Vahl! May you serve our society as well as it serves you. Return to your guildmaster and present both the slate and the application to him. The acrylia slate shall henceforth serve as proof of your citizenship.");
    ...
    plugin::Whisper("Oh, by the way, be careful with this as it will be important for recording your service to our society. If you should somehow lose it, ask me about your slate and I will issue you a new one.");
