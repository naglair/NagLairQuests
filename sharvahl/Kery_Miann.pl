sub EVENT_SAY {
  if ($text=~/hail/i) {
    plugin::Whisper("Greetings. May I help you?");
  }
}

sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 5571 => 1)) {
    plugin::Whisper("Where did you get this?! I have been looking for just this kind of map for a very long time! Hmmm, I know, how about I show you how to improve those claws of yours!");
    plugin::Whisper("In order to improve them, I need you to take this Stitching Pack, unless you already have one, and this stone and make two leather straps. Once you have them, give me them along with your claws and I will work my magic!");
    plugin::Whisper("Use only the very best rockhopper hide you can find along with that stone, and you will have those strips in no time!");
    ...
    plugin::Whisper("There you go! I see you had little trouble gathering the straps. Perhaps you could help a friend of mine in Hollowshade Moors. Here, take this note and deliver it to Rittuh Purric. She should be at one of the outposts, though I couldn't tell you which one. Good luck, $name!");
    ...
    plugin::Whisper("You have done well, youth.' She says as she picks up what appears to be a new cloak. She hands you the cloak and smiles. 'Your life as a member of our sect may not always be pleasant, but take comfort in the fact that you are performing a great service to your people. Walk the path of the Khati Sha with pride and one day may you see his face as I have. Now, seek out Kaam Rahiir in the libraries. Show him your claws and he will be able to assist you in imbuing them magically. Take care.");
