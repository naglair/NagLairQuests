...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 5574 => 1, 5575 => 1)) { #Reinforced Khati Sha Claw, Reinforced Khati Sha Claw
    ...
    plugin::Whisper("I see that you've been getting some use out of these things. They are crude, but they seem sturdy enough.");
    quest::emote("says as he returns the claws. He hands you a small bag and continues.");
    plugin::Whisper("I hope the combat you've seen has made an impression on you, young friend. Combat is not pleasant, but it is often unavoidable. We are explorers and conflict often breeds in the unknown. Learn from each encounter and you are less likely to be trapped by conflict in the future.");
