...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 52113 => 1)) { #Misshapen Cragbeast Flesh
    ...
    plugin::Whisper("Do you see now, $name? Do you understand?");
  ...
  if (plugin::check_handin(\%itemcount, 52119 => 1 )) {
    ...
    plugin::Whisper("Oh my. She . . . killed me, didn't she? Krisz slew me in front of everyone I knew and loved. Her fate is entwined with mine no longer. I will sing one last song and then leave this world. Thank you for avenging me, $name. The leather choker around Krisz's neck may prove of some use to you.");
    quest::exp(50000);
