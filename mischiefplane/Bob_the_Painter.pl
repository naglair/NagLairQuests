...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 18008 => 1)) {
    ...
    plugin::Whisper("Ay!!! this is poifect! 'ere take this pot o' gold. It's empty at the moment. Go ask my brother Vinny about the pot and mebbe he'll have a clue how ta get it full agin.
");
  }
  else {
