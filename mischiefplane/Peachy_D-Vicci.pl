...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 9504 => 2)) {
    ...
    plugin::Whisper("Here ya go! Enjoy it. Come back soon. Just a warning though, I cant give you a box that you already have. There isn't enough for everyone you know!");
  }
  else {
