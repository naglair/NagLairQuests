...
sub EVENT_SAY {
 if($text=~/hail/i){
  ...
  plugin::Whisper("While your choice, that attitude will get you nothing but a great deal of grief and an eventual death. I urge you to reconsider your decision to come into this vast lair without some kind of true commitment, as flights of fancy often end up poorly.");
  }
 elsif($text=~/adventuring/i){
  plugin::Whisper("Excellent, we can always use more of your type around, to perpetuate the life, if nothing else. Take care through this den though, as there are a great many things that would just as soon see you as a floor decoration than a wandering buccaneer, especially the four ancients at the end of it. From my own experience, I have found that the [larger golems] seem to be in charge and may instruct the others to do their bidding, which may or may not include the destruction of any invaders.");
  }
 elsif($text=~/larger golems/i){
  plugin::Whisper("I can assure you that if you proceed beyond these doors, you will find out for yourself. I will tell you though that there is a great master of the guardians that walk these halls, and he is aptly named as well, for he will instruct those below him to assist him should trouble engulf him. For your own sake, I hope you are prepared for the immensity of the situation ahead. If you are not, then this adventure is not for you, as it was not for me. What lay beyond was the death of me, not so long ago, and that is why I am now a permanent resident to these frosty walls. They do tell [stories] though. . .");
  }
 elsif($text=~/stories/i){
  plugin::Whisper("There is a story of a [short fellow] who came through here looking for grand adventures and seeking grand treasures, but all he found was grand pain and suffering. There is a lost love story of a [man and a woman] who came here in search of a friend, only to be sucked into the traps that litter the grounds beyond. Theirs is a most sad tale, wrought with pain and suffering, and whose story isn't yet completed. Then. . . then there is your story. Your story is what you make of it, and I hope for your sake you choose the pages of your adventure well. Look to the halls of this debilitating dungeon for answers you seek and perhaps you will find more than you were searching for.");
  }
