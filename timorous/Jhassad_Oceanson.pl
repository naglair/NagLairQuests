...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 28048 => 1, 28049 => 1, 28050 => 1)) { #Orb of Clear Water, Orb of Frozen Water, Orb of Vapor
    ...
    plugin::Whisper("The Avatar of Water approaches. You must hand him the Orb of the Triumvirate and it will be decided if it is your destiny to wield the Nem Ankh Sprinkler."); 
