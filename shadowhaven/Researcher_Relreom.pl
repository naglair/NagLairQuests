...
sub EVENT_ITEM {
 if(plugin::check_handin(\%itemcount, 48104 => 1, 48105 => 1, 48106 => 1, 48107 => 1)){
  # Monk Epic 1.5
  plugin::Whisper("You have returned with the pages but I am afraid I have nothing to reward you with but my thanks. I am sure Tomekeeper Danl will be able to give you something though if you want to bring them to him. Yes! That is what we will do. Take the pages back and give them to Tomekeeper Danl he will be overjoyed to have them back!");
