...
sub EVENT_SAY {
  ...
  if ($text=~/report/i) {
    plugin::Whisper("I have a report that I collect every few days from my first Lieutentant Broansas. This report contains information about each guard, his performance, and usually notes on suggestions upon how to limit the number of smugglers passing through our town. However, Lieutenant Broansas is currently on assignment investigating a smugglers ring. I need someone to retrieve his reports of the latest information that he gathered for me. Will you [retrieve the daily reports]?");
  }
  if ($text=~/retrieve the daily reports/i) {
    plugin::Whisper("Many thanks, $name. The last I heard from Broansas he was heading for the Dawnshroud peaks. Please seek him out there and present him with this notorized letter so that he will know that I have sent you. Return to me with his report as soon as you can. I await your return.");
