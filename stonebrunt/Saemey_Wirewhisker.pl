...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 6970 => 1, 6971 => 1, 6972 => 1)) { #Valley Spiritling Stone, Jungle Spiritling Stone, Mountain Spiritling Stone
    ...
    plugin::Whisper("I require a Soul Orb and Kejek Spirit Dust in order to perform the ritual that will free the imprisoned souls.");
