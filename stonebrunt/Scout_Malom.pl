  ...
  if (plugin::check_handin(\%itemcount, 9031 =>1 )) {
    ...
    quest::emote("Something glows brightly from high above the falls.");
      ...
      if (plugin::check_handin(\%itemcount, 9040 =>1 )) {
        plugin::Whisper("Great work, friend. Take this totem and place it in the case that you were given in Shar Vahl. Do not unwrap the totem and be quick in your pursuit of the others. Once you have all of the totems, please seal the case and return it to Shar Vahl. I can only hope that you will get to all of the spirits in time. Take care, friend.");
