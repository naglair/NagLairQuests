...
sub EVENT_ITEM {
 if (plugin::check_handin(\%itemcount, 6975 => 1)) {
  plugin::Whisper("I thought the kobolds would have you for dinner, but you made it back.");
  ...
  plugin::Whisper("Take this vial back to Jali. I pray to the Titan Spirits that it works.");
