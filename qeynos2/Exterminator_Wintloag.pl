sub EVENT_SAY {
  if($text=~/Hail/i){ #Start of Exterminate the Vermin Quest (Scripted By: Fatty Beerbelly)
    plugin::Whisper("I really can't believe it, $name. I have seen Qeynos in bad shape but this is unbelievable! The rodents have practically taken over our city. If you see some of them running around, keep the rat whiskers, and I will reward you for every four you bring me.");
  }
}
...
sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 13071 => 4)){ #End of Exterminate the Vermin (Scripted By: Fatty Beerbelly)
    plugin::Whisper("Here is something for you, $name. I certainly appreciate your help with our pest problem here. Great work.");
