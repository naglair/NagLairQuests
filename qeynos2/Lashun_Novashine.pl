...
sub EVENT_WAYPOINT_ARRIVE {
  if($wp == 16) {
    plugin::Whisper("Greetings, people of Qeynos! Are you lost? Has the chaotic life of an adventurer left you empty and alone? Seek redemption in the glorious light of the Prime Healer. Only through Rodcet Nife and the Temple of Life will you find true health and salvation.");
  }
  if($wp == 28) {
...
sub EVENT_SAY {
  if($text=~/hail/i) {
    plugin::Whisper("Well met, $name. My name is Lashun Novashine and I am a humble priest of Rodcet Nife, the Prime Healer. I wish to spread His word to every corner of Norrath. My job gets more difficult each day with so many so willing to take lives rather than preserve them.");
  }
}

sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 13073 => 4)) { #Bone Chips (4)
    plugin::Whisper("Very well, young one. May the light of the Prime Healer wash away your scars.");
    ...
    if($ItemCount == 1) {
      plugin::Whisper("Ah good, I see you seek healing. But you must offer the remains of one more minion of Bertoxxulous before Rodcet will deem you worthy.");
    }
  }
    ...
    plugin::Whisper("Thank you for the donation to the Temple of Life. May Rodcet Nife cleanse your body of all ills.");
    $npc->CastSpell(17,$userid); #Light Healing
    quest::faction(257,1); #Priests of Life
    quest::faction(183,1); #Knights of Thunder
    quest::faction(135,1); #Guards of Qeynos
