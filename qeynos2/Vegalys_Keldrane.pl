...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 2173 => 1)) { #Cracked Corrupt Guard Helm
    ...
    plugin::Whisper("Very well, here is the briefing document. Please read it very carefully. I wish you luck friend, this mission could prove to be dangerous.");
