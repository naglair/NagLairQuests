...
{
 if($text=~/Hail/i){
 plugin::Whisper("Welcome to Crow's! If you're thirsty, we have a fine selection of brews and ales.");
}
 }
sub EVENT_ITEM {
if(plugin::check_handin(\%itemcount, 17600 => 1)){
      plugin::Whisper("What are you? The Rat's new bag man? Peh, he is useless. That bum drinks any gold he gets. Here ya go, kid!");
