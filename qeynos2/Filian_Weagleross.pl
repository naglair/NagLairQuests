sub EVENT_SAY { 
if($text=~/Hail/i){
plugin::Whisper("Pleased to meet you $name. I am Filian Weagleross High Priest of the glorious Rodcet Nife! I have recently taken upon some very [important duties] here in our temple so if your business is not urgent please excuse me.");
}

if($text=~/important duties/i){
plugin::Whisper("My important duties are training the new recruits of our temple. It can be quite perilious for a new adventurer in our world today as I am sure you will soon find out. The Temple of Life is dedicated to ensuring that once our young ones leave our home to venture out into Norrath they are ready for whatever might present itself. If you are a [young cleric of Rodcet] then we can begin your training at once.");
}

if($text=~/young cleric of rodcet/i){
plugin::Whisper("Your training will be very important to your development as a Cleric of Rodcet Nife so I do hope you will remain focused at all times. Your exercises will take you all over your hunting area and our city to specific [magical items].");
}

if($text=~/magical items/i){
plugin::Whisper("The magical items you need to collect will be necessary for creating your magical armor will be placed in this Prime Healers Mail Kit that will create armor materials.When you are ready to collect the items necessary for creating a piece of armor all you must do is tell me what armor piece you [want] to craft. I can present you with the recipes and armor molds for Prime Healer Initiate [Helms]. [Bracers]. [Armguards]. [Boots]. [Greaves]. [Gauntlets] and [Breastplates].");
quest::summonitem(17267);
}

if($text=~/i want to craft helm/i){
plugin::Whisper("To create your helm material you will need to combine 2 Bricks of Crude of Iron Ore. 1 Piece of Rat Fur and 1 Chunk of Meat in your assembly kit. Once you have created the proper material take it to a forge along with this mold to fashion your very own Helm of the Prime Healer Initiate.");
plugin::Whisper("To create your helm material you will need to combine 2 Bricks of Crude of Iron Ore. 1 Piece of Rat Fur and 1 Chunk of Meat in your assembly kit. Once you have created the proper material take it to a forge along with this mold to fashion your very own Helm of the Prime Healer Initiate.");
quest::summonitem("22610");
}

if($text=~/i want to craft bracers/i){
plugin::Whisper("To create your bracer material you will need to combine 1 Brick of Crude of Iron Ore. 1 Brown Bear Femur and 1 Giant Rat Ear in your assembly kit. Once you have created the proper material take it to a forge along with this mold to fashion your very own Bracer of the Prime Healer Initiate.");
