...
sub EVENT_SAY {
   if($text=~/Hail/i) {
      plugin::Whisper("Hello, my name is Phin. Practice, practice, practice.. That's my motto. It is my responsibility to train our members, and help them to advance their skills and abilities. I also reward our members with colored [Headbands] for completing certain tasks.");
   }
   elsif($text=~/Headbands/i) {
      plugin::Whisper("Yes, I give the [White, Yellow, and Orange Headbands] to our newer members, and Togahn gives out [Red, Purple, and Blue Headbands] to our elder members.");
   }
   elsif($text=~/Tomer Instogle/i) {
      plugin::Whisper("Tomer? I think Seta needs someone to go find him... Go ask her.");
   }
   elsif($text=~/Konem Matse/i) {
      plugin::Whisper("Konem was sent to retrieve [supplies] and has not returned.");
   }
   elsif($text=~/supplies/i) {
      plugin::Whisper("Take this message to Konem and find out where my supplies are.");
      # Message to Konem ID-18921
      quest::summonitem("18921");
   }
   elsif($text=~/gnoll/i) {
      plugin::Whisper("Those vile creatures are constantly attacking our city.. and often killing innocent citizens. It is our duty to help defend Qeynos from their vicious raids.");
   }
   # Requires Kindly Faction for Headband Quests
   elsif($faction <= 3) {
      if($text=~/white headband/i) {
         plugin::Whisper("That is our training headband.. Beginning students can earn this by slaying four [gnoll] pups, and bringing their scalps back to me.");
      }
      if($text=~/yellow headband/i) {
         plugin::Whisper("This is awarded to our students for helping clear out the evil that inhabits the old ruins of the Qeynos Hills. Just bring me back three putrid rib bones as proof of your good deeds and turn in your [training headband], and then I will give you the yellow headband.");
      }
      if($text=~/orange headband/i) {
         plugin::Whisper("This is a difficult award to obtain. The city of Qeynos is, as you know, under constant attack by the gnolls of Blackburrow. The Silent Fist Clan rewards its members who venture deep into this gnoll stronghold and bring swift justice to these vile creatures. Please return two Blackburrow gnoll pelts - make sure they aren't ruined - and a Blackburrow gnoll skin as proof of your noble actions. Also, turn in your [yellow headband], and then I shall give you the orange one. Good luck.");
      }
   }
   else {
...
sub EVENT_ITEM {
   ...
   if($faction <= 3 && plugin::check_handin(\%itemcount, 13789 => 4)) {
      quest::ding();
      plugin::Whisper("Good job, $name, keep up the good work! Here is your white training headband. Wear it with honor, and make Lu'Sun proud.");
   ...
   # Has the items but not the required faction for the White Headband
      ...
      plugin::Whisper("Good.. the more of these vile dogs we slay, the safer the citizens of Qeynos will be.");
      # Silent Fist Clan faction
      quest::faction("300","2");
      # Guards of Qeynos faction
      quest::faction("135","2");
   ...
   # We don't need to check faction again because they must have the White Headband
      ...
      quest::ding();
      plugin::Whisper("Good work.. and, as promised, here is your reward. It is an honor to present this yellow headband to $name, for recent acts of courage and heroism, on behalf of the Silent Fist Clan.");
   ...
   # Orange Headband ID-10112 requires two Blackburrow Gnoll Pelt ID-13027, one Blackburrow Gnoll Skin ID-13028 and the Yellow Headband ID-10111
      ...
      quest::ding();
      plugin::Whisper("It is an honor to present the orange headband of the Silent Fist Clan to one of our finest members, $name the mighty!");
