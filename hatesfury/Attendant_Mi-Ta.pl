...
sub EVENT_SAY {
 if($text =~ /Hail/i) {
	plugin::Whisper("Thieves! Thieves aboard the ship! Return what you have stolen and I promise, your death will be swift.");
 }
 if($text =~ /What have I stolen/i) {
	plugin::Whisper("Do not try my patience dryfoot, the Captain and his hands will soon return. If he finds his things missing there will be death, he has been in foul spirits since losing the Stone. Your death if you are found with them. You did steal them? Admit it!");
 }
 if($text =~ /I did not steal/i) {
	quest::emote("gets a suspicious look in his eyes");
	plugin::Whisper("Ok, I will be honest. I lost the Captain's trinkets. If you help me find them before his return, I am sure I can track something down that will not be missed. I have access to the treasure room, and there is much there in the way of spoils.");
 }
  if($text =~ /I will help you/i) {
 	...
 	plugin::Whisper("Excellent! It is not much, I was below deck with his compass, spyglass, ocean map, and a bottle of his favorite spirits. I would be in your debt should you find them for me.");
  }
}
