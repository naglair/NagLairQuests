...
plugin::Whisper("Greetings, $name. I'm troubled that we have not yet been able to fully clear out the remaining Grimlings from the camps they still hold, I know [which camps] we have to assault to proceed, and it'll be just a matter of time before we can move forth with our plans.");
}
if ($text=~/which camps/i && $signal == 802){
plugin::Whisper("My scouts report the following to me. . .");
plugin::Whisper("We have not yet cleared camp one, to the North, of enemy forces.");
plugin::Whisper("We have not yet cleared camp two, to the North, of enemy forces.");
plugin::Whisper("We have not yet cleared camp three, to the West, of enemy forces.");
plugin::Whisper("We have not yet cleared camp four, to the West, of enemy forces.");
plugin::Whisper("We have not yet cleared camp five, to the West, of enemy forces.");
plugin::Whisper("We have not yet cleared camp six, to the West, of enemy forces.");
plugin::Whisper("We have not yet cleared camp seven, to the Northwest, of enemy forces.");
plugin::Whisper("We have not yet cleared camp eight, along the river to the North, of enemy forces.");
plugin::Whisper("We have not yet cleared camp nine, to the North, of enemy forces.");
}
if($text=~/Hail/i){
plugin::Whisper("Greetings. $name. Are you here to serve in the war against the grimling horde?");
}
if($text=~/i am here to serve in the war/i){
plugin::Whisper("As you probably know, we've been battling the grunts for nearly a generation now. They have proven to be a challenging opponent. We've inflicted great casualties upon their kind in this war, yet somehow, they seem to grow even more numerous. Barring some miracle, they will become a serious threat to Shar Vahl very soon. One remaining strategy has a chance of bringing us victory, but none have met the requirements for its implementation.");
}
if($text=~/what requirements/i){
plugin::Whisper("Our intelligence has provided us with some information about the enemy. They blindly follow a being they refer to as 'the master'. Our high spiritists have sensed a powerful presence from the caverns beyond our mines, but only those who possess a special key can venture there. None who have obtained the key and ventured into the caverns have been seen alive again.");
}
if($text=~/what key/i){
plugin::Whisper("The grimling high commander holds half of a magical acrylia obelisk that will transport the wielder to their master's stronghold. I have slain the high commander who held the other half of the obelisk and I have the knowledge of it's construction. I will only give it to one who has proven to be a powerful soldier, for nothing less would stand a chance against the enemy ruler.");
}
