...
sub EVENT_SAY {
  if($text=~/hail/i) {
    plugin::Whisper("Shhh, not so loud. I have heard stories of werewolves in this area..."); #Text made up
  }
}

sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 15809 => 1)) { #Note to Yuanda
    plugin::Whisper("So you are working for Geboron? Yes I have seen the paladins and the staff they were guarding. They passed through here just one day ago. From what I have been told, they were attacked by a pack of werewolves. All of the paladins were killed and one of the werewolves took the staff. If you want the staff you will need to find these werewolves. Oh, no! Here they come now! I am getting out of here!");
    quest::spawn2(12183, 0, 0, $x-18, $y-35, $z,   128); #a snarling werewolf (normal)
    quest::spawn2(12183, 0, 0, $x+18, $y-35, $z,   128); #a snarling werewolf (normal)
