...
sub EVENT_SAY {
 if($text =~ /Bloodsaber/i) {
	plugin::Whisper("Of course I'm a Bloodsaber, you fool! I've just returned from the Plains of Karana where I was reveling in the glory of the Plaguebringer. Now then, since I see that this foolish investigator is with you, I suppose you want me to sign a confession document or something like that? Well, let's have it then!");
	#should drop head
 }
}
...
sub EVENT_DEATH_COMPLETE {
	plugin::Whisper("You...can not...defeat us all...");
