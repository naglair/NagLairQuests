...
sub EVENT_SAY {
	if($text=~/Hail/i)   {
		plugin::Whisper("Hail, $name! Are you new to Qeynos? If you are, I highly recommend stopping by the Lion's Mane Tavern for the best ale in Antonica. Oh, did I mention that my brother Earron is the master brewer there? Tell him [Kwint sent] you.");
	}
}

sub EVENT_ITEM {	
	if (plugin::check_handin(\%itemcount, 18821 => 1)) {#Scrap of Parchment
		plugin::Whisper("Hey. Thanks! Sorry about that 'he's my brother' bit but I am sure you had a good time at the Lion's Mane anyway. I sure didn't lie to you about the quality of the ale there.");
