...
sub EVENT_ITEM {
  ...
  quest::exp(500);
  plugin::Whisper("Good! Now the Bloodsabers know that Karana will not allow them to live forever! Here, take this to aid you.");    
  }
