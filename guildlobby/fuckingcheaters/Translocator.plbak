...
if ($text =~/Hail/i)
{
plugin::Whisper ("Well hello there $name. Would you like to go to [$qeynos], [$east_freeport], [$west_freeport], [$halas], [$erudin],[$surefall], [$rivervale], [$akanon], [$felwithe],[$kaladim],[$kelethin],[$oggok], [$grobb], [$neriak], [$lavastorm], [$nektulos], [$guildlobby] or [$abysmal]?  ");
}
if ($text =~/kaladim/i)
{
