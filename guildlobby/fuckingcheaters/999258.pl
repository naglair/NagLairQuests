...
if ($text =~/hail/i) {
	$client->Message(14,"PLEASE NOTE READ ALL TEXT AND CLICK EVERY SAYLINK ON THIS MOB I WILL NO LONGER BE REIMBURSING EATEN ITEMS - IF YOU DONT GO THROUGH TEXT YOUR ITEMS WILL BE EATEN");
