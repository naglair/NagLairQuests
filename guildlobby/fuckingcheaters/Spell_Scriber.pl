...
if ($text =~/Hail/i)
{ plugin::Whisper("Greetings $name. I can [$scribe] your spells for you, but never exceeding your [$levels] of experience. I will also train you to [$meditate] ,(I can [erase] your spellbook, if you need. You can download the correct spell files from NagafenServer.com (if you need it) "); }
