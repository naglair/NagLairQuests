...
sub EVENT_ITEM
{
	...
	if (plugin::check_handin(\%itemcount, 51479 => 1, 51507 => 2)) #arms
		{
		plugin::Whisper("Yes, I believe this is the pouch.' He opens it up and begins to rummage through the contents. 'Ah, this is the locket I spoke of. Truly, I am closer to giving my master the peace his spirit searches for. With the thread I will be able to perform the minor tailoring work required to fit these sleeves to you.' He hands you the sleeves after a few minutes.");
		quest::exp(100000);
			if($class eq "Enchanter")
				{
