    ...
    if (defined($qglobals{Wayfarer}) && ($qglobals{Wayfarer} == 1)) { #PC has spoken to home town Wayfarer recruiter but not received Adventurer's Stone
      ...
      if (!plugin::check_hasitem($client,41000)) { #PC does not have an Adventurer's Stone
        ...
        if ($tak_wins < 2) {
          ...
          plugin::Whisper("I have more detail to give you $name. As the sands continued to pour in around the elves of Takish-Hiz like a merciless sea, parts of the city began to fall to the pressure of the failing earth. But the elves did not falter in their resolve and desire to save their home. The geomancers used the sands to form new walls where the stone crumbled. All the wood that cracked and split under the advancing sands were also replaced by reformed earth. Soon, large parts of the city were replaced with sandy architecture. Each day the elves fought to maintain their city, but it would be a battle that would seemingly never end. I must make an entry in my journal now, friend. Return soon!");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($tak_wins >= 34) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::Whisper("Hail, $name. I would recommend you go inquire about the decrepit state of Takish-Hiz and the elves with Niflel Faliwae in the Greater Faydarks. She has been doing a lot of research on the elves of Takish-Hiz and has quite a tale to tell. She can provide you with more insight than me. Safe journey!");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($tak_wins >= 40) {
          ...
          plugin::Whisper("Greetings $name! While we were exploring, we came upon the Royal attendants. They are all that is remaining of the advisors and guards of King and Queen Tak'Yaliz who had long-since abandoned the city. They became quiet workers, but they are very skilled with weapons due to their former professions. They were the warriors of the realm. Now they are just faint semblances of their former heroics. Extremely sad that there were so many survivors left behind, isn't it?");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($tak_wins >= 74) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
