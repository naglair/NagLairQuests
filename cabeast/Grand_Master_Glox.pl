...
sub EVENT_SAY {
 if($text=~/hail/i){
  ...
  plugin::Whisper('I knew you were not the whiff others claimed you to be, are you sure you are [ready] to be tested in agility?');
  }
 elsif($text=~/ready/i){
  plugin::Whisper('We shall spar then, I hope you are as prepared as you think you are.');
