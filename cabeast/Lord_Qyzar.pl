...
sub EVENT_SAY {
 if($text=~/hail/i){
  ...
  plugin::Whisper("You are a student of our ways? I would hope so. I seek a knight in search of a way to prove his allegiance and a way to earn his [zealot khukri].");
  }
 elsif($text=~/zealot khukri/i){ #Test of the Zealot (Greenmist Quest 4/8)
  plugin::Whisper("In search of a zealot khukri? I have heard much of your deeds to aid us. I offer it to you in exchange for your service. I have dispatched a knight named Grizzle to seek out the Kromdul fortress called Chalp. He was to secretly map Chalp and return with a [Chalp diagram]. He has yet to return. Perhaps you can [rescue Grizzle].");
  }
  ...
  plugin::Whisper("If you can find the knight in Chalp and have him hand you the Chalp diagram, you shall become a zealot and wield a zealot khukri. All I need are the Chalp diagram and your knight khukri.");
  }
 elsif($text=~/matter of betrayal/i){ #Test of the Betrayal (Greenmist Quest 5/8)
  plugin::Whisper("One of our agents, a hero by the name of Goxnok, has found evidence that the book entitled 'Charasis' has been taken from this temple and is to be delivered to an unknown foe in the Outlands. Go at once to the lower levels of the temple and greet Goxnok. Hurry, before he departs!");
  quest::spawn2(106301,0,0,-113,1000,-23.9,30);
  }
 elsif($text=~/visceral dagger/i){ #Test of the Hero (Greenmist Quest 6/8)
  plugin::Whisper("The visceral dagger was an ancient torturing weapon. I do not know much of it other than that it was forged by a member of the Brood of Kotiz, but that was ages ago. He is surely dust by now.");
  }
}

sub EVENT_ITEM {
  if(($itemcount{12496} == 1) && ($itemcount{5123} == 1)){ #Test of the Zealot (Greenmist Quest 4/8)
  plugin::Whisper("At last!! The Chalp diagram. I shall see that the emperor gets this at once. You have proven yourself more than just a mere knight, you are a zealot. Being new to the temple we have need of you in a [matter of betrayal].");
