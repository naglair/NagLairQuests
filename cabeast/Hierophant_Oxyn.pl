...
sub EVENT_ITEM {
  ...
  #shaman skull quest no.2 turn in - check for Skull with I and Skull with II turn in and cudgel
    ...
    plugin::Whisper("We are in your debt. You are truly one who shall collect all the lost ancient skulls. Take your weapon. Go to Hierophant Zand and he shall guide you further. Tell him you are [the chosen saviour].");
    quest::faction(282, 10); #Scaled Mystics
    quest::faction(193, 10); #Legion of Cabilis
    ...
    plugin::Whisper("I don't need that.");
