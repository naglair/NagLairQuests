...
sub EVENT_SAY {
 if($text=~/hail/i){
  plugin::Whisper("Do you come to me empty handed, knave? Did you lose your pike?");
  }
 elsif($text=~/no/i){
  plugin::Whisper("Ah... Yes... very good! Continue to work at this pace and the enemies of the Legion of Cabilis will fall beneath the blades of Cazic-Thule! Now move out... To Victory!"); #Could not find original text, modified SK version to fit.
  }
