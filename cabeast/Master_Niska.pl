sub EVENT_SAY {
  if($text=~/hail/i){
   ...
   plugin::Whisper("Greetings. We are the Swifttails. We are the harnessers of the elements. We are the tails of discipline. To achieve rebirth into our caste is a great honor indeed. We can be identified by our adornments. You should display that which we have given you to adorn your arms with pride. You do have your Shackle of Dust, correct?");
  }
  elsif($text=~/no/i){
   plugin::Whisper("You dare disgrace us?");
   quest::emote("hisses at you.");
   plugin::Whisper("If you have truely lost the marking of our caste, you will need to take this note and speak to the Toilmaster immediately. Read it on the way and praise the will of Cazic Thule.");
   quest::summonitem(18271);
  }
  elsif($text=~/yes/i){
   plugin::Whisper("Very good Broodling. Display your adornment with pride so that the enemies of the Brood may see our might as you rip through the weak will of their ranks. Now be gone from my sight.");
  }
  elsif($text=~/shackle of rock/i){
   quest::emote("strikes within inches of your snout with amazing speed.");
   plugin::Whisper("The Shackle of Rock is your interest? Then learn well our ways and prepare yourself. If the stone embraces your wrist, you are ready indeed. To complete the second rung you must find for me the [Fists of Talon].");
  }
  elsif($text=~/fists of talon/i){
   quest::emote("points to the Court Chronicler.");
   plugin::Whisper("All that is known of Talon has been chronicled. Should you obtain the fists then you shall hand them to me. This shall earn you the Shackle of Rock.");
  }
  elsif($text=~/troubles with an outlander/i){
   plugin::Whisper("It seems Klok Ephmir has encountered an outlander who was hunting the food we lizards enjoy. The legion will not act without proof of this outlanders existence. We were asked by the Baron to find this proof. We shall do this. You shall provide me with the outlanders head and the Shackles of Rock and Stone!!");
  }
...
sub EVENT_ITEM {
 if(plugin::check_handin(\%itemcount, 12797 => 1, 12798 => 1, 12799 => 1)){
  ...
  plugin::Whisper("Very good!! Here is your Shackle of Copper. The Emperor shall be pleased that I, Mistress Niska, have slain the outlander. Do you have some time? I need someone to be my [personal courier]. Will you?");
  ...
  quest::faction(193,10);
    ...
    plugin::Whisper("Lucky you. You have earned a second chance. Praise Cazic-Thule!");
