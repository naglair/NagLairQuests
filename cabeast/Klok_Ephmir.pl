sub EVENT_SAY {
  ...
  # Catfish Croak Sandwich [Part 5]
    plugin::Whisper("I can provide thin sliced froglok meat, or rather, I used to. First I need to [sharpen the dull cutting disk].");
  }
  elsif($text=~/sharpen.*disk/i){
  # Catfish Croak Sandwich [Part 6]
    plugin::Whisper("That would be good. If you are a blacksmith, I am sure you can find a sharpening stone and bring life back in my disk. If you sharpen this I shall gladly provide you with some thin sliced froglok.");
  }
