sub EVENT_SAY {
 if($text =~ /Hail/i) {
	quest::emote("turns to you and snorts in anger. Some mucus lands on your cheek.");
        plugin::Whisper("Troopers! I thought I ordered you to keep all new recruits away from this chamber! Go, child. The War Baron of Cabilis has no time for games. See this intruder out!!");
 }
 if ($text=~/What memory of Sebilis?/i) {
   quest::emote("takes a step back and thinks to himself. Phlegm dribbles off his lips.");
   plugin::Whisper("The Memory of Sebilis. Kept within my personal chambers. They have been taken. Taken by some croakin' Forsaken no doubt!! You have been sent to me because you show excellent prowess. Find my Memory and bring it to me with your footman's pike.");
 }
 if ($text=~/brave trooper of the empire/i) {
   plugin::Whisper("So you are a trooper? Word of your deeds has been spreading through the legion. If you truly wield the pike of a trooper, then go and serve the garrisons of swamp, lake and woods. Report to the Warlord and tell him you are a [trooper reporting for duty]. Their recommendations and your trooper pike shall earn you the rank of legionnaire.");
 }
}
...
sub EVENT_ITEM {
 if(plugin::check_handin(\%itemcount, 18464 => 1, 22919 => 1)){
  ...
  plugin::Whisper("My memory has returned! Boneripper! You are no footman. I grant you the rank of soldier. Go and forge your weapon. Do not return to me until you become a [brave trooper of the empire].");
  plugin::Whisper("Find Drill Master Kyg to help you in this task?  [Footman Moglok] needs help.");    #not live text, link to 4th pike beginning
...
if (plugin::check_handin(\%itemcount, 18073 => 1, 18072 => 1, 18074 => 1, 5134 => 1 )) {
  ...
  plugin::Whisper("It is time to wield the weapon of a [true warrior of the legion]. You have done well, Legionnaire $name!");
