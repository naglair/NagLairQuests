...
sub EVENT_SAY {
 if($text=~/hail/i){
  plugin::Whisper("Do not bother me unless you wish to join the chain gang. Now go away or I shall have my slaves chop you as they chop this granite!");
  }
