...
sub EVENT_SAY {
  if(($text=~/chosen savior/i) && ($faction <= 5) && ($shmskullquest >= 3)){
    plugin::Whisper("I am honored to meet the one who shall pledge his life to the return of the Skulls of the Ancients. However, I must see proof of our prowess as of yet. Go to the outlands and retrieve one Froglok Hexdoll, and no, they are not found on Frogloks. They are shaman dolls made by the goblin tribe.");
  }
  elsif($text=~/hail/i){
    plugin::Whisper("Welcome to the Temple of Terror, young one. May the pain of the ancients guide you. Have you lost your Iron Cudgel of the Petitioner?"); #Could not find original text
  }
  elsif($text=~/no/i){
    plugin::Whisper("The Temple of Terror requires all young Scaled Mystics to wear the symbol of their station. Wear it with pride in these halls to display the rank you have attained. Go now, and serve The Faceless."); #Could not find original text
  }
...
sub EVENT_ITEM {
  ...
  #Shaman Skull Quest No.3.1 turn in - Check for  A froglok hex doll
    ...
    plugin::Whisper("You have proven your prowess to me, now take this note to Crusader Quarg outside the city and he will test you further.");
  ...
  #Shaman Skull Quest No.5 turn in - Iksar Skull Helm and Iksar Skull and Cudgel of the Prophet
    ...
    plugin::Whisper("You have done well in proving yourself to this council, but we have yet more tests for you before you will be a true clairvoyant. Speak with Hierophant Dexl for your next test.");
    quest::faction(282, 10); #Scaled Mystics
    quest::faction(193, 10); #Legion of Cabilis
    ...
    plugin::Whisper("This isn't what I asked for.");
