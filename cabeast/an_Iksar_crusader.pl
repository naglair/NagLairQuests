...
sub EVENT_SAY {
 if($text=~/hail/i){ #Test of Betrayal (Greenmist Quest 5/8)
  ...
  plugin::Whisper("As I have reported, the babble states they appear to be skinless stubs who ride giant spiders. Most encounters occur when the moon is high. Little is known about them and only in recent weeks have they begun to appear.");
  }
