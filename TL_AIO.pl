...
if ($text =~/Hail/i)
{
$client->Message(315,"Well hello there $name. Would you like to go to [qeynos], [eastfreeport], [westfreeport], [halas], [erudin],[surefall], [rivervale], [akanon], [felwithe],[kaladim],[kelethin],[oggok], [grobb], [neriak], [lavastorm], [nektulos], [guildlobby] or [abysmal]?  ");
}
if ($text =~/hail/i && $status > 0 && $status < 2)
 {
$client->Message(315,"Well hello there $name. Would you like to go to [qeynos], [eastfreeport], [westfreeport], [halas], [erudin],[surefall], [rivervale], [akanon], [felwithe],[kaladim],[kelethin],[oggok], [grobb], [neriak], [lavastorm], [nektulos], [guildlobby], [abysmal] ,[fieldofbones], [firionavie], [overthere], [emeraldjungle], [skyfire], or [dreadlands]? ");
 } 
 if ($text =~/hail/i && $status > 1 && $status < 3)
 {
 $client->Message(315,"Well hello there $name. Would you like to go to [qeynos], [eastfreeport], [westfreeport], [halas], [erudin],[surefall], [rivervale], [akanon], [felwithe],[kaladim],[kelethin],[oggok], [grobb], [neriak], [lavastorm], [nektulos], [guildlobby], [abysmal] ,[fieldofbones], [firionavie], [overthere], [emeraldjungle], [skyfire], or [dreadlands], [greatdivide], [iceclad], [westwaste], [wakeningland], [field], [firiona], [overthere], [emerald], [skyfire],[dreadlands]");
