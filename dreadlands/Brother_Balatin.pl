...
sub EVENT_SAY {
 if($text=~/hail/i){
  ...
  plugin::Whisper("What discipline do you follow?");
 }
 elsif($text=~/lost circle/i){
  # ROTWF [Part 2]
  plugin::Whisper("Then we are one. The rebirth of our circle shall start with you. I have waited decades for your arrival. You should seek the living brothers within Tunaria. When you have earned your garb then you will be ready for the [true drape].");
 }
 elsif($text=~/true drape/i){
  # ROTWF [Part 3]
  plugin::Whisper("Seek the broken flute of our master. Taken from us by the Iksar twins of Vistrei. To me they will come and to me your robe and you will come the dawning of the new brotherhood.");
 }
}
