...
if (plugin::check_handin(\%itemcount, 9031=>1 )) {
  ...
  if (plugin::check_handin(\%itemcount, 9036 =>1 )) {
    plugin::Whisper("Perfect work, $name! I am glad the Elders made such a wise choice in sending you. I must admit, I was rather scared during the exploration of these halls. This lair is quite foul, quite foul indeed! Take this wrapped totem and place it in the case that you were given. Once you have all of the totems, seal the case and make your way back to Shar Vahl. I work my way back as well. Thank you again. ");
