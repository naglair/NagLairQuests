sub EVENT_SAY {
 if($text=~/hail/i){
  plugin::Whisper("You wield great power. The wind whispers to me. You seek to learn more about the augmentation stones found in ruins long forgotten. They hold great power. A mysterious power. I fear however that if you were to fuse one of these magical stones to your Orb of Mastery, it would be lost due to the transitory nature of the Orb. I believe after much research I have discovered a way for you to make use of these stones if you are [interested].");
 }
 elsif($text=~/interested/i){
  plugin::Whisper("Hand me your Orb of Mastery. I must infuse the power of the elements into a new orb.");
 }
}
...
sub EVENT_ITEM {
 ...
 if(plugin::check_handin(\%itemcount, 28034 => 1)){
  ...
  plugin::Whisper("I do believe this was a success. The power of summoning and elements has been infused into a new orb. Take this new Orb of Mastery. You may now safely use the power of the augmentation stones with your new orb.");
