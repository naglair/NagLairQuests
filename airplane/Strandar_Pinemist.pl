...
plugin::Whisper("Greetings, young one. Are you a [child of the trees]?");

}

if($text=~/child of the trees/i) {

plugin::Whisper("Then you are welcome in my presence. I shall call forth some loyal children if you but speak the name. Will or Fenalla will serve you well.");
 }
