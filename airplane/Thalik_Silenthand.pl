...
plugin::Whisper("Greetings, $name.  Do you believe you are a great rogue?");

}

if($text=~/great rogue/i){

plugin::Whisper("I will not take your word for it!  You must prove your greatness to one of my apprentices.  Do you wish to be tested by Rayne or by Kendrick?");
