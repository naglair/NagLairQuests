...
plugin::Whisper("Greetings. $name.  Have you come here to test your dark powers of skill and spell casting?");

}

if($text=~/dark powers of skill/i){

plugin::Whisper("You will be tested by either Gragrot or Tynicon.  Choose one!");
