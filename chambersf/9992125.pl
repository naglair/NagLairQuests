...
if ($text =~/rivervale/i && $cv == 7)
{
plugin::Whisper ("$name , stand close to me while I cast..");
quest::emote ("moves his hands as if chanting...");
quest::movepc(415, 664, -9, 0);
}
elsif($text =~/rivervale/i && $cv <= 6)
{
plugin::Whisper ("$name , stand close to me while I cast..");
quest::emote ("moves his hands as if chanting...");
...
if ($text =~/erudin/i && $cv == 7)
{
plugin::Whisper ("$name , stand close to me while I cast..");
quest::emote ("moves his hands as if chanting...");
quest::movepc(414, -718, -2102, 26);
}
elsif($text =~/erudin/i && $cv <= 6)
{
plugin::Whisper ("$name , stand close to me while I cast..");
quest::emote ("moves his hands as if chanting...");
