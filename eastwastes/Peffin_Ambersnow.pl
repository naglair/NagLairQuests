sub EVENT_SAY {
  if($text=~/hail/i) {
    plugin::Whisper("Oh, I uh... err, hello there. Umm, thank Brelll you're here, those bloody Kromrif were going to torture me! Yes, yes, and you've saved me! How can I ever repay you?");
  }
  if($text=~/murdrick/i) {
