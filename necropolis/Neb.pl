...
sub EVENT_SIGNAL {
  if ($signal == 101) {
    plugin::Whisper("Chika val na vi Paebala Neb'ri. I am Neb of the Paebala.
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 26033 => 1, 26009 => 1)) {
    plugin::Whisper("Ika Paebala ma ri skasha, Neb`ri mi re skashi! The Paebala
