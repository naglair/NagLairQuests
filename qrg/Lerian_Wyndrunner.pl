...
plugin::Whisper("My sister Jhaya must have sent you.  Let me see what you have brought.");
...
plugin::Whisper("There is [more that you must do], my friend, before this task is complete.");
...
plugin::Whisper("You will need to seek out one other item -- the Blackened Mithril Boots from the kobold priest in Solusek's eye. Once you have the boots, you will need a master's knowledge of tailoring to carefully fit this hide over the boots before returning them to Cheyloh.");
