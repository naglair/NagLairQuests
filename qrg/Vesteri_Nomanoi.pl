...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 13864 => 1)) {
    plugin::Whisper("Oh thank you so much! Here. Take this reward for your time. I will also tell Te'Anara of you.");
    quest::exp(250);
