sub EVENT_SAY {
 if($text=~/hail/i){ #Part of Shaman Epic 1.0
  plugin::Whisper("Oh thank Marr you are here, $name. I was beginning to think I would be abandoned in my time of need. I have a [task] for you to complete in the name of my patron Mithaniel Marr.");
  }
