...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount,67020 => 1)) {  ##Give him Marr's Retribution.
    ...
    plugin::Whisper("Thank you again $name. Your kindness has allowed my spirit to go home. Please show this to my people so they will have a memory of what you have done.");
    quest::settimer(1,6);
