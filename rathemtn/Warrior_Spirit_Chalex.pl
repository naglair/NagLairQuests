...
sub EVENT_SPAWN {
  ...
  plugin::Whisper("Your kindness has given me a chance to finish that which I started. While I thank thee for restoring my blade and bringing it to me, I am not worthy to wield it until I have destroyed the one who killed me. Please hold my sword until I have redeemed myself by vanquishing the vile Troll Captain Krignok.");
...
sub EVENT_TIMER {
  ...
  if ($timer == 1) {
    plugin::Whisper("Now, I must ask that you protect me, I can feel his presence close by and once again he is not alone.");
