    ...
    quest::summonitem(17831);
      ...
      plugin::Whisper("These are not the usual components used in spells. Look instead in Innothule Swamp for your pieces. The many enemies and vermin that stalk that bog hold items which are only trash to others. But to you they will eventually become treasures. When you are ready to attempt making your armor, return and tell me what you wish to make and I will instruct you. I can teach you the recipes and give you the proper molds for the Armor of the Jin Initiate [Headband], [Vestment], [Armwraps], [Bracer], [Handwraps], [Leggings], and [Sandals].");
        ...
        if ($text=~/slay him/i) {
          ...
          plugin::Whisper("Yes. It is the only way now. But once he has fallen, look in his possessions and see if you can find a Tattered Codex. It was my last gift to him. Return it to me along with two Burly Kobold Ears and a Larvae Skin and I shall use my own crucible to repair it. You are certainly worthy of it.");
        }
}

sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount,  63089=>1, 51036=>2, 51019=>1  )) {
    plugin::Whisper("You have done me a great favor and shown mercy to own of our own.  Here is you reward, use it well and remember your lessons.");
