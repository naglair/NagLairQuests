...
{
  if($text=~/hail/i){ 
plugin::Whisper("Come to look at my animals, have you? I have managed to capture and 
...
animals] yourself?");
  ...
  {
  plugin::Whisper("Those blasted Trolls caused me to lose one of my finest specimens! I 
...
her.");
  ...
  if($text=~/snake/i)
  {
  plugin::Whisper("There was a band of Troll invaders moving through our supply line one 
...
surroundings that I find myself lacking the time to go [look for her].");
  ...
  {
plugin::Whisper("She answers to the name of Sethena when she is in the mood. She wore a 
...
if(plugin::check_handin(\%itemcount, 54001 => 1))
  {
  plugin::Whisper("Alas, my poor Sethena! Thank you for this trinket, $name. Please, take 
