sub EVENT_SAY {
  if ($text=~/hail/i) {
    plugin::Whisper("Well hello there. I don't mean to be rude but I am trying to enjoy a short break alone and enjoy my favorite Ale.");
  }
}
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 67010 => 1)) { #Mug of Poisoned Ale
    ...
    plugin::Whisper("Thanks young one, that was just what I needed. Take this as a token of my gratitude. Perhaps you will join our ranks when you get older.");
