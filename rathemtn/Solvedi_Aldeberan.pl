...
sub EVENT_SAY {
   ...
   if($text=~/Hail/i){
      plugin::Whisper("Hail, forestwalker. Welcome to the Rathe bear preserve of the Unkempt Druids. We strive to protect nature with diligence and punish her [defilers] with prejudice!");
   }
   if($text=~/defilers/i){
      plugin::Whisper("There are many defilers of nature about that warrant eradication. Groi Gutblade is a loathsome troll poacher who lurks in South Karana. Slay him and bring me his Lionhide Backpack. Timbur the Tiny takes pride in crushing the trees in North Karana into pulp under his feet. Make him pay for this affront and bring me his Laceless Sandal as proof of his demise. I will give you my own blade if you succeed.");
   }
}
...
sub EVENT_ITEM {
   ...
   if(plugin::check_handin(\%itemcount,9352=>1,17350=>1)) {
     plugin::Whisper("You have done well. Here, take my blade as promised");
     quest::summonitem(5378);
     quest::exp(25000);
   } else {
     plugin::return_items(\%itemcount);
     plugin::Whisper("I have no need for these, have them back.");
   }
}
