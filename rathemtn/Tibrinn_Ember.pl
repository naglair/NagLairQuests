...
sub EVENT_ITEM {
   ...
   if(plugin::check_handin(\%itemcount,4310=>1,6335=>1)) {
     plugin::Whisper("You have done well. Here is the reward for your deeds.");
