...
sub EVENT_ITEM {
  if($itemcount{51093} == 1) {
	#text made up
	plugin::Whisper("Thank you for retrieving the artifact, young one.  Your training is now complete, and I present to you the last of the equipment granted to Yun Initiates, the cudgel of our order.  May it serve you well in your travels.");
