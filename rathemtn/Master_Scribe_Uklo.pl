...
sub EVENT_ITEM {
  if ($faction => 9 && plugin::check_handin(\%itemcount, 67014 => 1, 67015 => 1, 67013 => 1)) { # Restore the Blade - Tarnished Cross-Guard, Tarnished Pommel, Fused Sword Blade
    ...
    plugin::Whisper("I thank you. Since our creation it has been rare that we have received such kindness. You will always be welcome in our city and future generations will croak the story of your greatness. Please take this as a small token of my gratitude you have truly earned it.");
    ...
    plugin::Whisper("I do not need this $name. Here, have it back.");
