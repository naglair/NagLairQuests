...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 61230 => 1, 61231 => 1, 61232 => 1, 61233 => 1)) {#Fireback Silk, Sweltering Slime Bauble, Fireborn Tooth, Blistering Tentacle
    plugin::Whisper("Well I see that you can certainly be trusted to uphold my will should I request it of you. Please take this symbol and return to me if you should desire to help me with a much [bigger problem].");
