...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 55253 => 1, 55256 => 1, 55254 => 1, 55255 => 1)) {#A Smoldering Tentacle, Seared Imp's Blood, Seared Ooze, Crystallized Soul of Fire
    plugin::Whisper("Quite excellent.  The kobolds have found pieces of a sword that was undone.  Bring me the three pieces along with this vial, and I will remake the blade.");#text made up
  ...
  if(plugin::check_handin(\%itemcount, 55260 => 1, 55257 => 1, 55258 => 1, 55259 => 1)) {#Flame-Forged Vial, Melted Hilt, Shattered Blade (Top), Shattered Blade (Bottom)
    plugin::Whisper("Amazing.  This should serve you well, take it and slaughter our mutual enemies, $name!");#text made up
