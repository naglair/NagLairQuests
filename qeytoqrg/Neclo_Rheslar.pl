...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 18823=>1)) { #Note to Neclo
    plugin::Whisper("Ah.. Hello friend.. So, I see Daenor sent you.. Uh huh, ok.. Here's something that will be very useful for you. Practice this well, friend.. It will help protect you in this harsh world.");
