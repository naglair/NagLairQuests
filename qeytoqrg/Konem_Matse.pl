...
sub EVENT_ITEM {
   ...
   if(plugin::check_handin(\%itemcount, 18921 => 1)) {
      quest::ding();
      plugin::Whisper("Oh I see.. Phin's always after me about something.  I mean, it's not my fault the order hasn't come in yet.  Hey, since I'm so busy right now, why don't you be a friend and take this back to Phin for me, huh?");
      # Grathin's Invoice ID-18922
