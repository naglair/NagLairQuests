...
sub EVENT_SAY {
   if($text=~/Hail/i){
      plugin::Whisper("Greetings. The fishing is sparse here. You would fare better at [Lake Rathe].");
   }
   if($text=~/Lake Rathe/i){
      plugin::Whisper("Beyond the Plains of Karana can be found a pass to Lake Rathe. I have heard stories of a giant water beast and underwater cities. I wish I knew how to swim.");
   }
}
...
sub EVENT_ITEM {
   if(plugin::check_handin(\%itemcount, 18893 => 1)) #A Sealed Letter
   {
      ...
      plugin::Whisper("So you are the new warrior. Let us test your skill. Across the pond is a skeleton. See him? Engage him in combat. He awaits. Return his skull to me and I shall call you a Steel Warrior. Be quick. He will dissipate soon.");
   ...
   {
      plugin::Whisper("So you have returned. Victory is yours, young Steel Warrior. Take this letter of recommendation to Brin Stolunger at the arena in Qeynos. You have passed.");
