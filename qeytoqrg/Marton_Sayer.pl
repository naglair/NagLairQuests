...
sub EVENT_ITEM { 
   ...
   if(plugin::check_handin(\%itemcount, 12204 =>1)){ 
      ...
      plugin::Whisper("Baby Joseph!! Look, Momma!! Baby Joseph has been rescued by this good adventurer!! That evil Lord Elgnub made good on his word and snatched my son from under our noses. You saved the day!! For this you shall wield 'Gnoll Slayer'!! Be aware of its [true potential]."); 

   } if(plugin::check_handin(\%itemcount, 8357 =>  1,  8356 => 1, 5416 => 1)){ 

      quest::summonitem(5417); 

      plugin::Whisper("You have found the missing pieces!  Now the Gnoll Slayer is returned to it's full power!"); 
