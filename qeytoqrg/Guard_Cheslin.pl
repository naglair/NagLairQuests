...
sub EVENT_SAY{
   ...
   if($text=~/hail/i)
   {
      plugin::Whisper("Hail, mighty adventurer! I am Guard Cheslin Sydwend and I am here to serve and
   ...
   if($text=~/father sent me/i)
   {
      ...
      plugin::Whisper("My father has no need to worry and I do not need a baby sitter. I may be in training
   ...
   if($text=~/illusion/i)
   {
      ...
      {
         plugin::Whisper("Yes!! I seem to have dropped some of my [Illusion] cards.");
         $illusionResponse = "1";
      }else{
         plugin::Whisper("Oh!! Do you play Illusion, too? I love that game. I have some very rare cards in my deck. I
...
sub EVENT_TIMER{
   ...
   if($timer eq "1")
   {
      ...
      plugin::Whisper("Hail, fellow guards! I am off to protect the travelers of the hills from evil. I
         shall return!");
      quest::start(100);
   }
} # EVENT_TIMER
...
sub EVENT_ITEM{
   ...
   if($correctHandin)
   {
      plugin::Whisper("Wow!! I thought I lost this for good. All together I lost the [illusion] cards: Ebon Lotus,
      ...
      {
         plugin::Whisper("Oh great! I have all my cards back. Here is a little something for assisting a Qeynos guard.
   ...
   {
      plugin::Whisper("I have no need for this, please have it back and let me finish my patrol...");
...
sub EVENT_WAYPOINT_ARRIVE{
   ...
   plugin::Whisper("Fear not, simple travelers. Cheslin the masterful is here to protect you.");
   ...
   {
      plugin::Whisper("Hey! Did I just drop something?");
      plugin::Whisper("'I lost some of my [illusion] playing cards. And they were the rare ones too! Darn it! If
