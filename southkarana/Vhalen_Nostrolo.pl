...
if($text=~/Hail/i){
   ...
   plugin::Whisper("I am out here composing my latest masterpiece. Unfortunetly a vile man of a hermit has taken off with two sheets of the song. If you can retrieve them I would be glad to play the tune for you.");
}
}
...
if (plugin::check_handin(\%itemcount,13114 => 1)) { # Lisera Lute
   ...
   plugin::Whisper("Ahh, I see Cassius still don't trust his lute to anyone else. Please be kind to return this letter to him about his lute. It should make him quite pleased.");   
