...
plugin::Whisper("I'm Captain Bosec. and I am the officer in charge down here. It's my job to patrol the prison and try to keep any [goblins] from getting into Highpass."); }
...
# Left Goblin Ear ID-13790
  ...
  if ($ear>=1) {
    for ($i=0; $i<$ear; $i++) {
	plugin::Whisper("Well done! We could really use the extra help around here.");
        quest::exp(100);
