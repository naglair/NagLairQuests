...
if (plugin::check_handin(\%itemcount, 55298 => 1)) { # Phylactery
	plugin::Whisper("Excellent work. There is only one slight error that I have now corrected for you.");  
	quest::summonitem(55299); # Dark Phylactery
	}

if (plugin::check_handin(\%itemcount, 55299 => 1)) { # Dark Phylactery
	plugin::Whisper("Ah, you wish to perform your own alterations? Very well.");  
