...
if(plugin::check_handin(\%itemcount, 67404 => 1)) { # Rarundel's Open Memory Box (non Container) 
	...
	plugin::Whisper("I thank you for returning this to me. It is one of the last things I remember before that fateful day when Krixt executed me in front of my people. Now I long only for the keepsake that is missing. I know that tyrannical brute has done something with it. If only someone would make him suffer the way I suffered. Place the keepsake in this box and return to me what is rightfully mine.");
...
if(plugin::check_handin(\%itemcount, 67623 => 1)) { # Rarundel's Closed Memory Box
	plugin::Whisper("I cannot believe this! Your kindness knows no bounds, which is why I must ask that you give this to my love, Rasnil. We were destined to be together until the legion took him away from me. Now he is a slave to them in the gardens. Please show this to him so that he will know that I was thinking of him even as I died.");
...
if(plugin::check_handin(\%itemcount, 67411 => 1)) { # Narundel's Decision
	...
	plugin::Whisper("Thank you, adventurer, for bringing closure to this part of my life. Please take this as a token of my gratitude and as a memory of the great thing you have done.");	
