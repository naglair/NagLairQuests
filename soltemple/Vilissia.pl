...
sub EVENT_ITEM {
  ...
  if(($itemcount{2352} == 1) && ($itemcount{2368} == 1) && ($itemcount{10558} == 1) && ($itemcount{2367} == 1)) {
    plugin::Whisper("Well done $name. You truly are a powerful wizard. I have crafted your mask. Take it.");
  ...
  if(($itemcount{2332} == 1) && ($itemcount{10553} == 1) && ($itemcount{10554} == 1) && ($itemcount{10555} == 1)) {
    plugin::Whisper("Well done $name. You truly are a powerful wizard. I have crafted your cloak. Take it.");
  ...
  if(($itemcount{10035} == 2) && ($itemcount{10000} == 1)) {
    plugin::Whisper("Okay, here is your Lambent Ruby.");
  ...
  if($itemcount{16507} == 1) {
    plugin::Whisper("I see that Gavel has sent you to me.  Very well, I have vulcanized your platinum bar - take it.");
