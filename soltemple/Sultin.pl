...
sub EVENT_ITEM {
  ...
  if(($itemcount{10087} == 1) && ($itemcount{6337} == 1)) {
    plugin::Whisper("Well done, $name.  Here is your reward."); # Made this text up
  ...
  if(($itemcount{12240} == 1) && ($itemcount{6340} == 1)) {
    plugin::Whisper("Well done, $name.  Here is your wand."); # Made this text up
  ...
  if(($itemcount{2353} == 1) && ($itemcount{2354} == 1) && ($itemcount{2355} == 1) && ($itemcount{2356} == 1)) {
    plugin::Whisper("All four sets of gloves?  Very well done.  Here is your reward."); # Made this text up
  ...
  if(($itemcount{2352} == 1) && ($itemcount{10530} == 1) && ($itemcount{10531} == 1) && ($itemcount{10532} == 1)) {
    plugin::Whisper("Well done, $name!  Here is your mask, as promised."); # Made this text up
