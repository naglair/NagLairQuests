...
sub EVENT_ITEM {
  ...
  if(($itemcount{10548} == 1) && ($itemcount{10549} == 1) && ($itemcount{10550} == 1) && ($itemcount{6048} == 1)) {
    plugin::Whisper("Well done, $name. Now I will craft your Staff of Temperate Flux, as promised.");
  ...
  if(($itemcount{10551} == 1) && ($itemcount{6338} == 1) && ($itemcount{10557} == 1) && ($itemcount{14364} == 1)) {
    plugin::Whisper("Well done, $name. Now I will craft your Weeping Wand, as promised.");
  ...
  if(($itemcount{10034} == 2) && ($itemcount{10000} == 1)) {
    plugin::Whisper("Ahh, Genni must have sent you to me.  Very well, here is your Lambent Sapphire.");
