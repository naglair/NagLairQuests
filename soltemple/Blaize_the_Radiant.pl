...
sub EVENT_ITEM {
  ...
  if(($itemcount{19001} == 1) && ($itemcount{19002} == 1) && ($itemcount{16507} == 1)) {
    plugin::Whisper("Well done! Please take these boots as your reward.");  # text made up
  ...
  if(($itemcount{19007} == 1) && ($itemcount{19008} == 1) && ($itemcount{19049} == 1)) {
    plugin::Whisper("Well done! Please take these greaves as your reward.");  # text made up
  ...
  if(($itemcount{19003} == 1) && ($itemcount{19004} == 1) && ($itemcount{19047} == 1)) {
    plugin::Whisper("Well done! Please take these gauntlets as your reward.");  # text made up
  ...
  if(($itemcount{19005} == 1) && ($itemcount{19006} == 1) && ($itemcount{19048} == 1)) {
    plugin::Whisper("Well done! Please take these vambraces as your reward.");  # text made up
