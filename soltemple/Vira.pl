...
sub EVENT_SAY {
  if($text=~/hail/i) {
    plugin::Whisper("Well met $name. I am Vira, elementalist of Solusek Ro. I guard the secrets of the tools of [elemental summoning]. If you are a magician, you might be interested.");
  }
  if($text=~/elemental summoning/i) {
    plugin::Whisper("I hold the secrets to the construction of four tools which assist magicians with the summoning of elementals. I know about the [broom of Trilon], the [shovel of Ponz], the [torch of Alna] and the [stein of Ulissa].");
  }
  if($text=~/broom of trilon/i) {
    plugin::Whisper("The broom of Trilon was held by the infamous Mistress of Air of the same name. Are you [interested in the broom]?");
  }
  if($text=~/interested in the broom/i) {
    plugin::Whisper("I will construct a replica of the broom of Trilon for you, but I will need the following components to make it: a star ruby; a feather from a griffon, a broom from a magician in Najena and the toes of a cyclops. Bring me these four components, and I will fashion for you an object of elemental power.");
  }
  if($text=~/shovel of ponz/i) {
    plugin::Whisper("The shovel of Ponz was crafted by the earthen master of the same name. Are you [interested in the shovel]?");
  }
  if($text=~/interested in the shovel/i) {
    plugin::Whisper("I will create a replica of the shovel of Ponz for you, but I will need the following components to make it: a ruby, the eyes of a gargoyle, a shovel from a magician in Najena and the toes of a hill giant. Bring me these four components, and I will construct for you an object of elemental power.");
  }
  if($text=~/stein of ulissa/i) {
    plugin::Whisper("The stein of Ulissa was found and used by the mistress of water of the same name. Are you [interested in the stein]?");
  }
  if($text=~/interested in the stein/i) {
    plugin::Whisper("I will devise a replica of the stein of Ulissa for you, but I will need the following items to make it: a sapphire, a scale from a mermaid, a stein from a magician in Najena and the toes of an ice giant. Bring me these four components, and I will make for you an object of elemental power.");
  }
  if($text=~/torch of alna/i) {
    plugin::Whisper("The torch of Alna was constructed and held by the fire mistress of the same name. Are you [interested in the torch]?");
  }
  if($text=~/interested in the torch/i) {
    plugin::Whisper("I will make a replica of the torch of Alna for you, but I will need the following items to make it: a fire emerald, a scale from a fire drake, a torch from a magician in Najena and the toes of a fire giant. Bring me these four components, and I will build for you an object of elemental power.");
  }
}

sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 16544 => 1, 16543 => 1, 16538 => 1, 10032 => 1)) { #Broom, Cyclops Toes, Griffon Feathers, Star Ruby
    plugin::Whisper("All of the components to make the infamous broom of Trilon! Well done, adventurer. As you have proven yourself worthy, I grant you this broom.");
    ...
    plugin::Whisper("Each of the four items needed to construct the famed Shovel of Ponz! Very well. As you have displayed ingenuity, I grant you this shovel.");
    ...
    plugin::Whisper("The four components required for the stein of Ulissa?! I am impressed! As you have displayed valor, I grant you this stein.");
    ...
    plugin::Whisper("All of the pieces of the famous Torch of Alna! I never thought you would find them all! As you have displayed courage, I grant you this torch.");
