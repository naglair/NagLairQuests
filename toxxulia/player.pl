...
sub EVENT_TIMER {
  ...
  elsif (defined $qglobals{nexus_toxxulia} && defined $qglobals{spire_toxxulia} && $qglobals{spire_toxxulia} == 1 && !defined $qglobals{message_toxxulia} && !plugin::check_hasitem($client, 19720)) {
