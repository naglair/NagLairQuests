...
sub EVENT_TIMER {
	...
	plugin::Whisper("Dragoons!!  Attention!!  Right face!!");
	quest::start(277);
}

sub EVENT_WAYPOINT_ARRIVE {
	if($wp==1) {
		plugin::Whisper("Forward.. march!!  Your left.. Your.. left, right, march!  Eighty.. second.. dragoon soldier!!  Pick up your weapon and follow me!!");
