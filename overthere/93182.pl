...
if ($itemcount{12848}==1){
      ...
      plugin::Whisper('I live to study and quench my thirst. I live to Bash the Faces of Pariah and entangle myself in the ivy of evergreen. I live. I want to remember.');
quest::summonitem(12848);
  ...
  if ($itemcount{12848}==1 && $itemcount{12850}==1 && $itemcount{12851}==1 && $itemcount{12610}==1) { 
    if ($ulevel>20) {
      ...
      plugin::Whisper('You will have to be more skilled to complete that quest.');
    }
  }
}
