...
sub EVENT_ITEM { 
	if (plugin::check_handin(\%itemcount, 54431 => 1, 54434 => 1, 54432 => 1, 54433 => 1)) { # Chipped Cracked, Rusted and Wobbly Pick 
		plugin::Whisper("These picks are in sad shape, that they are. This would take longer than it is worth. I just forged some new ones, just take those and get out!");
		quest::ding();
