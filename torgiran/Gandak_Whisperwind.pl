...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 21986 => 1)) { #Medallion of the Emerald warrior
    ...
    plugin::Whisper("Excellent work, $name! Now that I have these I need one final favor from you. I need you to continue on to the farmer in the Karanas to obtain the remedy for my wife. Take him this bag and he will fill it with what you need."); #need correct text
