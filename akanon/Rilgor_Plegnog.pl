...
sub EVENT_SAY {
  if ($text=~/mechanical pen/i) {
    plugin::Whisper("Why do you want one of those contraptions. You will spend more time repairing it then you will writing with it. But if you insist on getting one, you are going to have to do a small favor.");
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 1360 => 1)) {
    plugin::Whisper("Very nice!! It is perfect! Here take this pen. Have fun with it.");
    quest::exp(50000);
