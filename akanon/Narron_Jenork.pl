...
sub EVENT_SAY { 
  ...
  if($text=~/final task/i) {
    plugin::Whisper("Much like most of the other guildmasters in our great city, we have decided to begin presenting all new worthy recruits with weapons that symbolize their devotion to Ak'anon. I am in need of a [few items] from the mountains to make this weapon. If you will collect these items for me, I will be happy to reward you with one of these fine weapons.");
  }
  if($text=~/few items/i) {
    plugin::Whisper("I will need for you to bring me 1 Clockwork Oil Extract, 1 Minotaur Tibia, 1 Young Ebon Drake Ribcage and 1 Renegade Clockwork Scrapmetal. Return to me after you have gathered this items and I will reward you with your weapon.");
  }
}

sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 9111 => 1, 9112 => 1, 9113 => 1, 9114 => 1)) {
    plugin::Whisper("Well done, young $name! Since you have brought me the necessary items, I now present you with this Initiate Watchman's Long Sword. Use it worthily."); # text made up
    quest::summonitem(9115);
  }
  elsif(plugin::check_handin(\%itemcount, 12378 => 1)) { # Box of Undead Brownies
    plugin::Whisper("Wonderful!! Watchman Dexlin sent word that you would be returning these specimens. I shall see that the Eldritch Collective gets them.  For you there is a reward. Manik has donated a pair of Watchman Boots!!");
