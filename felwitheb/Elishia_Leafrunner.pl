...
sub EVENT_SAY {
  if($text=~/letter back to him/i) {
    plugin::Whisper("Thank you. Take this letter and see that he gets it."); #Real text still needed
...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 8969=>1)) { #Letter to Elishia
    plugin::Whisper("Oh, a letter from my grandson? Thank you very much. I haven't been able to talk to him recently. Would you mind taking a [letter back to him] for me?");
