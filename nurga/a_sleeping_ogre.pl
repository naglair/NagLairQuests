...
sub EVENT_ITEM {
  if((plugin::check_handin(\%itemcount, 1685 => 1)) && ($ulevel >= 46) && ($class eq "Monk")) { #Breath of Gwan
    $npc->SetAppearance(0);
    plugin::Whisper("Your path of wanton destruction ends here. Gwan and Eejag were impatient and hot-headed. You will not defeat me, for I have the patience and perseverance of stone, unlike the children you have beaten before me. Are you sure you want to challenge me?");
