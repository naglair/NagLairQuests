...
sub EVENT_ITEM
{
	if(plugin::check_handin(\%itemcount, 25115 => 1)) {#Hand of Deaen Greyforge
		plugin::Whisper("You truly are a bringer of strife, $name. Take this. I hope it will assist you. Use it in our war against the Coldain scum.");
