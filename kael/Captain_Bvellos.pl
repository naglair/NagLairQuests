...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 30081 => 1)) {
    ...
    quest::summonitem(quest::ChooseRandom(25077,25084));
  	...
  	plugin::Whisper("This indeed points to Wenglawks being a traitor. If only there were more proof I could take this to the king. Thank you, $name, you have done a great service for Kael. Take this mask as a reward for your service to this city.");
    quest::exp(20000);
