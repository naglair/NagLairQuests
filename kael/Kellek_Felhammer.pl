sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 25279 => 1)){
    ...
    plugin::Whisper("Here you go $name. I dunno why master Wenglawks trusts you with this but take it anyways and don't mess up.");
  ...
  # Handin: Voucher for spear 
    ...
    # Spear Delivery (kael)
    plugin::Whisper("Another delivery eh? Be careful with this spear, if you break it I'll break you.");
  ...
  # Handin: Voucher for Mechanical Net  
    ...
    plugin::Whisper("It's hard to belive a $race like you is going to make a trip like this. I don't envy you little fool.");
