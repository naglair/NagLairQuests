...
my $now = quest::saylink("now");
	...
	if($text=~/hail/i)
	{
		plugin::Whisper("Hello $uname. I will soon be able to  upgrade your melee damage charm up to a maximum level of 50 for you if you'd like. At this point I do not have the resources to do so, come back and see me later. ");
	}
