sub EVENT_SAY {
  ...
  # Catfish Croak Sandwich [Part 1]
    plugin::Whisper("Buy, buy, buy. Go ahead, make a purchase. I am not here to talk. Go to Cabilis for talk. Come to Foob for armor. Now hurry and.. Ooh.. Foob is starvings. Foob wish he had his [munch break favorite].");
  }
  ...
  # Catfish Croak Sandwich [Part 3]
    plugin::Whisper("What?!! You dus gets Foob his sandwich for his munch break!! You be a good tail. Gets me two sandwiches, one fer break and one fer work, then me pay you something for the troubles. But it be no trouble. Foob is sure you know [how to make sandwich].");
  }
...
sub EVENT_ITEM {
 #Handin: 2x Catfish Croak Sandwich (12451)
  ...
  # Catfish Croak Sandwich [Part 8][End]
    plugin::Whisper("Me thanks you very much!! Now me stop da tummy grumbles. You have this. And you takes dis. Foob make special, not sold yet, you test it. It is not toughest, but it take a little bashing just like you. It is called Foobscale!!");
