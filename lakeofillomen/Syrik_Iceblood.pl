...
sub EVENT_ITEM {
  ...
  plugin::Whisper("Excellent work, $name. We will study the architecture of these weapons to better the legions of Cabilis. Soon your name will be known among the Iksar.");
