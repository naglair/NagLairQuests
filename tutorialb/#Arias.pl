...
sub EVENT_SAY {
  if ($text=~/hail/i && quest::istaskactivityactive(22,0)){
    plugin::Whisper("We found the other slaves! Not bad, my friend, not bad. No matter what happens in the mines, you should always be able to find your way back here.");
    ...
    plugin::Whisper("Well done, my friend. Take this kobold skull charm. You are now ready to join ranks with the slaves and fight against the Gloomingdeep kobolds. Speak with Guard Rahtiz for your next assignment.");
  ...
  if ($text=~/leave/i || $text=~/escape/i) {
    plugin::Whisper("Here I'll show you how to get out. Come and help us again!");
