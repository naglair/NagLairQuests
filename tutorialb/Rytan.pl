...
sub EVENT_SAY
{
	if ($text=~/hail/i)
	{
		plugin::Whisper("Hello $name. I'm not much of a fighter myself but I can bestow the power of my god's favor. Would you like to be [blessed]?");
	...
	elsif ($text=~/blessed/i) 
	{
		...
		if (quest::istaskactivityactive(22,4)) 
		{
			...
			{
				plugin::Whisper("You seem to be a bit of a caster yourself! You will find that spells and songs can greatly enhance your power. Take this and scribe it in your spell book. I can only hope it helps you against the kobold horde. As you earn money and gain experience you will find other powerful spells. Good luck out there!");
