...
sub EVENT_ITEM{
  if (plugin::check_handin(\%itemcount, 59968 => 1)) {
    plugin::Whisper("Excellent, thank you, $name. Now I can fight along side the revolt against the kobolds. Here take this. I found it in the tunnels earlier. You might need it.");
