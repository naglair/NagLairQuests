...
sub EVENT_SAY { 
   if ($text=~/hail/i) 
   { 
      plugin::Whisper("Hello $name. Before the slave revolt, I was forging picks and shovels. Now I'm making weapons so we can fight back. Mainly swords and spears. Simple stuff. If you give me your weapon, I can make you a better one!"); 
...
sub EVENT_ITEM { 
  if (plugin::check_handin(\%itemcount, 9997 => 1)) { 
    ...
    plugin::Whisper("There you go. That should work much better."); 
   ...
   quest::popup("Weapons", "Absor has fixed up your weapon and placed it back in your inventory. Pick up the improved 
    ...
    plugin::Whisper("Now let me see... Ah ha! Here ya go! A much better weapon to help fend off those nasties!"); 
    ...
    plugin::Whisper("Now let me see... Ah ha! Here ya go! A spiffy, new weapon to aid you in your adventures!"); 
