...
sub EVENT_SAY {
   if ($text=~/hail/i && defined($qglobals{TAKtalk}) && plugin::check_hasitem($client, 41000)) {
      ...
      if ($tak_wins >= 14 && $qglobals{TAKtalk} == 6) {
         ...
         plugin::Whisper("Hail $name. I'm certain that Ruanya sent you to me. That must mean you want to learn more about Takish-Hiz and the elves. I do have an interesting tale about that. Some call it folklore, but I say it is true. The story was passed amongst the wood elves for centuries. Give me some time to organize and we will talk, friend.");
         ...
         plugin::Whisper("So glad you're here. I've been aching to tell my story. Soon after Takish-Hiz was built, not only did Solusek Ro become angry, Innoruuk did as well. He abhorred the sickly sweet and lovely elves and wanted to disrupt the peaceful city and cut into Tunare's heart. Sorry to stop here $name, but I must practice. Don't tell anyone, but I've been learning the geomantic arts!");
         $client->Message(15, "You have received an invaluable piece of information!");
         if ($tak_wins >= 18) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
         }
