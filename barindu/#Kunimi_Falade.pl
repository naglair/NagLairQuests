sub EVENT_SAY {
  ...
  plugin::Whisper("Who are you and what do you want?");
  }
  }
  }
  ...
  plugin::Whisper("I'm sorry. I don't know anyone by that name.");
  }
}
}
...
sub EVENT_ITEM {
 ...
 plugin::Whisper("That should do it. I can't be positive that this will do more than give Ixvet an upset stomach, but we can hope. Please take this to Proteri Amari.");
