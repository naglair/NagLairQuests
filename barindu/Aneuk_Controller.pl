sub EVENT_ATTACK {
    ...
    plugin::Whisper("Finally, a chance to practice our tactics. Constructs, destroy their support troops!");

}

sub EVENT_SIGNAL {
  if($signal == 1) {
    plugin::Whisper("Bring that tray here, girl! I'm famished.");
    plugin::Whisper("Don't keep that all to yourself. Bring some of that fruit over here too!");
