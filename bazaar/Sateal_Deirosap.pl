...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 26055 => 1)) {#Tattered Newsletter
    plugin::Whisper("Ah great, I have been meaning to go and pick one of these up from the Trade Commissioner but I have been very busy with my work. I'm sure Henry has been waiting for my sales report so here it is. Please return it to him for me if you could and thanks again!");
