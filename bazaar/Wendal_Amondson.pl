sub EVENT_SAY { 
if($text=~/Hail/i){
plugin::Whisper("Greetings $name. If you're looking to sell a black horse, I'll be happy to give you a fair price.  If you've got a different color horse you'd like to sell talk to one of my brothers."); }
}
