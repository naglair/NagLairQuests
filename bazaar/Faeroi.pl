...
sub EVENT_SAY {
  if($text=~/hail/i) {
    plugin::Whisper("Hi there $name. It's nice to meet ye. Many great deals here today if I don't say so myself.");
  }
  if($text=~/piece/i) {
    plugin::Whisper("I'm waiting to have a rhino beetle horn delivered to me to finish off Hardam's helm. I do not want to present it to him with one horn, you know. If you wanted to be a big help, any rhino beetles horn would do fine. Bring one to me and I can then finish Hardam's helm and send it back to his shop in your hands.");
  }
}

sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 4757 => 1)) { # Hardams Box of Goods
    plugin::Whisper("Ah Hardam sent you eh. Fair enough then, please let him know I will get to selling these goods as soon as possible and please let him know that the helm will be done soon. All I need is a certain [piece].");
    ...
    plugin::Whisper("Its good to see you again so soon $name. I knew that you would be able to assist me in this task. As I said, here is Hardams finished helm. Please return it to him for me as I cannot leave my booth here.");
