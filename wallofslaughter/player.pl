sub EVENT_CLICKDOOR {
	...
	if($doorid == 11944 || $doorid == 12200){

				$client->Message(15, "An ethereal force pulls you downward through space...");
				#quest::movepc(339,1340,2488,520);
			}
	if($doorid == 11943 || $doorid == 12199){

				$client->Message(15, "An ethereal force pulls you upward through sapce...");
				#quest::movepc(339,1348,5361,6);
			}
		}
