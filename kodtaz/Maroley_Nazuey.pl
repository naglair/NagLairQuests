 ...
 $group = $client->GetGroup();
  ...
  if($text=~/hail/i) {
    if(defined $qglobals{ikkyredo} && $qglobals{ikkyredo} == 1) {
      ...
      plugin::Whisper("You are doing well are you [ready] to face the challenge of the twin struggles?");
    }
