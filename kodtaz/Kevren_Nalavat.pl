...
if ($text=~/some being/i) {
  plugin::Whisper("From what I've been able to gather these people prayed to a god they call Trushar. They believed Trushar was the one who controlled the seas. It was to this deity that they prayed for the destruction of all non-believers and those who exiled them. I tend to wonder if they [prayed for the destruction] of non-believers or the nihil in the city.");
}
if ($text=~/prayed for the destruction/i) {
  quest::emote("scrunches his brow thoughtfully.");
  plugin::Whisper("From the information I've sorted through so far, the nihil in the city kicked the trusik out because they were tired of the fanatic belief in their beloved sea god. I even think that's where the name trusik comes from, a title for exiled believers of a non-existent being. I'm hoping that we can uncover some more of those [mysteries] in the temples beyond.");
}
if ($text=~/mysteries/i) {
  plugin::Whisper("There are still some things that are left unexplained. Most importantly is the fact that we don't know how deep the invader presence goes. We need to discover some of the reasons for the temples, what purpose they serve now, and what the invaders have to do with them. We need to investigate the temples and the remains further for this information. That's where [you come in].");
}
if ($text=~/you come in/i) {
  plugin::Whisper("I haven't had a lot of time to look around the temples, because I was commissioned to scout ahead and remain here for the adventuring parties that would be sent shortly after. Now that those parties are being sent, I have to maintain my post and make sure that those we're sending in to look for the information for us are up to the task. That's the very reason we have designed the [trials].");
}
if ($text=~/trials/i) {
  quest::emote("look turns serious");
  plugin::Whisper("There are any number of new threats with these invaders and we're unsure just how powerful or how many of them there are. We need to make sure that those of you being sent up here to find that information out for us won't be scared off by the destructive force these invaders bring along with them. The trials must be done in a [specific order] and must all be completed before we can allow you to attempt any further work for the brotherhood.");
}
if ($text=~/specific order/i) {
  plugin::Whisper("There exist three temples nearby that you must enter. I have defined these three as the Temple of [Singular Might], Temple of [Twin Struggles], and Temple of the [Tri-Fates]. In each lay the forces of the Legion of Mata Muram who must be destroyed. You must not be fooled, we do not control these temples. The areas are controlled by the [Muramites], but we believe that these places hold the most predictable of the invaders and can be used easily as our testing grounds.");
}
if (($text=~/singular might/i) && (!defined $qglobals{ikky})) {
  plugin::Whisper("Beyond the dark fog to the south lies the Temple of Singular Might. You can find it between the two other temples. In front of the temple you will find a single, smaller temple where another of the brotherhood is waiting for you. Seek out Gazak Klelkek and speak to him about the troubles within the temple.");
...
if (($text=~/twin struggles/i) && (defined $qglobals{ikky} && $qglobals{ikky} == 2)) {
  plugin::Whisper("Beyond the dark fog to the south lies the Temple of Twin Struggles.  It is past the first two temples. Seek out Maroley Nazuey and speak to her about the troubles within the temple.");  #need live text
}
elsif ($text=~/twin struggles/i) {
  plugin::Whisper("I'm sorry $name, but you're not ready to face the second trial. You must first find Gazak Klelkek near the Temple of [Singular Might] and finish the first trial before you may proceed. Return to me when you have accomplished that feat.");
}
if (($text=~/tri-fates/i) && (defined $qglobals{ikky} && $qglobals{ikky} == 3)) {
  plugin::Whisper("Beyond the dark fog to the south lies the Temple of Tri-Fates.  It is the first temple you will come to.  Seek out Kenra Kalekkio and speak to her about the troubles within the temple");  #need live text
}
elsif ($text=~/tri-fates/i) {
  plugin::Whisper("I'm sorry $name, but you're not ready to learn about the third trial. You must first find Gazak Klelkek near the Temple of [Singular Might] and finish the first trial before you may proceed. Return to me when you have accomplished that feat.");
}
if (($text=~/other tasks/i) && (defined $qglobals{ikky} && $qglobals{ikky} >= 4)) {
  plugin::Whisper("If you continue on past the temples you will come to an area called [Martyr's Passage].  Within this area you need to find four different relic's of those who have died there, bring them to me.");
  }
...
if (($text=~/discover their plans/i) && (defined $qglobals{ikky} && $qglobals{ikky} == 5)) {
  plugin::Whisper("The Temple of the Damned is just south of my location.  Explore with caution.");
...
if (($text=~/think you can/i) && (defined $qglobals{ikky} && $qglobals{ikky} == 7)) {
  plugin::Whisper("The Summoner's Ring is just past the Temple of the Damned");
...
if (($text=~/have done all you asked/i) && (defined $qglobals{ikkyalt} && $qglobals{ikkyalt} == 8)) {
  plugin::Whisper("Indeed you have and your help is greatly appreciated. Take this back to L`diava I believe it has the answers she seeks.");
...
sub EVENT_ITEM {
  if ((plugin::check_handin(\%itemcount, 60141 =>1,60142 =>1,60143 =>1,60144 =>1 )) && (defined $qglobals{ikky} && $qglobals{ikky} == 4)) {
       ...
       plugin::Whisper("These glyphs are faded. I won't be able to decipher them until they've been cleaned up. You'll need to go back to the Martyrs Passage and recover some dust from the grounds nearby. Once you've gotten a pile of dust, you'll need to speak with Tublik Narwethar who is south of the Martyrs Passage. He has a stone tablet that can add some clarity to the glyphs with the help of that dust. Hurry along, $name, this information is important!");
      ...
      plugin::Whisper("Very interesting, but very dangerous. I've gone over the glyphs and they suggest there is great danger in the summoning of some kind of ferocious beast. I need to study the markings further, but since I've transcribed them already, you can keep the glyph for your own use. Nicely done, $name.");
    ...
    plugin::Whisper("You have done well, $name.  Speak with Tublik to continue helping us here in Kod'Taz.");
