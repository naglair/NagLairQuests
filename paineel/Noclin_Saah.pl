...
sub EVENT_ITEM {
 ...
 if(plugin::check_handin(\%itemcount, 7107 => 1)){
  plugin::Whisper("Ah! You found him and obviously removed his presence from the yard. You have my thanks, small as it is for such a menial task. Here. Keep this worthless bit of bone for your labors.");
