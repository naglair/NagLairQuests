...
if($text=~/audience/i)
{plugin::Whisper("The Overlord is not seeing anyone at this time. however. I may have work for you. You seem to have some experience with the kobold annoyance in the region. Are you [interested]. $name?");
}

if($text=~/i am interested/i)
{plugin::Whisper("Then I shall give you a task. I assume you are aware of the kobold lair nearby. Many of our adventurous knights and priests crusade to destroy those pests so seeing many Erudites frequent the area is normal. However. it is not normal to see someone carry large crates into the lair and return empty handed. This person's movements also show he is attempting to remain unseen.....the [fool].");
}

if($text=~/what fool/i)
{plugin::Whisper("Whoever it is. obviously is not an Erudite. even though he appears to be. Only an outsider would take us to be such idiots as to fall for their pitiful attempt at disguise. Or perhaps....well. never mind that. I want you to enter the kobold lair and find these crates. Return one to me and we'll decide what to do from there.");
}
              }
...
if(plugin::check_handin(\%itemcount, 1775 => 1)){#heretics report
    ...
    plugin::Whisper("'Listen close $race. When you leave this building, you will find the courier who is bringing the ore. You will kill him, and collect his head and a box of the ore. You will then find the supplier, and collect his head and any other information you find on him. Bring me these four things and you will be rewarded. Do not fail.");
    quest::exp(137180);   
                           }
if(plugin::check_handin(\%itemcount, 1776 => 1,1777 => 1, 18174 => 1, 1778 =>1)){#crate of ore,couriers head,suppliers head,sealed letter

    plugin::Whisper("'Honestly $name, I thought you would not return. Such strength and intelligence in a Knight of Fear I have not seen for quite some time. Wear this in pride of the ancient Ridossan. Perhaps when you are ready, i will give you a more [important task]. This conspiracy must be stopped.'");
    quest::exp(137180);
