...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 18018 => 1)) { #Dark Truth Guild Note
    ...
    plugin::Whisper("Very good, young acolyte. Maintain your diligence in your duties and you will quickly learn the secrets of the Dark Truth.");
