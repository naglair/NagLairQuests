...
if($text=~/Hail/i){
plugin::Whisper("Hello. $name.  Interested in the art of research?  I have several tomes which may aid you in such a pursuit.");
         }
               }
