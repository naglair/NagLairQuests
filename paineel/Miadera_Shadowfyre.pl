...
sub EVENT_SAY {
  if($text=~/hail/i) {
    plugin::Whisper("Ahhhahahaha! The terror that lays over this city like a blanket tingles my bones with vigor. I seek a fellow apostle of Cazic-Thule to assist me in the [summoning of Terror].");
  }
  if($text=~/summoning of terror/i) {
    plugin::Whisper("It will be a frightfully fulfilling summons. To do this, I need an eye of urd, some basalt drake scales, the lens of Lord Soptyvr, and a lock of widowmistress hair.");
  }
}
...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 10523 => 1, 19032 => 1, 14110 => 1, 14109 => 1)) { #Eye of Urd, Basalt Drake Scales, Lens of Lord Soptyvr, Widowmistress Hair
    plugin::Whisper("Yes, this is what I require to summon Terror!"); #Text made up
