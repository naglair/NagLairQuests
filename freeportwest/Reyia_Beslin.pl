...
sub EVENT_ITEM {
   ...
   if(plugin::check_handin(\%itemcount, 10400=> 1, 1903 => 1, 2299 => 1, 10131 => 1)) {
      quest::ding();
      plugin::Whisper("You have proven yourself a mighty warrior. I am honored to present you, $name, with the orange Sash of Order.");
      # Orange Sash of Order ID-10132
   ...
   # Blackened Wand ID-13237 - Blackened Sapphire ID-13238 - Orange Sash of Order ID-10132
      ...
      quest::ding();
      plugin::Whisper("Great job, $name ! Congratulations. With the destruction of these evil items, the wand of the Burning Dead will never bring harm to anyone on Norrath again. It is my honor to present to you, on behalf of Master Closk and the Ashen Order, the red sash. May Quellious be with you always.");
      # Red Sash of Order ID-10133
