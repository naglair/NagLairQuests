...
plugin::Whisper("Hail. good adventurer!  Do you bring word from my [husband]?");

}

if($text=~/husband/i){

plugin::Whisper("Tolkar is his name. My beloved husband. He still lives in Felwithe while I study here. It must be hard on him."); 
...
quest::summonitem(1599); # Powder of Unanimation
  ...
  if(plugin::check_handin(\%itemcount, 1056 => 1)) { #Faded Cloak
    plugin::Whisper("This looks like that cloak Tolkar used to wear?! Where did you get this? He gave it to you? You rescued Linara! Oh my heaven's thank you! Here I will restore the cloaks original power. There you are just like new, may it serve you as well as it did my husband!");
