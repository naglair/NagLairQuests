...
sub EVENT_SAY {
   ...
   plugin::Whisper("Greetings $name, any potions with you today?");
   }
...
sub EVENT_ITEM {
   ...
   if (plugin::check_handin(\%itemcount,13983=>1)) {
      plugin::Whisper("Ha!! What a fool!! I have stolen another potion to add to the crate. I shall make a fortune!! The real Slansin is in back. Now it is time for me to leave.");
