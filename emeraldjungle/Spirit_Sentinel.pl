...
sub EVENT_ITEM {
 if ($faction <= 3) {
  if(plugin::check_handin(\%itemcount, 1668 => 1)){ #Part of Shaman Epic 1.0
   plugin::Whisper("Ahh, you live, shaman! I am glad the beasts of this jungle haven't torn your body asunder. Tell me, do you still walk the path? Are you willing to [continue what you have started]?");
   ...
   plugin::Whisper("Good $class, what am I to do with that?");
  }
 }
 else {
   plugin::return_items(\%itemcount);
   plugin::Whisper("You must become better in tune with the spirits before I allow you to progress further.");
 }
}
