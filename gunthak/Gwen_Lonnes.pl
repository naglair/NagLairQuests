...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 59056 => 1, 59055 => 1)) {#A Sharp Glass Shard, A Torn Luggald Robe
    ...
    plugin::Whisper("Here, place this around your neck and it should offer you some small bit of protection. As long as you're interested in scavenging, you might try to find a few [other things] for me as well.");
