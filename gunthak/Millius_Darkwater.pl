...
sub EVENT_ITEM {
  ...
  # Give Millius the Glowing Black Skull Necklace and he'll tell you that you still haven't found Chester.
    ...
    plugin::Whisper("You still haven't found Chester.");
