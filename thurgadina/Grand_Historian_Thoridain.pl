...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 1418 => 1, 1428 => 1)) {
    plugin::Whisper("My compliments, $name, what a wonderful dish! Please accept my personal Seal as a token of my appreciation. May it give you power over your adversaries.");
    ...
    plugin::Whisper("My compliments, $name, what a wonderful dish!");
    quest::exp(5000);
    quest::faction(49,10); #coldain
    quest::faction(67,10); #dain
    quest::faction(188,-30); #krif
