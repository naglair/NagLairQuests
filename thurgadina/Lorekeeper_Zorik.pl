...
sub EVENT_SAY {
  if ($faction <= 3) { # Require warmly and greater faction
    if ($text=~/hail/i) {
      plugin::Whisper("I seek those who practice the art of dark magicks. I seek those who call themselves necromancers. Are you a necromancer?");
    }
    ...
    if ($text=~/robe/i) {
    plugin::Whisper("If you wish to have a fine robe, bring unto me a torn enchanted silk robe and three pristine emeralds. Then you will receive a robe beyond your wildest dreams.");
    }
    if ($text=~/sleeves/i) {
