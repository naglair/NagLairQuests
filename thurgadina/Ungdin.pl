...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    plugin::Whisper("Uuuuhhh, how goes it, $race? Oh, I'm doin' jest fine down here, just hanging around... Mining! Yes mining for our fearless leader, the Dain. Yessiree... sssoooooo...");
  }
}
