...
sub EVENT_SAY {
 if($text=~/greenmist/i){ #Test of the Hero (Greenmist Quest 6/8)
  plugin::Whisper("Mighty was the mist which covered the land. Mighty is the blade wielded by a crusader.");
  }
  ...
  plugin::Whisper("Shattered!! Three within the crypt. A master must go. To the [grand forge] they must go. Three become one with the spirit hammer.");
  }
