...
sub EVENT_SAY {
    ...
    if ($text=~/disgraced/i) {
        plugin::Whisper("Disgrace upon my soul for failing in my duties. Disgrace of my brethren.");
    }
    if ($text=~/duties/i) {
    ...
    if ($text=~/sword/i) {
        plugin::Whisper("Hands of a twisted brother no longer living.");
    }
    if ($text=~/shield/i) {
        plugin::Whisper("Earthly children of the god of hate. Keeping stand over his dark brothers and sisters.");
    }
