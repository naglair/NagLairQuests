...
plugin::Whisper("I have messages that need to go to - well. right now I have one that needs to go to Kelethin.  Will you [deliver] mail [to Kelethin] for me?");
}
if($text=~/What mail/i){
...
plugin::Whisper("Take this letter to Jakum Webdancer. You can find him at the bard guild hall. I'm sure he will compensate you for your trouble.");
