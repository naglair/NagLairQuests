...
# lore power up section
      ...
      if ($mmc_wins < 2) {
         ...
         # 20 wins - MMCtalk 10, MMCpower 2
         quest::setglobal("MMCtalk",10,5,"F");
         quest::setglobal("MMCpower",2,5,"F");
         plugin::Whisper("$name, it is indeed good to see you again! As you probably figured out for yourself, the Nightrage and Savagefang are caught in an eternal vicious cycle. Mayong Mistmoore continues to be absent and unconcerned with the ways of the catacombs. Consumed with his own importance, as long as his minions remains constant and in balance, it is likely Mayong won't appear here to solidify the pecking order. That means it's up to us to keep these foul creatures under control.");
         $client->Message(15, "You have received an invaluable piece of information!");
         $client->Message(15, "Your Adventurer Stone glows with more power as you gain stature with the Wayfarers Brotherhood.");
         if ($mmc_wins >= 22) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
         ...
         plugin::Whisper("The Bloodguard and the Stewards have been turning their eyes to each other lately. It looks like the Bloodguard is preparing an offensive attack that will all but decimate the Stewards. Words came to me on the wings of a bat about the Stewards trying to convince the elite vampires that the Bloodguard were no longer necessary and tthat a political power struggle may be on the horizon. There was some mention of some strange ore deep within the caverns too.");
         $client->Message(15, "You have received an invaluable piece of information!");
         if ($mmc_wins >= 46) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
         }
         ...
         plugin::Whisper("The Stewards have been collecting some strange ore that carries a strong aura of magic. It's clear that even the wise Stewards are not sure what the ore is for. The Bloodguard have also begun too collect the ore. The lower classes of Mistmoore's Catacombs also have orders to find more of the mysterious fragments.");
         $client->Message(15, "You have received an invaluable piece of information!");
         if ($mmc_wins >= 48) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
         }
         ...
         plugin::Whisper("I think I'm beginning to understand those vampires better. I always wondered why they seemed to coexist quietly while their hated was so palpable it weighed on the air. And there was always death everywhere. During one excursion to the catacombs, I was observing from the inside of a coffin and I saw a silent assassin end the existence of one of the Trueborn. I surmised that assassinations among them must be frequent.");
         $client->Message(15, "You have received an invaluable piece of information!");
         if ($mmc_wins >= 66) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
         }
         ...
         # 76 wins - MMCtalk 38, MMCpower 8
         # theme powerup done
         quest::setglobal("MMCtalk",38,5,"F");
         quest::setglobal("MMCpower",8,5,"F");
         plugin::Whisper("My good friend, $name! I've been contemplating the constant replenishment of the vampires in Mistmoore's Catacombs. It has occurred to me that many fallen comrades and curious Norrathians have succumbed to the vampires' tainted blood. Who can say if the vampires lust for more than only power. Or, has Mayong been visiting his catacombs? I'm not sure, but I'm suspicious. Still, the vampires seek to steal the best and brightest from the mortal realm. For so long as they have depended on secrecy to hide their existence and actions, and now they must not just fight themselves, but us as well. Who is to say what will happen in the future?");
         $client->Message(15, "You have received an invaluable piece of information!");
         $client->Message(15, "Your Adventurer Stone glows with more power as you gain stature with the Wayfarers Brotherhood.");
      }
      elsif($qglobals{MMCtalk} == 38) {
         # theme finished
         #if (defined($qglobals{GUKtalk}) && defined($qglobals{RUJtalk}) && defined($qglobals{MIRtalk}) && defined($qglobals{TAKtalk}) && $qglobals{GUKtalk} == 35 && $qglobals{RUJtalk} == 37 && $gqlobals{MIRtalk} == 34 && $qglobals{TAKtalk} == 39) {
         #   plugin::Whisper("Well, I must say I'm impressed! You know as much as the Wayfarers Brotherhood about these dungeons that have been uncovered. I suggest you go talk to Morden Rasp in light of this accomplishment.");
         #}
         #else {
            plugin::Whisper("Well, I must say I'm impressed! You know as much as the Wayfarers Brotherhood about these dungeons that have been uncovered. Nicely done, $name!");
         #}
      }
      else {
         # need to do more adventuring message - Text made up
         $client->Message(9, "You need to do some more adventuring.");
      }
# end lore section
      }
    }
