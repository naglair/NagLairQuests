...
sub EVENT_ITEM {
	...
	if(defined $qglobals{wizepicK} && plugin::check_handin(\%itemcount,14349 => 1)) {
		plugin::Whisper("Oh wow! You found the oil! Where is the golem? You didn't hurt him did you? I am very fond of him. Anyways, here is your reward a note and staff to give to that guy you were asking me about.");
