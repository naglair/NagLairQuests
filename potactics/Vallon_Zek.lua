--This mob should NOT have a static spawn, he is spawned and controlled by the #vallon_controller

function event_spawn(e)
	eq.set_timer("vzspawned",1000);
	--eq.zone_emote(14,"Vallon  spawned emote!");
	--one second delay so everything processes
end

function event_timer(e)
	--eq.zone_emote(14,"Vallon timer!");
