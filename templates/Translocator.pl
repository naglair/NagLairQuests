...
my $bind = quest::saylink ("Bind Your Soul",1);
...
if($text=~/hail/i)
	...
	if (($qglobals{flagging})==0) {
		#flagged for old world
	  	$client->Message(315,"Well hello there $name. Would you like to go to [qeynos], [east freeport], [west freeport], [halas], [erudin],[surefall], [rivervale], [akanon], [felwithe],[kaladim],[kelethin],[oggok], [grobb], [neriak], [lavastorm], [nektulos], [lobby] or  [abysmal]  -- I can also [bind] and [check] your flagging status. ");

								   }
	if (($qglobals{flagging}) == 1) {
	#flagged for Kunark
      #quest::setglobal("flagging",1,5,"F");
	  	$client->Message(315,"Well hello there $name. Would you like to go to [qeynos], [east freeport], [west freeport], [halas], [erudin],[surefall], [rivervale], [akanon], [felwithe],[kaladim],[kelethin],[oggok], [grobb], [neriak], [lavastorm], [nektulos], [lobby] or  [abysmal] ,[Field of Bone], [firiona] vie, [overthere], [emerald jungle], [skyfire] or [dreadlands]? -- I can also [bind] and [check] your flagging status.");
 
							}
	if (($qglobals{flagging}) == 2) {
	#flagged for Velious
      #quest::setglobal("flagging",1,5,"F");
	  	 $client->Message(315,"Well hello there $name. Would you like to go to [qeynos], [east freeport], [west freeport], [halas], [erudin],[surefall], [rivervale], [akanon], [felwithe],[kaladim],[kelethin],[oggok], [grobb], [neriak], [lavastorm], [nektulos], [lobby] or  [abysmal] ,[Field of Bone], [firiona] vie, [overthere], [emerald jungle], [skyfire], [dreadlands], [Great Divide], [iceclad Ocean], [Western Wastes], [Wakening Land] -- I can also [bind] and [check] your flagging status.");

							}
	if (($qglobals{flagging}) >= 3) {
	#flagged for Luclin
      #quest::setglobal("flagging",1,5,"F");
	  	 $client->Message(315,"Well hello there $name. Would you like to go to [qeynos], [east freeport], [west freeport], [halas], [erudin],[surefall], [rivervale], [akanon], [felwithe],[kaladim],[kelethin],[oggok], [grobb], [neriak], [lavastorm], [nektulos], [lobby] or  [abysmal] ,[Field of Bone], [firiona] vie, [overthere], [emerald jungle], [skyfire], [dreadlands], [Great Divide], [iceclad Ocean], [Western Wastes], [Wakening Land] ... [scarlet] desert, [shadowhaven], [hollowshade], [dawnshroud] peaks-- I can also [bind] and [check] your flagging status.");
