...
sub EVENT_SAY {
 if($text=~/hail/i){
  ...
  plugin::Whisper("Supreme Master Tynn was the only one that has even seen the weapon. I do not know its origin. I tell you though, you would need to be as powerful as he was to be able to wield the weapon. Only an Iksar of the last rung would be able to use it, come back and show me you have earned your Tynnonium Shackle and I will discuss with you what I know.");
 }
 elsif($text=~/tynnonium shackle/i && $Brew == 1){
  plugin::Whisper("Veltar was one with the ways of Tynn. He did return to Cabilis, I know you have rescued him from his cell. He has traveled afar to clear his mind of his torture in the mines. He did not say where his travels would take him. You will have to find him once more and ask him about the Tynnonium Shackle he still wears.");
 }
}

sub EVENT_ITEM {
 if (plugin::check_handin(\%itemcount, 8348 => 4)){
  plugin::Whisper("Ha! How did you know my favorite drink? Master Rinmark told you? That crazy old monk spends his days sitting on that mountain in Timorous Deep doesn't he? And they call me a drunkard! Anyhow, I bet he told you about the Whistling Fists. I have never seen them myself, and have only heard legend passed down by [Master Tynn].");
  quest::ding();
  quest::settimer("Brew",300);
  $Brew = 1;
 }
 elsif (plugin::check_handin(\%itemcount, 4199 => 1)){
  plugin::Whisper("Ah, a monk of the final rung. You should seek Gandan Tailfist in Charasis. He, too, was seeking for a way to advance even further."); #Made this up, unable to find actual text
  quest::summonitem(4199);
  quest::ding();
 }
 else{ 
 plugin::return_items(\%itemcount);
 plugin::Whisper("I don't want that."); #Made this up
 }
}
