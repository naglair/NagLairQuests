...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 19423 => 1) || # convergence
      ...
      plugin::Whisper("Here is the scroll that I promised. We have both gained much today. I hope to do business with you again soon. Farewell.");      
