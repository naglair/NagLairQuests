...
my $EmpRepopTime = int(rand(2)) + 4; #Respawn time for Emp after success (Current setting: 3-5 days)
my $EmpPrepTime = 15; #Seconds before Emp becomes targetable after killing Blood/Golem (Current setting: 2min 30sec)
