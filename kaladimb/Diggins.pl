...
if (plugin::check_handin(\%itemcount, 13931 => 4)) {
  plugin::Whisper("Good work. We shall add these to the stash. Here is your reward, as promised. Be happy with it and continue your work. Maybe soon you shall be able to [earn a parrying pick].");
  quest::faction(29,-10);
  quest::faction(33,-10);
  quest::faction(77,10);
