...
sub EVENT_ITEM {
 ...
 if(plugin::check_handin(\%itemcount, 55470 => 4)){
  plugin::Whisper("I see you have embraced the rage burning from within and have accomplished your task. Take this axe as a reward.");
