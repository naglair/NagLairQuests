...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 21988 => 1)) {#need correct text
    plugin::Whisper("Gandak is alive? That is excellent news, I will get this antidote to his wife right away.  The Emerald Warriors will not forget what you have done $name.  Here is a small token of our appreciation.");
