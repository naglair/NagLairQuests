   ...
   if ($text=~/hail/i) {
      if (defined($qglobals{TAKtalk}) && plugin::check_hasitem($client, 41000)) {
         ...
         if ($tak_wins >= 40 && $qglobals{TAKtalk} == 19) {
            ...
            plugin::Whisper("The bravery of my ancestors really makes my heart proud. Again, Cirwea offered his head and mind for the first experiment the geomancers would perform. His bravery and faith in his fellow geomancers was unequaled. With his usual persuasiveness, Cirwea told his fellow fading elves that they had to try or none of them would survive. Once again, they prepared the summoning room. The tension in the air felt as heavy as the sand bearing down on them. I'm afraid that's all I know at this point. I plan to read more soon.");
            $client->Message(15, "You have received an invaluable piece of information!");
            if ($tak_wins >= 58) {
               $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
            }
