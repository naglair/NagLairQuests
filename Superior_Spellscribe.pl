...
if ($text =~/provide/i){ plugin::Whisper ("$name , I charge 10pp for level 15 spells, 50pp for level 20 spells, 100pp for level 25 spells, 150pp for level 30 spells, 250pp for level 35 spells, 400pp for level 40 spells, 600pp for level 45 spells, or 1000pp for all spells to level 50!");  }
 }
