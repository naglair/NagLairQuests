...
sub EVENT_ITEM {
  ...
  if ($itemcount {14381} == 1 && $faction >= 51) {
    plugin::Whisper("Here, you take this shroud. You must now find the spirit of glohnor and place this item on him. This should force him back into his mummified body and then you must destroy this newly raised form and return to me its wrappings.");
    quest::faction(342, 7);
    quest::summonitem(14377);
  }
  if ($itemcount {14379} == 1 && $faction >= 58) {
    plugin::Whisper("You've done it! Your efforts will stand as a tribute to our kind for time eternal, my friend. Although nothing could possibly serve as a just reward for your accomplishments, please accept this as well as my eternal gratitude. It has been fashioned from the wraps of the mummy and shall protect you well.");
    quest::faction(342, 7);
