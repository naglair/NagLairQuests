...
sub EVENT_ITEM {
   if($faction < 3) {
      ...
      plugin::Whisper("These are not the pieces I need."); #made up text
    }
}
   else {
    plugin::Whisper("I do not know you well enough to entrust you with such an item, yet."); #Made up text
  }
}