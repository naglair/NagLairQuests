...
sub EVENT_ITEM
{
	if(plugin::check_handin(\%itemcount, 55801 => 1)) {#Kyv Heart
		plugin::Whisper("Well done. For every kyv you bring down you save the life of one of my few remaining soldiers. Soon you will be hailed as a friend amongst the few dragorn that still resist the Muramites.");
