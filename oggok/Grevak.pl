...
sub EVENT_SAY {
if($text=~/Hail/i){
plugin::Whisper("Need new members we do not. Powerful enough are we with Grevak. Still. peons needed. Are you a [new peon] or are you an [outsider]? Speak up!! Fool!! No time Grevak has!!");
      }
if($text=~/i am a new peon/i){
plugin::Whisper("So you think you can be greater than Grevak!! Touch you not and still I can smash you. I am a Greenblood shadowknight!! Peon are you. Peons go to swamps and slay lizardmen. You return with four lizardmen tails and a reward is yours. You return with two lizardman shaman dolls and a great reward is yours.");
      }
if($text=~/i am an outsider/i){
plugin::Whisper("Go away or soon your pain will find you.");
            }
}
...
sub EVENT_ITEM {
  if  (plugin::check_handin(\%itemcount, 13354 => 4))
   ...
   plugin::Whisper("Grevak rewards peon with reward instead of smashing you.  Bring me more, peon!");
   ...
   {
   # Text created by Diuretic since nothing found on Allakhazam
   plugin::Whisper("Grevak rewards you. Grevak now afraid of nothing! Ha ha! Mighty mighty!");
