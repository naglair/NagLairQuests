...
sub EVENT_SAY {
 if($text=~/hail/i){ #Part of Shaman Epic 1.0
  ...
  plugin::Whisper("Just waitin' . . . it'll [be ere soon], I s'pose.");
  }
  ...
  plugin::Whisper("Been 'ere since Erud sailed over with his friends. They let me catch a ride on their ship after I told them I needed to come 'ere to wait. He was a nice fella, real smart. Though I'm thinkin' he's dead by now. Maybe [Abe] knows fer sure. Abe's been here longer'n me, even.");
  }
 elsif($text=~/abe/i){ #Part of Shaman Epic 1.0
  plugin::Whisper("Yeah, Abe's an old guy. Well, he's kinda beyond bein' old if ye know what I mean. Not all together either. His mind floats all over like the sea around us. But he's got enough sense to wait here like he's done fer, well, fer dang near ever. If ye see him, and he ain't much fer talkin' straight, ask him about [a broken arrow]. Not sure what it means to him but it seems to bring him around.");
 }
}
