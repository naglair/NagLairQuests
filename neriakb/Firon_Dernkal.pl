...
sub EVENT_ITEM{
	if(plugin::check_handin(\%itemcount, 21974 => 1)) {#Sealed War Documents
		...
		plugin::Whisper("This is terrible news most definitely. I do not know how this could have happened. Gerod was one of the most skilled weapon masters that the Brotherhood has ever seen. I do certainly appreciate your work and dedication to this matter, please take this charm as a token of my appreciation.");
