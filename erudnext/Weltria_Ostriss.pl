...
if ($text=~/I am capable/i) {
  ...
  if (plugin::check_handin(\%itemcount, 31825 => 1)) {
    plugin::Whisper("You have my gratitude, $name! This will make a valuable addition to our historical volumes and perhaps offer some insight into the workings of Kobold society.");
