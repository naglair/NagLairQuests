...
sub EVENT_ITEM {
  ...
  if((plugin::check_handin(\%itemcount, 18195 => 1)) && ($ulevel >= 46) && ($class=="Monk")) {
    ...
    plugin::Whisper("This is a great find indeed! I can only imagine who you had to.. persuade to give you the book. Our library would be very interested in acquiring this and I am prepared to give you this referral that marks you as a friend of the library. If only [Lheao] could see this.");
  ...
  # Handin: Danl's Missing Book
    ...
    # Monk Epic 1.5
    plugin::Whisper("Whats this? How did you know I was missing these pages? I still do not know how you always find a way to help but you have again. Now what is it you can to ask me before? Ah yes, it was regarding the Immortals. It is no coincidence that the pages you just brought me came from the very book you are referring to.");
    ...
    plugin::Whisper("Well I suppose I do owe you the information you had come here seeking. Unfortunately, I do not know much more than what is in this book already. The other references I have found do speak of another [disciple] of Kaiaren.");
  }
  else {
