...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    plugin::Whisper("Welcome. I am Raine Beteria.");
  }
}
...
sub EVENT_ITEM {
  ...
  if(($itemcount{6339} == 1) && ($gold >= 50)) {
    plugin::Whisper("Here is your wand back - I assure you it is now fully enchanted.");
  ...
  #     1000
    ...
    plugin::Whisper("Thank you very much. I have always wanted one of these! Hehehe? Just kidding. I see that you have enchanted this coin. I have placed the final enchantment on it - take it back to Romar.");
