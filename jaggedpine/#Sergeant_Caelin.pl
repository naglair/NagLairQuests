...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 8264 => 4)) { #Gnoll Canine x 4
    ...
    plugin::Whisper("I see that I can fully trust you. Here is your badge back.");
    quest::summonitem(8285); #Marked Qeynos Badge of Honor
    plugin::Whisper("Take this note to Guard Finewine. He is officially on notice...");
