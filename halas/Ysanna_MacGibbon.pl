...
sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 1330 => 1)) 
    ...
    if($faction < 6)
    {
    plugin::Whisper("You have done well. Here is a small reward for your effort.");
    quest::exp("125");
    quest::ding();
