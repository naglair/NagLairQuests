...
sub EVENT_SAY
{
	if($text=~/hail/i)
		{
		plugin::Whisper("Hmph. Hello. how are ye an' how do ye do? Now. what are ye planning to buy?");
                }
	if($text=~/Jinkus sent me to assist you/i)
		{
		plugin::Whisper("About time he get around to it. Hmph. What i be needing you ta do is head on over to Einhorst McMannus in the plains of the western karana region. Give him this and he should have the shipment ready. Bring it back to me when ye be done."); #made up text
