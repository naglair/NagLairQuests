...
if ($wizepicB == 1) {
  if (plugin::check_handin(\%itemcount, 14337 => 1, 14338 => 1, 14339 => 1)) {
      plugin::Whisper("Here, this pack contains all of our items. You will never be able to open it again, so you must deliver the pack, intact, to Solomen. He will then reward you. Now that I have helped you, leave me in peace.");
