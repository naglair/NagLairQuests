sub EVENT_SAY {
  if($text=~/Hail/i){
    plugin::Whisper("Hello there, $name.  Can I interest you in any components to help you in your research?");
  }
}

sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 14331 => 1)) { #Ro's Breath
    plugin::Whisper("So, I've been discovered! You must know Camin - he is one of the only people who could have recognized my work. I have worked very hard to mask my presence here.");
