...
if(plugin::check_hasitem($client, 10651)){
    if ($text=~/hail/i) {
    plugin::Whisper("Ah, yes. You are not only a shaman, but one who has passed the tests of the heyokah. There are many problems that face us now and I grow weaker by the day. If you feel you are ready to bear a great burden and help all of those like us, including the immortals that charge our essence and consciousness, say [it is so].");
    quest::setglobal("shaman_epic",1,5,"F");
    }
    }
    elsif ($class eq "shaman"){
    plugin::Whisper("It Appears you are not yet ready for the great tasks that I require to be done. There are Others lesser than me that can guide you and prepare you to walk a greater path should you choose. You should seek them out. You can Perhaps seek knowledge from your elders and peers.");
    quest::setglobal("shaman_pre",1,5,"F");
  }
    else{
    quest::emote("eyes you with an ageless wisdom."); 
    plugin::Whisper("Ah, your spirit shines brightly. Should I know you?");
    }
