...
sub EVENT_ITEM
{
	if ((plugin::check_handin(\%itemcount, 12126 => 3)) && ($gold + ($silver/10) + ($copper/100) >= 10)) {#3x Shark Bones, 5gp of coins.
		plugin::Whisper("These will do nicely.  Here, take this back to Tonmerk.");#Text made up
		...
		plugin::Whisper("I see Tonmerk has remembered me.  Excellent.  Go bring me shark bones, and I will make his powder directly.");#Text made up
		quest::faction(184, 10);#Knights of Truth
		quest::faction(105, -20);#Freeport Militia
	}
	else {
