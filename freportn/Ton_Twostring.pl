...
plugin::Whisper("I have messages that need to go to Highpass, Kelethin, and Qeynos.  Will you [deliver] mail to [Kelethin], [Highpass], or [Qeynos] for me?");
}
if($text=~/deliver to kelethin/i){
plugin::Whisper("Take this pouch to Idia in Kelethin.  You can find her at the bard guild hall.  I am sure she will compensate you for your troubles.");
quest::summonitem("18167");
}
if($text=~/deliver to highpass/i){
plugin::Whisper("Take this pouch to Lislia Goldtune in Highpass.  You can find her at the entrance to HighKeep.  I am sure she will compensate you for your troubles."); 
quest::summonitem("18156");
}
if($text=~/deliver to qeynos/i){
plugin::Whisper("Take this pouch to Eve Marsinger in Qeynos.  You can find her at the bard guild hall.  I am sure she will compensate you for your troubles.");
...
sub EVENT_ITEM { 
  if(plugin::check_handin(\%itemcount, 18164 => 1) || plugin::check_handin(\%itemcount, 18166 => 1)) {
    plugin::Whisper("More mail - you have done us a noteworthy service!  Please take this gold for your troubles.  If you are interested in more work, just ask me.");
