...
sub EVENT_SAY {
  if($text=~/hail/i) {
    plugin::Whisper("AHHH get it away from me go away .. leave me alone");
  }
  if($text=~/celestial fists/i) {
    plugin::Whisper("Eh? What's that? Bah! That was destroyed long ago. Don't waste my time with fairy taAAAAAGGHHH GET IT AWAY!!!! HELP!!! They're all over MEHEHEHEHEEEEEEee!!");
  }
}
...
sub EVENT_DEATH_COMPLETE {
  plugin::Whisper("Not bad.. Now lets see if you can find my trueform if you do we discuss this further.");
}
