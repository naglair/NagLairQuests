sub EVENT_SAY { 
if($text=~/Hail/i){
plugin::Whisper("On what grounds do you think you are welcome to address me like that vermin? I am afraid you will have to prove yourself to me before I can treat you with any respect. Do you feel that you are [worthy] to stand before me?");
}
if($text=~/worthy/i){
plugin::Whisper("Very well then. you are lucky that I have been looking for some sort of an apprentice to help me out in gathering some hides from those nasty halflings. I did have a young one as yourself working for me before but unfortunately they didn't work out as you can see by looking at this autopsy table. I would hope that you will complete my [tasks]. for your sake.");
}
if($text=~/tasks/i){
plugin::Whisper("If you are willing to [gather some items] that are needed for specific halfling hides I can offer you with the resources necessary to fashion your own armor.");
}
if($text=~/gather some items/i){
plugin::Whisper("Excellent $name. Please take this Old Enchanted Tailors Kit. It contains magical power that is able to fashion specific components into a magical version of whatever the core material is. If you are a Necromancer you will need to gather halfling hides that have been infused with many different elements that you will collect and combine in this box. Simply tell me what pattern you want and I will present you with the recipe necessary for [Gloves]. [Robe]. [Trousers]. [Sleeves]. [Skullcap]. [Bracers] and [slippers]. I  would recommend you fashion your Robe last due to the difficulty and complex nature that is involved with finding the items necessary.");
quest::summonitem("17244");
}
if($text=~/gloves/i){
plugin::Whisper("If you are interested in making your own Unholy Silk Gloves you will need to gather 3 Halfling Hides. 2 Snake Eggs. 2 Spiderling Silks and a Cask which can be found in town. Once you have collected these items combine them in the Old Enchanted box to fashion your Infused halfling hide. Please make sure that you have prepared the correct halfling hide before you approach a loom with the pattern I have given you.");
quest::summonitem("22588");
}
if($text=~/bracers/i){
plugin::Whisper("To make your own Unholy Silk Bracer you will need to gather 1 Halfling Hide. 1 Deathfist Scouts Scalp and 2 Snake Eggs. Once you have collected these items combine them in the Old Enchanted box to fashion your Infused halfling hide. Please make sure that you have prepared the correct halfling hide before you approach a loom with the pattern I have given you.");
quest::summonitem("22584");
}
if($text=~/trousers/i){
plugin::Whisper("To make your own Unholy Silk Trousers you will need to collect many items in the forest along with a few in town. The halfling hide that you will need along with a pattern to craft together these Trousers will need to be infused with 4 Halfling Hides. 2 Bone Chips. 3 Spiderling Silks and 1 Raw Bamboo. All of these items will be collected in the field with the exception of the Raw Bamboo which can be bought in town. Please make sure that you have prepared the correct halfling hide before you approach a loom with the pattern I have given you.");
