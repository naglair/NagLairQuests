sub EVENT_SAY { 
  if ($text=~/hail/i) {
    plugin::Whisper("I do not know what you are doing up here, but I am a busy man. Please return to the bar downstairs and enjoy the atmosphere.");
  }
  if ($text=~/oblong bottle/i) {
    plugin::Whisper("The oblong bottle is a legend. They say one drink and you're off to oblivion, but just before that you feel the best you've ever felt and relive all your finest memories in the blink of an eye. The last I heard, some guy by the name of Turgin Swillfod turned up in Freeport spouting that he had found it. He was never heard from again.");
  }
  if ($text=~/never stop chopping/i) {
    plugin::Whisper("Hey!! You must be the one I traded my axe to. Funny, I thought you were much shorter. If you have my axe then I will return my your gem to you.
Well, let's have it.");
  }
}
