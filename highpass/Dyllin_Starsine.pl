...
sub EVENT_SAY { 
  ...
  if($text=~/Hail/i){
    ...
    plugin::Whisper("Hey!! I don't have any spare change, okay?!"); 

  }

  if($text =~/Testament of Vanear/i) {

    plugin::Whisper("So you heard Guard Dyllin has page 30 of the Testament of Vanear, eh?! Well, get lost!! Over my dead body will you get page 30!");
...
{
 plugin::Whisper("How dare you attack a member of the Qeynos Guard!!");
