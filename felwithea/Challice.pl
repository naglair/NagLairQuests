sub EVENT_SAY { 
if($text=~/Hail/i){
plugin::Whisper("You!  Remove yourself from my presence!  Do you not know to whom you speak?  My husband is a very powerful noble and if you do not do as I say. he will have your head!"); }
}
sub EVENT_ITEM {
	#Note handin:
