sub EVENT_SAY {
  if($text=~/hail/i){
    plugin::Whisper("Leave me alone, beast! Or I will cut your belly open and feed your entrails to the sharks.");
  }
}
...
sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 25107 => 1)){
    ...
    plugin::Whisper("So you are the servant of Wenglawks here to retrieve his cloak.
I will need more scales to make the cloak in his size. I have already slaughtered a good thirty sirens and the cloak is nearly complete. Go forth and slaughter my kind and bring me three excellent scales and this idol. Let this idol be your protection from the wrath of E'ci. I will continue my work on the cloak.");
  ...
  # Handin: Excellent Siren Scales, Idol of Solusek Ro (statless)
    ...
    # Mechanical Net Delivery (kael)
    plugin::Whisper("You are an excellent hunter. Tell me, did you enjoy the screams of the sirens as they perished? I find the sound so wonderful.");
    quest::emote("hands you a gigantic cloak made of slick siren scales.");
    plugin::Whisper("I was done making the cloak already. I just wanted to watch you slay the weak. I thank you for bringing more suffering into the world.");
