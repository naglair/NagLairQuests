  ...
  if ($ulevel >= 15) {
    if (defined($qglobals{Wayfarer}) && ($qglobals{Wayfarer} == 1)) { #PC has spoken to home town Wayfarer recruiter but not received Adventurer's Stone
      ...
      if (!plugin::check_hasitem($client,41000)) { #PC does not have an Adventurer's Stone
        ...
        if ($guk_wins < 2) {
          plugin::Whisper("The curse in Deepest Guk is incredibly strong. It's interesting how Deepest Guk came to be ike it is today. If you manage to do some work for us, I will share the story with you!");
        }
        elsif ($guk_wins >= 2 && $qglobals{GUKtalk} == 0) { #2 wins
          quest::setglobal("GUKtalk",1,5,"F");
          plugin::Whisper("Ahem, sorry. I had a fly stuck in my throat. By the looks of you, I'd say you're an adventurous spirit. Unfortunately, many similar spirits have been lost in that slimy place we now call Deepest Guk. In fact, those who have been overcome by the curse that creeps in there have lost their very souls. I'm hoping the next time we talk I'll have more information for you. Take care, most-promising hero.");
          ...
          plugin::Whisper("It's good to see that you remain healthy, my friend. As time passes, I see more fair Norrathians fall to the curse down there. I do know that the curse was brought upon the frogloks through a troll, but we're hoping to learn more about the nature of it. The curse itself is like a living, breathing monstrosity that feeds on the souls of the living, twisting them into hateful pawns. The curse does have an epicenter too -- and it is most difficult to resist surrender to the curse there. Awful thing, it is. See you soon.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($guk_wins >= 8) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::Whisper("It's no wonder the trolls are so put off by my people. After all, we did rob them of their cities, both Guk and Grobb. I'm thankful that Mithaniel Marr sent down a blessing to the frogloks to help us overcome those foul trolls. You know, since the beginning, frogloks and trolls have warred with one another. I can tell you more later.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($guk_wins >= 10) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::Whisper("Now, Mithaniel Marr, trapped in his prison in the swamps, prayed to his father, Tarew Marr the Water Lord, for salvation until he was so exhausted he fell into slumber. While he slept, Terris-Thule, Queen of Nightmares, attempted to steal Mithaniel Marr's Gift of Life at the behest of Cazic-Thule.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($guk_wins >= 36) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::Whisper("Right, well, when Mithaniel Marr's Gift of Life fell upon the swamps of Norrath, the first blessed froglok tads were born. Those first tads faced the greatest challenges because the swamps were overrun with the destructive minions of the gods of Fear and Hate. Fortunately, the Gift of Life empowered the frogloks with the bravery and valor of Mithaniel. They survived and flourished. And, that is how my frogloks ancestors came to be, but that's not the end of the tale.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($guk_wins >= 40) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::Whisper("Ah, back again I see. I'm glad that Deblik was able to fill in some gaps about what's going on here. It is certainly true that the curse in Deepest Guk is stronger than anywhere else. Our greatest conundrum now is how to stop it. As the curse comes from a portal that touches Innoruuk's powerful Cauldron of Hate, we have a formidable task ahead.");
          $client->Message(15, "You have received an invaluable piece of information!");
          if ($guk_wins >= 70) {
            $client->Message(13, "You have additional information to uncover! Try speaking to this adventurer again.");
          }
          ...
          plugin::Whisper("Stay alert, $name. You have been a good ear and just as much an expert on Deepest Guk as any one of us. Be well in your travels friend. You are fast becoming one of us. Bless you and the Wayfarers Brotherhood.");
          $client->Message(15, "You have received an invaluable piece of information!");
          $client->Message(15, "Your Adventurer Stone glows with more power as you gain stature with the Wayfarers Brotherhood.");
          ...
          plugin::Whisper("Hello again, $name! Have you gained experience in the other dungeons yet? You should talk with some of the other Wayfarers Brotherhood members."); #text made up
        }
        else {
