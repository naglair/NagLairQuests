...
plugin::Whisper("Can't ya see I'm busy working.  Leave me be."); 

}

if($text=~/what armor/i){

plugin::Whisper("Bah, Brodlan should know better than opening his big mouth. Anyway this looks like armor for a dark knight if ye want to trade for it.");

}

if($text=~/what trade/i){

plugin::Whisper("Good ya want to trade. I have the mask, cloak, gauntlets, gorget, girdle, and mace. Just tell me what piece you want to trade for and Ill tell ya what I want.")

}

if($text=~/cloak/i){

plugin::Whisper("For the darkened knight's cloak you'll have to bring me a cloud jewel, a mark of twisted souls, a chilled brazier, and a gem of blue skies.");

}
 
if($text=~/gauntlets/i){

plugin::Whisper("For the darkened knight's gauntlets you'll have bring me a sky jewel, a mark of fright, and a true silver idol");

}

if($text=~/girdle/i){

plugin::Whisper("For the darkened knight's girdle you'll have to bring me an astral jewel, a mark of gloom, some gilded beads, and an etched tablet.");

}

if($text=~/girdle/i){

plugin::Whisper("For the darkened knigh's gorget you'll have to bring me a meteor jewel, a mark of darkness, a runed stone brazier.");

}

if($text=~/mace/i){

plugin::Whisper("For the darkened knight's mace you'll have to bring me a sun jewel, a mark of night, a beaded circlet, and a heating stone.");
