...
plugin::Whisper("Salutations to you and your own. On your way to Katta are ya?");

}

if($text=~/what armor/i) {

plugin::Whisper("Frank must have told ya about the soldier's armor that we both keep to give to those worthy of wearing it. I have the mask, cloak, gauntlets, gorget, girdle, and swords.");

}

if($text=~/what cloak/i){

plugin::Whisper("To get the cloak you will need to get me a meteor jewel, a mark of glory, a ring of wit, and some twilight fish scales.");

}

if($text=~/what Gauntlets/i){

plugin::Whisper("To get the gauntlets you will need to get me an astral jewel, a mark of opposition, and a hope quartz.");

}

if($text=~/what girdle/i){

plugin::Whisper("To get the girdle you will need to get me a moon jewel, a mark of contention, a fire scorched stick, and a hope star ruby.");

}

if($text=~/what gorget/i){

plugin::Whisper("To get the gorget you will need to get me a sun jewel, a mark of pride, and some star dust.");
...
plugin::Whisper("To get the mask you will need to get me a sky jewel, a mark of defiance, and a bag of scarlet sand.");

}

if($text=~/what sword/i){

plugin::Whisper("To get the sword you will need to get me a star jewel, a mark of warfare, a hope fire opal, and some fire powder."); 
