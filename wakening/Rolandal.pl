  ...
  if ($faction==1) {
    ...
    if ($CircletFalinkan=="1") {
      ...
      if (plugin::check_handin(\%itemcount,1861=>1,1864=>1,1865=>1,1863=>1)) {
        plugin::Whisper("So you finally made it ! Head back to Ralgyn to get your reward.");
      ...
      # 1861 : An old worn Talisman (alone, you gave him for identification)
        ...
        plugin::Whisper("It would be my guess that you present this to me in hopes of finding out more about the magics it possesses. Before I can do this I require some rare treasures that you must present to me.");
