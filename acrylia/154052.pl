...
sub EVENT_SAY {
if($text=~/hail/i){
	plugin::Whisper("Thank you for coming. I am not sure what brought you here but I am glad that you have arrived. Andro and I came here as part of a raiding party. Our entire party was captured, all except Andro and I died. In the time we have been here, we have learned of 3 [seals] which protect the inner chambers.");
	}
	
if($text=~/seals/i) {
	plugin::Whisper("Interesting, from what we can tell each of the 3 seals embodies one of the principles with which the grimlings were created, Life, Death, and Spirit. Each of the seals has been enclosed in a Warder whose very existence is tied to the seal. Destroy the [Warder] and the seal falls with it.");
	}
