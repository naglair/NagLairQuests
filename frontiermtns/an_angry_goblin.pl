...
sub EVENT_SAY{
  if ($RegalBandBathezid==1) { # we handed the Signet of Service yet
    ...
    if ($text=~/hail/i){
      plugin::Whisper("'Go away, my life is miserable enough!' The angry goblin looks at you more closely, his rage fading for a moment. 'Are you here with the evidence I was promised? Give it to me if you have it.'");
    }
  }
}
