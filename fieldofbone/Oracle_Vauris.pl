...
sub EVENT_ITEM
{
   ...
   if(plugin::check_handin(\%itemcount, 30989 => 1) && $faction <= 5 && $shmskullquest >= 13)
   {
      ...
      plugin::Whisper("You now share the mark of Rile, Cradossk. Your fates are intertwined.");
