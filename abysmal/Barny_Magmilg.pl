sub EVENT_SAY {
	if ($text=~/hail/i) {
		plugin::Whisper("Hello.  I just caught a huge tuna fish!  Have you ever tried tuna?  It is very good.  I give all the tuna I catch to Chef Chowderly.  He is the world's best tuna chef.  You should go talk to him!");
	}
}
