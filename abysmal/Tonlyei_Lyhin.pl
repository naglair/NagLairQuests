sub EVENT_SAY {
  if ($text=~/hail/i) {
    if(quest::istaskactivityactive(164,4)) { #Tailoring Freebie Step 5
      ...
      plugin::Whisper("You have been of such great assistance to us that I can no longer ask you to spend your days working for us. I thank you. Please, allow me to show you the secret to preparing Muramite etched scales. This method will work on the younger and aged scales.");
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 58052 => 1)) { #Muramite Etched Scales
    plugin::Whisper("Ah, yes. Here are your scales.");
