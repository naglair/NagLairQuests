...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 55570 => 1)) { # Venomous Stonemite Poison Sac
    ...
    plugin::Whisper("Okay, let's see. Simmons begins to craft the sac into the shape of a small bag. He then dips it into some sort of liquid. 'This will preserve your new bag and keep its shape. Here you go, I hope it assists you on your adventures.");  
    quest::exp(500000);
