...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 58074 => 1)) { #Sample of Filtered Taelosian Sludge
    if (quest::istaskactivityactive(171,0)) { #Alchemy Collect Step 1
      ...
      plugin::Whisper("'Bless your ancestors! I could certainly use some Wayfarers Special Waterproofer. It's not that hard to make. You just take this Sticky Tree Sap and combine it with a Sample of Filtered Taelosian Sludge in your medicine bag and you have it. Bring it back to me as soon as you can, I have a lot of potters waiting on that stuff.");
