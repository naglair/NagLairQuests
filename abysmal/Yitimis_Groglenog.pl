sub EVENT_SAY {
  if ($text=~/hail/i) {
    if (quest::istaskactivityactive(168,4)) { #Brewing Collect Step 5
      plugin::Whisper("You've been just a peach helping out! I don't think I need your help any more, you've already done so much. Let me give you the secret I promised and you go out and enjoy the rest of the day.");
  ...
  if ($text=~/lend a hand/i) {
    if (quest::istaskactivityactive(158,0)) { #Brewing Freebie Step 1
      ...
      plugin::Whisper("Well hello! I can certainly use your help. We need to brew up some coffee. I think we'll make Vanilla Coffee today. Just take the Coffee Beans, the Vanilla Beans and the Flask of Purified Sea Water and combine them in a brew barrel. Please rush back and give me the coffee, we'd like to serve it hot.");
