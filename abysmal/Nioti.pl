...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    plugin::Whisper("Yes, what is it? I am a bit occupied right now with quite the [predicament]. I swear things keep getting worse and worse around here.")  
  }
  if ($text=~/predicament/i) {
    plugin::Whisper("Well simply put, we are overwhelmed with repairs. While we made it safely to the shores of the new continent, we suffered some damage to the ship. To make matters worse, we are running out of supplies to complete the needed repairs and I don't have time to return to the mainland to find more. I sure could use some [assistance]. I knew we should have never come here.")  
  }
  if ($text=~/assistance/i) {
    plugin::Whisper("Well I cannot really believe someone would want to help me, but if you really could help, that would be great. I would need you to find four Branches of Sylvan Oak and return them to me. If you do this for me, I will find some way to reward you for your efforts.")  
  }
}
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 19140 => 4)) { # Branch of Sylvian Oak
    ...
    plugin::Whisper("Thanks. I hope that wasn't too much trouble. Seems we need more help. Grumby just informed me that some parts on the bridge have already been damaged by rust. That doesnt sound good at all. We will need your help to get some sort of anti rust agent. What? Hey, dont get mad at me. I am sorry I keep asking for help, but I am just following Grumby's orders. There is a gnomish tinker in Ak'anon named Gilipus that might have something to help us. Go there and hand him this note along with your badge so he knows you are working for Grumby. I promise to reward you for your time when you are done helping us. Take your badge back and give it to me again when you hand in the anti-rusting agent."); 
    quest::exp(60000);
    ...
    plugin::Whisper("Looks like your work here is done. Grumby said I can reward you. Here you go. Thanks again and sorry for all the trouble.");  
    quest::exp(200000);
