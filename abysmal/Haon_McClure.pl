sub EVENT_SAY {
	if ($text=~/hail/i) {
		plugin::Whisper("Hello to you.  I hope your day is going well.");
	}
}

sub EVENT_WAYPOINT_ARRIVE {
	if ($wp == 1) {
		plugin::Whisper("Enough chatter, I'm hungry!  I didn't get to eat my lunch.  I set it down like I always do, right under the netting they toss about each morning.  I went and stuck my hand in there at noon for my food and out jumps a rat!  Darn thing ate my lunch an' nearly scared me outta my pants.");
