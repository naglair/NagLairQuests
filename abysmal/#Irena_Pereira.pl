...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    ...
    plugin::Whisper("You must be the one De'van spoke to. I'm not looking for any of your help. I know that the mighty Absor will return someday and until I am proven wrong I will continue to wait for him to arrive.");
  }
}
