...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 67397 => 1)) {
    ...
    if (defined $qglobals{bic} && $qglobals{bic} >= 1) {
      ...
      plugin::Whisper("While I had accepted Talwin's passing as reality, I still hoped you would save him in time. Either way, I thank you for your effort and for delivering this vital piece of information contained in this report. Please take this. I found it wrapped up in the report. Talwin would have wanted you to have it as it appears to be a gem fragment that could fit into the stone Fezbin gave you. Now that you have finished all that was needed for Barindu, there is still more of the city left to explore and I won't be able to complete my report until it is done.");
    ...
    if (defined $qglobals{bic} && $qglobals{bic_fer} == 11 && $qglobals{bic_riw} == 10 && $qglobals{bic_bar} == 6 && $qglobals{bic_qin} == 4) {
      plugin::Whisper("You have now finished the scouting of the city.  Take this as a reward.  If you are unable to use the result please hand it to me and I will fix your problem");
      quest::summonitem(67527);
      quest::setglobal("bic",11,5,"F");
    }
    else {
      plugin::Whisper("You still have other portions of the city to explore.  Please return when you have finished all areas of the city.");
