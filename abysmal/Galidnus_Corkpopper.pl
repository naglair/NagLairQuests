...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 58152 => 1)) { #Taelosian Tea
    if (quest::istaskactivityactive(168,0)) { #Brewing Collect Step 1
      plugin::Whisper("Let's get you started. Brew us up some Traveler's Tea. Just drop a Small Bundle of Taelosian Tea and a Pinch of Sugar into a brew barrel and combine. The tea it makes is very tasty and very popular with the Wayfarers. Bring the Traveler's Tea to me as soon as you have it.");
      ...
      plugin::Whisper("Much work to do. Dive right in and brew up some Wayfarer Spiced Tea. Just take a Small Bundle of Taelosian Tea and Wayfarer Spice and combine them in a brew barrel. The result is pretty good! Just bring the tea back to me when you have it ready. Thank you."); 
      quest::summonitem(58136,10); #Small Bundle of Taelosian Tea
      quest::summonitem(58211,10); #Wayfarer Spice
    }
    elsif (quest::istaskactivityactive(168,2)) { #Brewing Collect Step 3
      plugin::Whisper("You'll have plenty of experience brewing tea before I'm done with you,' Galidnas smiles. 'I need more Bitter Berry Tea. Personally, I can't stand the stuff, but it goes over well with some folks. Just take a Small Bundle of Taelosian Tea and a Bitter Berry and combine them in a brew barrel. Don't worry, you only need one of those berries, they are really bitter! Bring the tea back to me when you're done.");
      quest::summonitem(58136,10); #Small Bundle of Taelosian Tea
      quest::summonitem(58223,10); #Bitter Berry
    }
    elsif (quest::istaskactivityactive(168,3)) { #Brewing Collect Step 4
      plugin::Whisper("Busy work is never done, is it? Well, I need some Rum Tea brewed up. Simple, but wonderful stuff, especially with that new tea. Combine Small Bundle of Taelosian Tea, Wayfarer Spice and an Ounce of Rum in a brew barrel to make this. It's my favorite drink. Bring it right back here to me as soon as you can, please.");
      quest::summonitem(58136,10); #Small Bundle of Taelosian Tea
      quest::summonitem(58211,10); #Wayfarer Spice
    ...
    plugin::Whisper("Ah, yes. Here is your tea");
