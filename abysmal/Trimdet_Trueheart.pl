...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    plugin::Whisper("Greetings. I am only interested in speaking with those most uplifted of knights known as the [paladin], would you be one?");
  }
  if ($text=~/paladin/i) {
    plugin::Whisper("I have served those such as you my entire life. If you are in need of new equipment such as a [helm], [legplates], [chestplate], [bracer], [vambraces], [gloves], or a pair of [boots] let me know.");
  }
  if ($text=~/bracer/i) {
    plugin::Whisper("A bracer is rather simple to reshape. If you speak to Nalasrine about her findings, she may be able to help you infuse some Muramite metal to strengthen it. Bring me a Muramite Bracer Armor to work with. One sheet of infused Muramite metal along with the new bracer from me placed in a forge should come out perfectly.");
  }
  if ($text=~/helm/i) {
    plugin::Whisper("I can craft a Muramite helm into something suitable for you. Nalasrine has managed to form a powerful compound that reinforces some native materials. Bring me a Muramite Helm Armor piece and I can shape it to suit you, then you must take some Muramite metal that has been infused with Nalasrine's mixture and put it together in a forge to form a new helm.");
  }
  if ($text=~/gloves/i) {
    plugin::Whisper("In order for me to craft you some gloves, you will need to find some Muramite metal. I am sure Nalasrine can assist you with infusing the metal, which needs to be done before you forge it. Bring me the Muramite Glove Armor and I will shape some gauntlets for you. Then all you need to do is the final touch with the infused metal and the gauntlets in a forge.");
  }
  if ($text=~/legplates/i) {
    plugin::Whisper("Reshaping a pair of Muramite legplates into a pair for a noble one such as you is a pleasure. Bring back a pair of Muramite Greaves and two sheets of Muramite metal. Give only the greaves to me for shaping, once I am done with that you will need to take the metal and the greaves to a forge. Don't forget to infuse the metal with the misxture from Nalasrine before you take it to the forge.");
  }
  if ($text=~/chestplate/i) {
    plugin::Whisper("I can easily craft you a chestplate if you bring me back a Muramite Chest Armor. Give that to me and I can make some rough adjustments for you. In order for it to suit you properly however, you will also need to sheets of infused Muramite metal and a forge. Make sure to speak to Nalasrine about infusing the metal.");
  }
  if ($text=~/boots/i) {
    plugin::Whisper("Bring me back some Muramite Boot Armor and I believe I can rework them into something quite fine for you. You will need a sheet of infused Muramite metal along with the new boots from me in a forge to get a good fit. If you need help with infusing process speak to Nalasrine."); 
  }
  if ($text=~/vambraces/i) {
    plugin::Whisper("I shall make you some glorious vambraces. Bring to me Muramite Sleeve Armor and I will start shaping it to fit you. Once you have some Muramite metal talk to Nalasrine about infusing it. Then simply take the new vambraces from me and forge them with some of the infused metal.");
  }
}
