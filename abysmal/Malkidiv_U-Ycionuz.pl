sub EVENT_SAY {
  ...
  if ($text=~/keep helping/i) {
    ...
    if(quest::istaskactivityactive(161,2)) { #Pottery Freebie Step 3
      plugin::Whisper("Wonderful! You are certainly good at working with a kiln, and you've been a great help to me. I have a somewhat more complicated task to be done, if you have the time. We go through mugs here faster than an ogre goes through chocolate. Take this clay and these flasks of water and turn them on a pottery wheel until you have something that resembles a mug. Handles would be helpful, but not necessary. Then take the unfired mug and these Wayfarers seals and carefully fire them in the kiln. Don't worry, those seals are stamped onto tough sea serpent skin, they won't burn. Bring me the mugs when you're done.");
      quest::summonitem(58135,20); #Small Block of Scrap Clay
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 58027 => 1)) { #Chunk of Broken Taelosian Stone Worker
    plugin::Whisper("Ah, yes. Here is your clay.");
