sub EVENT_SAY {
  if ($text=~/hail/i) {
    if (quest::istaskactivityactive(169,4)) { #Jewelcraft Collect Step 5
      ...
      plugin::Whisper("You have been of great assistance to me. It would be improper for me to ask more of you. I will find others to do these tasks. I have learned much doing research while you have been helping me. Let me show you the method I have discovered for preparing the nihilite.");
