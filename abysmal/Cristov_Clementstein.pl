...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 55579 => 1)) { # Cristov's Red Wine
    ...
    plugin::Whisper("Truly Magical! The best I have ever tasted! I cannot believe it! Thank you so much, my friend! Take this as your reward!");
