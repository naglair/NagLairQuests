sub EVENT_SAY {
  if ($text=~/hail/i) {
    if (quest::istaskactivityactive(167,4)) { #Baking Collect Step 5
      plugin::Whisper("You have been a big help around the kitchen! I wouldn't feel right continuing to abuse your kindness.");
      quest::emote("glances around.");
      plugin::Whisper("Take a quick peek into my recipe book. This is the way you grind the Taelosian Wheat into flour.");
  ...
  if ($text=~/further help/i) {
    if (quest::istaskactivityactive(157,0)) { #Baking Freebie Step 1
      ...
      plugin::Whisper("Good! We're trying to stock up for dinner. We usually serve a lot of Wayfarer Pie. It's sort of a pie surprize! If you could run over to the oven and bake up a Hunk of Dough, Wayfarer Pie Tin and Wayfarer Surprise into a nice, tasty pie, that would be great! Bring the pies to me when you're done. No, I'm still not going to tell you what the surprize is."); 
      quest::summonitem(58046,20); #Hunk of Dough
      quest::summonitem(58214,20); #Wayfarer Surprise
      quest::summonitem(58199,20); #Wayfarer Pie Tin
    }
    elsif (quest::istaskactivityactive(157,3)) { #Baking Freebie Step 4
      plugin::Whisper("You have been a big help! I think I can trust you to make some dessert for these ruffians. I need a lot of pastries, or who knows what they might do! Just take this Hunk of Dough and a Dab of Frosting and pop them in the oven! Bring them back piping hot, please!");
      quest::summonitem(58046,20); #Hunk of Dough
