...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 58064 => 1)) { #Pale Nihilite
    if (quest::istaskactivityactive(169,0)) { #Jewelcraft Collect Step 1
      plugin::Whisper("Good. We are in need of some simple pendants made from Pale nihilite, both for sale and for some of our research. Just take this Small Pale nihilite and Thin Silver Chain and combine them in your Jeweler's Kit. Give me the pendants and I will be grateful.");
    ...
    plugin::Whisper("Ah, yes. Here is your Nihilite.");
    ...
    plugin::Whisper("Good work! Here is your new kit.");
