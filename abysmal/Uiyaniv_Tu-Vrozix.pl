sub EVENT_SAY {
  if ($text=~/hail/i) {
    if (quest::istaskactivityactive(162,4)) { #Poisonmaking Freebie Step 5
      plugin::Whisper("You have proven your worth. You need do no more tasks for us. You have done enough and your skills will be more useful elsewhere. Here is the secret we promised you.");
  ...
  if ($text=~/painful tasks/i) {
    if (quest::istaskactivityactive(162,0)) { #Poisonmaking Freebie Step 1
      plugin::Whisper("Your first task will be to create some simple universal suspension. Just take the simple thickener and a vial of Abysmal Sea water and combine them in you mortar and pestle. Return the suspension to me when you are done.");
    ...
    if(quest::istaskactivityactive(162,1)) { #Poisonmaking Freebie Step 2
      ...
      plugin::Whisper("I have plenty for you to do. We need some solvent. We use a lot of it around here. Just put one ounce of mild acid and a vial of Abysmal Sea water into you mortar and pestle and mix them. Go do that and leave me to my work. Only come back to give me the solvent.");
      quest::summonitem(58060,20); #Ounce of Mild Acid
      quest::summonitem(58167,20); #Vial of Abysmal Sea Water
    }
    if(quest::istaskactivityactive(162,2)) { #Poisonmaking Freebie Step 3
      plugin::Whisper("You are skilled enough to do something more challenging. We have some need of simple poison, though I cannot tell you exactly why. Just take a vial of simple suspension and one ounce of weak spider venom and combine them in your mortar and pestle. Bring me the resultant poison and you will earn a little more respect.");
    ...
    if(quest::istaskactivityactive(162,3)) { #Poisonmaking Freebie Step 4
      plugin::Whisper("Good. Now, get to work making some injected poison for me. It's not hard to do. Just take a vial of simple solvent and an ounce of weak snake venom and combine them in your mortar and pestle. Bring me the poison when you are done.");
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 58049 => 1)) { #Muramite Blood
    plugin::Whisper("Ah, yes. Here is your distillate.");
