...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 67608 => 1)) { # Valtron's Writing
    plugin::Whisper("This tome will serve as a remnant of a great warrior who died protecting our realm from the menace of the Muramites. I thank you, $name, and ask that you bring more if you find them.");
