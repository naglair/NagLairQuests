...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 58053 => 1)) { #Preserved Muramite Etched Scales
    if (quest::istaskactivityactive(176,0)) { #Tailoring Collect Step 1
      ...
      plugin::Whisper("Ah, good. The Muramite scales make very supple and durable gloves. They seem to have become a popular item among our own Wayfarers, and so I need you to make some for me. Take one piece of Muramite scale and one glove pattern and combine them in your sewing kit to make the gloves. Please bring them to me when you are done. Thank you.");
      quest::summonitem(58051,10); #Muramite Scale
