...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 1783 => 1)) { #Giant Scalebound Tome
    ...
    plugin::Whisper("Ah... Ah yes... According to this book, the dragonbane herb grows only in one place, deep inside the lair of the sirens. If my memory serves me properly one of the creatures there is very fond of its flavor. I will also need the blood of a dragon, but not just any dragon. The blood must come from a beast of Lord Yelinaks bloodline. Please go now and see if you can find this herb and the dragon blood. No time to waste, child. You will need to take this box to contain and combine the herb and blood in. Once you have accomplished this, please return the box to me.");
    quest::summonitem(17059); #Ornate Reagent Box
  }
  elsif(plugin::check_handin(\%itemcount, 1786 => 1)) { #Sealed Reagent Box
    plugin::Whisper("Ahhh! With the knowledge that I have gained from the Giant Scalebound Tome and these reagents, I can finish my research and create a most powerful spell for you! If successful, I will call it the Porlos Fury spell. It will cause near fatal wounds to any dragon or dragon kin in Lord Yelinaks bloodline. Take this and study it. The magiks contained within will aid you in your fight.");
    quest::emote("hands you the scroll and says,");
    plugin::Whisper("You will need a reagent to channel the magical energies through to enhance the power of the spell. Two peridots will be required to cast this spell. I wish you good fortune in your fight.");
