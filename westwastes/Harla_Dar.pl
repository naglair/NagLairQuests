...
sub EVENT_SAY {
  if ($faction <= 4) {
    if ($text=~/hail/i) {
      plugin::Whisper("I do not have time for you now, $name. My son is lost, and you can not help me.");
    }
    if ($text=~/son/i) {
      plugin::Whisper("Have you seen him? I must find him, he has been gone far to long! If you have harmed him, I will slay you and all of your race! Tell me where he is!");
    }
  }
}
