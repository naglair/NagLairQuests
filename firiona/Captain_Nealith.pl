...
sub EVENT_SAY {
if($text=~/Hail/i){
plugin::Whisper("Hail. adventurer!!  Stand tall and fight for the forest folk and all good races of Norrath. 
...
plugin::Whisper("I salute you!!  Join the hunt.  Reports from the front line indicate a rise in the drolvarg
...
plugin::Whisper("Fine work, $name. I wish all my own troops showed the same tenacity. I salute you. This will
...
quest::faction(193,-50); # -Legion of Cabilis
    ...
    plugin::Whisper("Good work, but you will have to slay more than this to earn your wages.");
} 