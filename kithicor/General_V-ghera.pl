...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 28058 => 1)) {
    ...
    plugin::Whisper("The only object in this wretched world that I even desire is the bruised and bloodied head of that scoundrel, Stanos! Take this back!"); #Made this up, in case someone screws up and tries to hand him other rogue epic items
