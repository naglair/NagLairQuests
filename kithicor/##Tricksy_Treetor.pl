...
sub EVENT_SAY {
	...
	if ($text=~/defensive/i) {
		plugin::Whisper("For those of you new to Norrath, Jack will be able to improve your [valor]. For those who have lasted more than 30 seasons, I can protect you with an [aegolism]. For the rest of you, Eve can bestow upon you a greater [virtue]");
	}
