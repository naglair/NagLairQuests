...
sub EVENT_ITEM {
 ...
 if(plugin::check_handin(\%itemcount, 16548 => 1)){
  plugin::Whisper("Excellent work, $name!! It is obvious that you are a highly skilled tracker and warrior. Accept this reward, my personal sword which has served me well in countless battles.");
...
# plugin::Whisper("We meet again, $name. This log reveals much of the machinations of our dark oppressors, but not enough. Deliver these orders to Bryn in Lesser Faydark, and he will provide you with another weapon to aid in our defense of Kithicor.");
