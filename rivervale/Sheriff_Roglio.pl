...
sub EVENT_ITEM {
 if(plugin::check_handin(\%itemcount, 18733 => 1)) { #Hand in Warrior Recuitment Letter
   ...
   plugin::Whisper("Good work, Deputy $name! We shall soon rid our countryside of the goblin threat. Here are your wages. Eat well tonight!");
