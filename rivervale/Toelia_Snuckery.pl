...
plugin::Whisper("Oh. hi.  Listen. um.. $name. was it?  Listen. pal.  I really don't have time for the friendly-friendly. so why don't you just move on?"); 
...
sub EVENT_ITEM {
 ...
 plugin::Whisper("'What is this?  The pouch is empty!  Where is the Ruby?!  What do you mean you don't have it?  Oh no.  I bet [Chomper] swallowed it!  Get it back and bring it to me.");
 quest::faction(77,5);
 quest::faction(33,5); 
 quest::faction(218,-5);  
 quest::faction(48,5); 
 ...
 plugin::Whisper("'You found it!  Heh.  Good thing you brought it back bub.  This thing isn't priceless, its worthless but at least you proved you are loyal.  Poor ol' Chomper..");
 quest::faction(77,10);
 quest::faction(33,10); 
...
} else { plugin::Whisper("I have no need for this item $name, you can have it back.");
