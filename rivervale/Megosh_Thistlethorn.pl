...
sub EVENT_ITEM {
 if (plugin::check_handin(\%itemcount, 18432 => 1)) { #Handin the Halfling Ranger note
    plugin::Whisper("Excellent! Welcome to the ranks of the Storm Reapers $name! Here is a Tunic that I give all new Storm Reapers.");
   ...
   plugin::Whisper("Excellent work young Storm Reaper $name. Now take this Dull Storm Reaper Machete to a [forge] and sharpen it with a sharpening stone. It may take several attempts to get the blade to an adequate sharpness if you are unfamiliar with the process. Once it is sharpened give it to Bodbin Gimple with a ruined thorn drakeling scales and he will put the finishing touches on what will be a fine weapon!");
    quest::faction(316,5);
    quest::faction(208,5);
    quest::faction(218,5);
    quest::faction(347,-5);
