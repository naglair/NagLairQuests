...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 19689 => 1)){ #Rusbek's Head
    ...
    plugin::Whisper("Welcome young druid. You will need protection while on your adventures. Take this and bring pride to our guild!"); #Text made up
