...
if (plugin::check_handin(\%itemcount,  19661 => 1, 19612 => 1 )) {
      ...
      plugin::Whisper("Yer another one of Megosh's trainees I suppose. This here's a fine weapon for a young Ranger of the Storm Reapers like yerself.");     
      quest::faction(218,5);
      quest::faction(77,5);
      quest::faction(133,5);
      quest::faction(208,5);
  ...
  plugin::Whisper("Yer another one of Hibbs trainees I suppose. This here's a fine weapon for a young Druid of the Storm Reapers like yourself.");
  quest::faction(218,5);
  quest::faction(77,5);
  quest::faction(133,5);
  quest::faction(208,5); 
...
if (plugin::check_handin(\%itemcount,  19662 => 1, 13060 => 1 )) {
      ...
      plugin::Whisper("Yer another one of Kaya's trainees I suppose. This here's a fine weapon for a young Paladin like yerself.");     
      quest::faction(218,5);
      quest::faction(77,5);
      quest::faction(133,5);
      quest::faction(208,5);
