...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 77522 => 1)) {
    plugin::Whisper("Phew! Me are safe from Kaglari's beating. Dank yoo, $name.  Take dis."); #Text made up, I have no reference.
    ...
    plugin::Whisper("Me been waitin for doze. Dank yoo, $name.  Take dis.");
