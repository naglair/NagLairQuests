...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount, 52233 =>1 )) {
    ...
    plugin::Whisper("Your valiant demonstration in the arena has given us all hope that someone can stand against the Muramites. Please accept this trinket as a token of appreciation from our people.");
  ...
  if (plugin::check_handin(\%itemcount, 52235 =>1 )) {
   ...
   if (plugin::check_handin(\%itemcount, 52242 =>1 )) {
    ...
    plugin::Whisper("Aha, you've done it! Thanks to your distractions in the coliseum, the Muramite legion is engulfed in utter chaos. We will take this opportunity to escape. You have saved us all. Oh, I almost forgot! Before I go, take this as a final gift from the Yunjo. It holds much strength, just as you do. Unfortunately I have bad news. Something I could not tell you until now. Reyna passed on a few days ago. Her last request was that I give this to someone who had proven his or her worth. You have more than done that. I wish there were more I could do, but we are masters of shaping stone not life.
");
    quest::summonitem(52094);
    plugin::Whisper("I can't wait to be reunited with my family! Let's get out of this place.");
