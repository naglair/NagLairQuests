  ...
  if($ulevel >= 15) {
    if(plugin::check_hasitem($client, 41000) || $client->KeyRingCheck(41000)) { #Adventurer's Stone
      ...
      if($text=~/commonlands/i) {
        ...
        quest::movepc(22,-179,-1617,5,0); #East CommonlandsCommonlands
      }
      ...
      plugin::Whisper("You will have to excuse me, I am quite busy studying this Farstone and the possibility of using the magic stored inside of it.");
    }
  }   
