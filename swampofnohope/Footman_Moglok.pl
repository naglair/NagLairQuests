sub EVENT_SAY {
  if ($text=~/hail/i) {
    ...
    plugin::Whisper("Woe is me. I am nothing more than a lowly footman. And spare me the smart remarks - 'Moglok the Froglok' - I have heard all the jokes.");
  }
}
