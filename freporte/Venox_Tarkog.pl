...
sub EVENT_SAY
{
   if($text=~/Hail/i)
   {
   plugin::Whisper("Welcome to the shrine of the Dismal Rage.  May [Innoruuk] guide your every move in life.  Here. we will teach you to release your rage unto the world.  My priests are at your disposal.");
   }

   if($text=~/Innoruuk/i)
   {
   plugin::Whisper("You do not even know the name of the Prince of Hate!  That is a crime in here.  Our god Innoruuk speaks with Pietro Zarn himself.  It was Innoruuk who told him to create the Dismal Rage.  You should speak with our family.  Perhaps someone will help you better understand our beliefs.");
   }
}
...
sub EVENT_ITEM
{
   ...
   {
   quest::ding();
   plugin::Whisper("Take this to help you on your journeys #name.");
   quest::exp("50");
   # Faded Crimson Tunic ID-13561
