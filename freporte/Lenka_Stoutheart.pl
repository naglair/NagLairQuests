...
sub EVENT_SAY
{
   if($text=~/Hail/i)
   {
   plugin::Whisper("If I catch the little thief who took my pouch, may the Wolves of the North have no mercy on em!!");
   }
}
...
sub EVENT_ITEM
{
   ...
   {
   quest::ding();
   plugin::Whisper("Oh!! You must work for that Erudite named Palatos. I guess he won't have to spend anymore money drinking in Freeport. Here. Here is the portrait I kept until he could get me a new boat beacon.");
   quest::exp("100");
