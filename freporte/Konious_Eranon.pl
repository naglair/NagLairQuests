...
sub EVENT_SAY
{
   if($text=~/Hail/i)
   {
   plugin::Whisper("Greetings!  I am the mighty Konious Eranon, Master Enchanter, devoted follower of Innoruuk, and loyal assistant to the all-powerful Nexvok.");
   }
}
...
sub EVENT_ITEM
{
   ...
   {
   quest::ding();
   plugin::Whisper("Take this $name, to help you in your journeys.");
   quest::exp("100");
