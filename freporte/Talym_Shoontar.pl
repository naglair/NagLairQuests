...
sub EVENT_SAY
{
   if($text=~/Hail/i)
   {
   plugin::Whisper("Hello $name, I hope your hunt is going well.");
   }
}
...
if ($signal == 1)
   {
    plugin::Whisper("Antonius Bayle is a blithering fool.");
...
if ($signal == 2)
   {
    plugin::Whisper("All right, Tlin! I am going to smash your face in!");
   } 
