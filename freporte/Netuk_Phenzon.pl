...
sub EVENT_ITEM
{
   ...
   {
   quest::ding();
   plugin::Whisper("This isn't much, but let it show you the gratitude the Dismal Rage has for your deeds.");
   quest::exp("100");
