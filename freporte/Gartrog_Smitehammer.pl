...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 17859 => 1, 10908 => 1)) { #Red Scabbard (Old), Jagged Blade of War (Old)
    ...
    plugin::Whisper("Ah, a fine job! Your new weapons, $name! Good luck on your travels and if you find any of the augmentation stones, you can now use them to make these fine weapons ever finer!");
