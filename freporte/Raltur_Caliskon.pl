...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 18822 =>1 )) {
    plugin::Whisper("So the great Antonius Bayle wishes to ally himself with the mighty Knights of Truth. How pathetic. It would appear that the alliance has spawned infiltrators of sorts. Of course, we of the Dismal Rage are already aware of this, but I am sure Sir Lucan D'Lere knows nothing as usual. I have a [mission] for any evil shadowknight of Innoruuk.");
    quest::exp(5000);
    quest::faction( 235,1 );
    quest::faction( 86,1 );
    quest::faction( 184,-3 );
