sub EVENT_SAY {
  if ($text=~/Crypts of Nadox/i) {
    plugin::Whisper("'How am I supposed to know? Sounds like some darn troll lair. You're the adventurer, why don't you go investigate it. I will stay here to look for more clues.");
  }
}
