...
sub EVENT_SAY
{
   if($text=~/Hail/i)
   {
   plugin::Whisper("Who are you that you dare to speak with the great Pietro Zarn!! I see nothing more than a whelp in front of me. Innoruuk himself speaks with me. And now you expect me to waste words on you, a common. Begone $name . You have nothing to peak my interest, only my rage.");
   }
}
...
sub EVENT_ITEM
{
  ...
  {
   quest::ding();
   plugin::Whisper("I will deal with this $name. Take this and know that you are welcomed by the Dismal Rage.");
   quest::exp("100");
   # Rage War Maul ID-12153 
