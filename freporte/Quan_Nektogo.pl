...
sub EVENT_SAY
{
   if($text=~/Hail/i)
   {
   plugin::Whisper("Sorry friend. I have nothing to sell at the moment. These taxes imposed by the Freeport Militia and the Coalition of Tradefolk take a heavy toll on us poor folk.");
   }

   if($text=~/forge/i)
   {
   plugin::Whisper("You can find them all over freeport. Inside and out of many of the buildings where Weapons and armor are sold.");
   }

    if($text=~/dismal knight boots/i)
   {
   plugin::Whisper("To assemble Dismal Knight Boots you will need to obtain two bricks of crude iron and smelt them in a [forge] with a Water Flask and this crude Boot Mold. Once that is done combine the Crude Iron Boots with two Ruined Cat Pelts, and two Large Leaf Scarab Tarsi in the Mail Assembly Kit.");
   quest::summonitem(19634);
   }

   if($text=~/dismal knight bracer/i)
   {
   plugin::Whisper("To assemble a Dismal Knight Bracer you will need to obtain a brick of crude iron and smelt it in a [forge] with a Water Flask and this Crude Bracer Mold. Once that is done, combine the Crude Iron Bracer with a Ruined Cat Pelt and a Leaf Scarab Sternite in the Mail Assembly Kit.");
   ...
   {
   plugin::Whisper("To assemble Dismal Knight Gauntlets you will need to obtain two bricks of crude iron and smelt them in a [forge] with a Water Flask and this crude Gauntlet Mold. Once that is done combine the Crude Iron Gauntlets with a Ruined Cat Pelt and two Leaf Scarab Tarsi in the Mail Assembly Kit.");
   quest::summonitem(19633);
   }

   if($text=~/dismal knight greaves/i)
   {
   plugin::Whisper("To assemble Dismal Knight Greaves you will need to obtain two bricks of crude iron and smelt them in a [forge] with a Water Flask and this Crude Greaves Mold. Once that is done combine the Crude Iron Greaves with two Low Quality Cat Pelts and two Large Leaf Scarab Sternites in the Mail Assembly Kit.");
   quest::summonitem(19636);
   }

    if($text=~/dismal knight helm/i)
   {
   plugin::Whisper("To assemble a Dismal Knight Helm you will need to obtain two bricks of crude iron and smelt them in a [forge] with a Water Flask and this Crude Helm Mold. Once that is done combine the Crude Iron Helm with a Ruined Cat Pelt and two Large Leaf Scarab Eyes in the Mail Assembly Kit.");
   quest::summonitem(19631);
   }

   if($text=~/dismal knight vambraces/i)
   {
   plugin::Whisper("To assemble Dismal Knight Vambraces you will need to obtain two bricks of crude iron and smelt them in a [forge] with a Water Flask and this Crude Vambrace Mold. Once that is done combine the Crude Iron Vambraces with a Low Quality Cat Pelt and two Large Leaf Scarab Patella in the Mail Assembly Kit.");
...
sub EVENT_ITEM
{
   ...
   plugin::Whisper("May your new sword see the deaths of many enemies!");
   quest::exp("100");
   # Dismal Rage Long Sword ID-19940
