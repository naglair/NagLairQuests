...
sub EVENT_SAY
{
   if($text=~/Hail/i)
   {
   plugin::Whisper("What do you want?  Can't you see that I wish to be alone?!  I have no need nor desire to speak with anyone.  I have a minor dilemma to ponder and the only person I wish to speak with is the [captain].");
   }

    if($text=~/captain/i)
   {
   plugin::Whisper("If you have to ask that. you should not be in this fine establishment.");
   }

   if($text=~/Danaria sent me/i)
   {
   plugin::Whisper("If you are working for Danaria, you have been misguided. You will go back to her empty handed. Now leave. The [captain] and I have some business to discuss.");
   }
...
sub EVENT_ITEM
{
   ...
   {
   quest::ding();
   plugin::Whisper("Ahh.. I.. Need help.. You.. take this.. Go build.. boat beacon. Ask gnomes about.. boat beacon. They know how.. Then bring back.. Unnnhh!! Prexus help me!! I will never drink again.");
   ...
   {
   quest::ding();
   plugin::Whisper("Thanks.. That saved me a lot of money. Now I can spend more time with the captain before I give this back to Lenka Stoutheart. Here is a little so...mething.");
   quest::exp("200");
