...
sub EVENT_SAY { 
  if ($text=~/hail/i) {
    plugin::Whisper("Get out you pesky $race! I don't need any $race germs! Out, ye filthy beast!");
  }
  if ($text=~/mystical instrument/i) {
    plugin::Whisper("I have made many mystical instruments in the past. Each one seemed to be better then the last. I have always had a dream of building the world's best lute, but I have yet to find someone brave enough to gather the components needed to make the instrument.");
  }
  if ($text=~/components/i) {
    plugin::Whisper("To make a mystical lute I will first need to make several pieces. If you bring me the backbone of an ancient fishman, a strong tentacle from one of the long lost amalgyms, and a petrified skull of a lycanthrope I may be able to create the head and neck of the instrument. If you go out and gather these things, make sure to bring me the note I gave you or I might forget who you are. I am getting quite old, you know.");
  }
  if ($text=~/next pieces/i) {
    plugin::Whisper("The next pieces are a little harder to come by than the last set. To make the body of an instrument that will last for ages to come, I need something very special. The scales of a big red dragon and the scales of a big white dragon will make it unbreakable, as well as giving it a unique look. Some metal bits will allow me to hold the body together. Please, if you gather up these things, bring them to me as soon as possible. I have not felt this good in years!");
  }
}

sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 20378 => 1)) { #Note to Forpar Fizfla
    plugin::Whisper("So you know Vedico! How is the lass? If Vedico would give you the time of day, you must be something special. What can I do for you? I hope you have not come to have me make another [mystical instrument].");
    ...
    plugin::Whisper("Wow! I didn't think a $race like you would be able to gather all of those things.");
    ...
    plugin::Whisper("Now, do you want to gather the next pieces for me?");
  }
  elsif (plugin::check_handin(\%itemcount, 11602 => 1, 11622 => 1, 16905 => 1)) { #White Dragon Scales, Red Dragon Scales, Metal Bits
    plugin::Whisper("Wooooooo! You are doing a wonderful job, $name. I wish I could go out and gather these things myself.' Forpar sits back down at his desk and pulls several very strange looking tools out. Eventually he looks up at you and says, 'The body is done! Only one more piece to go!");
    ...
    plugin::Whisper("Goodness! I can hardly contain myself! This will be my greatest creation ever!");
    ...
    plugin::Whisper("I hope you find a good use for that! I bet you could play it from the mountaintops and the people below would hear you. Thank you, $name, for making my lifelong dream come true!");
