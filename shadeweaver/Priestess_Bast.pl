...
sub EVENT_ITEM {
	if(plugin::check_handin(\%itemcount, 30856 => 1, 30853 => 3)){#The Champion's Cape, 3x Drop of Loda Kai Blood 
		plugin::Whisper("You are indeed a friend to us and have earned a place of high honor among our people and our four-legged cousins. Wear this robe with pride and none will ever doubt your conviction for the honor of the felidae.");
