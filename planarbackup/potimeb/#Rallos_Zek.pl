...
sub EVENT_AGGRO {
       plugin::Whisper("Defeating my sons in battle is impressive, but your legacy ends now. If no one else can stop these mortals, then the power of War shall!");
}
...
sub EVENT_DEATH_COMPLETE {
        ...
        plugin::Whisper("My mantle shall never be passed on. . .");
