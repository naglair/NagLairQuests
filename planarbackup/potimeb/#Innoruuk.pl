...
my $h;
sub EVENT_AGGRO {
       plugin::Whisper("Your kind have invaded my home for long enough. If you thought you knew what hate was before, I have one last lesson to teach you!");
}
...
sub EVENT_DEATH_COMPLETE {
        ...
        plugin::Whisper("This cannot be. . . I will return. . . somehow, in some way. . .");
}
