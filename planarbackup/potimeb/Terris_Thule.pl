...
sub EVENT_AGGRO {
       plugin::Whisper("Now is the chance to prove my power reigns supreme. Prepare to feel the power of nightmares shatter your soul!");
}
...
sub EVENT_DEATH_COMPLETE {
        ...
        plugin::Whisper("My armies have failed. . . how could this have happened?");
