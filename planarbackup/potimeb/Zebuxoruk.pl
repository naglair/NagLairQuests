...
if($timer eq "zeb3"){
    plugin::Whisper("Druzzil, I have missed you. Wasn't it you that taught me in your own realm to seek knowledge and share it in all forms?");
