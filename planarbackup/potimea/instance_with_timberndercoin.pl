...
if ($text =~/hail/i) 
	...
	if ($text =~/Enter Instance 1/i) 
		{
			$client->Message(315, "$npc_name says, 'Give me 1 platinum to enter [PotimeB] Instance Version (1)'");
		} 	# End Instance 1
	if ($text =~/Enter Instance 2/i) 
		{
			$client->Message(315, "$npc_name says, 'Give me 2 platinum to enter [PotimeB] Instance Version (2)'");
		} 	# End Instance 2
			if ($text =~/Enter Instance 3/i) 
		{
			$client->Message(315, "$npc_name says, 'Give me 3 platinum to enter [PotimeB] Instance Version (3)'");
		} 	# End Instance 3
			if ($text =~/Enter Instance 4/i) 
		{
			$client->Message(315, "$npc_name says, 'Give me 4 platinum to enter [PotimeB] Instance Version (4)'");
		} 	# End Instance 4
			if ($text =~/Enter Instance 5/i) 
		{
			$client->Message(315, "$npc_name says, 'Give me 5 platinum to enter [PotimeB] Instance Version (5)'");
		} 	# End Instance 5
}
...
sub EVENT_ITEM
{
	  if ($platinum == 1) # IF 1k+ plat for instance 2
		...
		if (defined($qglobals{"PotimeBInsta1"})) { ### IF THERE IS AN INSTANCE ASSIGNED!
		 ...
		 # End plat > 1
		 if ($platinum == 2) # IF 1k+ plat for instance 2
		{
		...
		if (defined($qglobals{"PotimeBInsta2"})) { ### IF THERE IS AN INSTANCE ASSIGNED!
		 ...
		 # End plat > 2
		 		 if ($platinum == 3) # IF 1k+ plat for instance 3
		{
		...
		if (defined($qglobals{"PotimeBInsta3"})) { ### IF THERE IS AN INSTANCE ASSIGNED!
		 ...
		 # End plat > 3
				 		 if ($platinum == 4) # IF 1k+ plat for instance 4
		{
		...
		if (defined($qglobals{"PotimeBInsta4"})) { ### IF THERE IS AN INSTANCE ASSIGNED!
		 ...
		 # End plat > 4 
		 				 		 if ($platinum == 5) # IF 1k+ plat for instance 4
		{
