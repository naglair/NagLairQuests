...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 28445 => 1, 9430 => 1)) {#Spell: Draught of Thunder, Lightning Sphere
    plugin::Whisper("Thank you $name!  May this spell serve you well.");#Text made up, no text listed on alla's
