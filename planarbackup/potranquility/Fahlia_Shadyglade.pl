sub EVENT_SAY {
	if ($pop_cod_bertox == 1 && $pop_ponb_terris == 1) {
		if ($pop_pot_saryrn == 1 && $pop_pot_newleaf == 1 && $pop_pot_shadyglade == 1) {
			...
			if ($text=~/Hail/i) {
				plugin::Whisper("Oh thank you for helping Tylis! We will be forever in your debt");
		...
		plugin::Whisper("I can see that you may be passionate to help others but now I must ask you to be about your own business. I sense that if you were to try to help you may befall the same fate as poor Tyllis. Perhaps you should become more experienced in travelling through the planes before you learn more about his condition.");
	}
