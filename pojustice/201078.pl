         ...
         if ($in_progress == 0) {
            ...
            if ($group) { 
              for ($count = 0; $count < $group->GroupCount(); $count++) {
                ...
                if ($pc->CalculateDistance($x,$y,$z) <= 500000) {
            ...
            quest::say("I'm sorry, the Trial of Execution is currently in progress and unavailable to you.");
         }
      }
