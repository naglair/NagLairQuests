sub EVENT_SAY {
  ...
  quest::emote("Smith Dandi looks to Lirprin for approval and he nods. She turns to you again, smiling broadly, and clasps your fingers in a warm handshake.");
    plugin::Whisper("Smith Dandi is my name. I trained under Rondo before we lost him in that horrible incident, bless his poor soul. Lirprin says it's okay to talk, and I understand you have a job for me? Let's see if you have what we need. . .");
    
    #Flag Check
    
    plugin::Whisper("Hmm, you're still missing a few things. Keep at it, $name");
    #set Culthor flag
  }
}
