sub EVENT_SAY {
  if($text=~/hail/i) {
    plugin::Whisper("Hey there stranger, pleased to meet you. I'm Ruru, I do the cooking around here. I'm the best cook around these parts. So, if you get hungry, you'd best be making sure you're coming to see me.");
...
sub EVENT_SIGNAL {
  if($signal == 1) {
    plugin::Whisper("Hah! Whatever Grudash. You know that my Roasted Walrus in Plum Sauce is better. You just don't want to admit it.");
    quest::signalwith(114467,1,1); #Grudash the Baker
  }
  if($signal == 2) {
    plugin::Whisper("Just you wait, just you wait! One of these days Grudash, you'll see.");
