...
sub EVENT_ITEM {
  if ($faction <= 3) { # requires kindly faction
     ...
     plugin::Whisper("You have made good on your word, $name.  This is indeed what I have been seeking, and as promised I will keep my end of the bargain. Take this mask and wear it with pride, it is symbolic of your aid to the The Draconic Loyalist Fellowship.");
