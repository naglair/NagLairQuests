...
sub EVENT_ITEM {
  ...
  if(plugin::check_handin(\%itemcount, 11990 => 3)){
    ...
    plugin::Whisper("Well done $name! The Draconic Loyalist Fellowship and the residents of Skyshrine are grateful for your assistance in eliminating the threat the Kromzeks mercenaries pose to the dragons and dragon-kin of Velious. Here is the bounty that has been promised.");
  ...
  # Handin: Captain Glargs Brooch, Captain Mc'Hershs Brooch, Captain Ulmogs Brooch
    ...
    plugin::Whisper("This is good news indeed for the dragon-kin of Skyshrine. Word will be passed to the rulers of Skyshrine of the assistance you have provided the Draconic Loyalist Fellowship. Here is the bounty that has been promised for the lives of the mercenary captains.");
  ...
  # Handin: Grenth Drakebane's Head, Julius Oresco's Head, Rontar O'Karn's Head, Sadeem Oujva's Head
    ...
    plugin::Whisper("Congratulations on successfully eliminating this deadly band of murderous mercenaries. The nobles of Skyshrine will be pleased with your actions, as is the Draconic Loyalist Fellowship. Here is the bounty that has been promised for the lives of these notorious slayers of dragon-kin.");
