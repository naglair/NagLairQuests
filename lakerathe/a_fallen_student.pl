...
sub EVENT_ITEM {
 ...
 if(plugin::check_handin(\%itemcount, 48122 => 1)){
  # Monk Epic 1.5
  plugin::Whisper("Where did you find this? Could it really be happening now, after all of this time? It couldnt be. He had been defeated... there is little [time] left for us now I am afraid.");
  }
 # Handin: Seal of Cedrick & Seal of Mystik
 elsif(plugin::check_handin(\%itemcount, 48100 => 1, 48101 => 1)){ 
  # Monk Epic 1.5/2.0 (Prequest)
  plugin::Whisper("I see you do have the skill that is needed to continue this quest, but you must now face your hardest foe yet. For your final task, you will be alone, and in that moment you will have to face your true self. Many cannot bear to see what they find within. It is at that time we really see what we are capable of. If you wish to continue, I will [show you the way].");
 }
 # Handin: Medal of Identity
  ...
  plugin::Whisper("So I see you do truely have the ability to follow the path of the Enlightened. I am sorry I was not sure before but I am now. Now I must tell you of my [cursed dreams].");
 } 
}
