...
sub EVENT_SAY
{
   if($text=~/Hail/i)
   {
   plugin::Whisper("I suppose you're one of Nestrals new employees, eh? Well if that's the case I can help get you outfitted with some [gear] necessary for people in this [line of work].");
   }

   if($text=~/gear/i)
   {
   plugin::Whisper("The first thing you need is a suit of sturdy traders clothing. Take this note to Verona Rankin and she'll help you with a suit tailored to your needs. Once you have been outfitted in your traders clothing return to me and I will inform you of your [next task].");
...
sub EVENT_ITEM
{
   ...
   if (plugin::check_handin(\%itemcount, 19918 =>1 )) {
     ...
     quest::ding();
     plugin::Whisper("Sharpen this dagger and take it with this gem and a rattlesnake skin to Verona Rankin.");
     quest::exp("100");
     # Faceted Blue Gem ID-19919
