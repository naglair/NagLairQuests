...
sub EVENT_ITEM {
 if (plugin::check_handin(\%itemcount, 19933 =>1 )) {
   plugin::Whisper("Thank you $name.  Your work makes the Dismal Rage even stronger.  Take this as your reward.");
