...
sub EVENT_AGGRO {
  plugin::Whisper("You shall regret trespassing into my chambers. Rise my minions and show them how well I have learned to use the power of this land's creatures. Destroy them all. Leave only enough to feed the hounds.");
  }
...
sub EVENT_HP {
  ...
  if($hpevent == 51) {
    plugin::Whisper("So it seems you are not so easily defeated after all. I am through toying with you fools. Prepare for the reality of death.' Riel's body begins to speed up as her attacks become increasingly vicious.");
    quest::setnexthpevent(31);
    quest::modifynpcstat("attack_speed",-40);
  }    
  if($hpevent == 31) {
    plugin::Whisper("You and your friends are starting to annoy me. Come forth my little experiments choose one of these fools and show them the surprise you have waiting.");
    quest::settimer(1,60);
  ...
  if($hpevent == 11) {
    plugin::Whisper("That's it! You have past the point of being bothersome. I grow weary of this encounter. It is time for it to end.");
