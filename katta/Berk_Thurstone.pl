...
sub EVENT_ITEM {
 ...
 if(plugin::check_handin(\%itemcount, 29843 => 1)){
  ...
  plugin::Whisper("Aww, noice, this'll do just right. Thanks millions, $name. Yer ok by me, ye are.");
