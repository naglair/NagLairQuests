...
plugin::Whisper("Ho there, who are you? Are you [reporting for duty] or just annoying me?");

}

if($text=~/reporting for duty/i){

plugin::Whisper("Outstanding, now tuck in that tunic. We are trying out some new Shadowscream armor from Barkhem, the smith in Shar Vahl, and some of his students. They will cut us a nice deal if we deliver some of the supplies, so go fill this up with shrieking substances for me. What are you staring at? Go!! And suck in that gut!");
...
plugin::Whisper("Well done, $name, this should really help keep our costs down. Here, take these, and keep up the good work. Dismissed!");
