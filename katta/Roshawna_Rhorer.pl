...
sub EVENT_ITEM {
    ...
    plugin::Whisper("You have done a great service for these poor souls. I have sent for a courier to come for the chest of skulls but he is quite late in his arrival.");
	quest::me("The runes inscribed on the chest and iron bands begin to softly glow with a golden light.");
	plugin::Whisper("I will keep it safe until the courier arrives.");
	...
	plugin::Whisper("It appears this situation is much more dire than we had first presumed. It would be unsafe to send this crate within the walls of Shar Vahl should another innocent be possessed and the tormented Vah Shir be resurrected once more. I shall scribe a note explaining the occurrences for you to deliver along with the crate to Spiritualist Roleko at the Vah Shir outpost in Grimling Forest");
...
#	plugin::Whisper("I hope your journey back to Shar Vahl is less eventful. Please make haste the spiritualists must receive this crate as soon as possible");
...
#	plugin::Whisper("Catch him and bring back that crate of skulls!");
