...
sub EVENT_ITEM{
	if(plugin::check_handin(\%itemcount, 31752 => 1)){
		plugin::Whisper("Ahh i see you're assisting Phenic. Perhaps looking into more information on [Valdanov Zefeer]?");
