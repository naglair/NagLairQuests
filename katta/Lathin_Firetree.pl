...
sub EVENT_ITEM{
	...
	if(plugin::check_handin(\%itemcount, 7273 => 1)){
		plugin::Whisper("Excellent, this figurine will work wonderfully. A group of my best summoners is gathering on the first floor at the largest of the summoning circles to call forth the shade. Please take the figurine to Theurgus Ajeea Polaja immediately.");
		quest::faction(206,10);
		quest::faction(168,10);
		quest::faction(350,10);
		quest::faction(284,-30);
