sub EVENT_SAY {
 if($text=~/hail/i){
  plugin::Whisper("I am Governor Kroldar Strongarm of Katta Castellum. It is my duty to command the Validus Custodus in matters of Warfare. The Empire 
...
[Coterie of the Eternal Night].");
  ...
  plugin::Whisper("The Coterie of the Eternal Night are not an enemy to be taken lightly. Our vampyre hunters must be dedicated to the annihilation of 
...
sub EVENT_ITEM {
 ...
 if(plugin::check_handin(\%itemcount, 2691 => 4)){
  #End of Vamprye Fang
  plugin::Whisper("You have dedicated yourself to the war with the Coterie of the Eternal Night. I will continue to reward you for the fangs of every 
