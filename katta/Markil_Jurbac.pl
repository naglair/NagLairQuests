sub EVENT_SAY {
  if ($text=~/hail/i) {
    plugin::Whisper("Greetings, $name. I am Governor Markil Jurbac. It is my primary duty to uphold the law in Katta Castellum. How may I be of assistance to you?");
  }
  sub EVENT_ITEM {
