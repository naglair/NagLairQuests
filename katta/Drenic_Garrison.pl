...
sub EVENT_ITEM {
 ...
 if(plugin::check_handin(\%itemcount, 10412 => 1, 10413 => 1, 10414 => 1, 10415 => 1)){
  ...
  plugin::Whisper("Excellent work, the Loyalist Empire is grateful for your assistance. Governor Maralicis and I will have our researchers resume their work on curing Luclin of its diseases.");
 ...
 if(plugin::check_handin(\%itemcount, 10416 => 3)){
  ...
  plugin::Whisper("Excellent work $name! The acquisition of these organs is a fantastic accomplishment!");
