...
sub EVENT_ITEM {
  ...
  if (plugin::check_handin(\%itemcount, 29860 => 1, 7810 => 1)) {
    plugin::Whisper("This is astounding, I find myself at a loss for words. You have done Katta a great justice, Sanctus Seru will never be the same now that the truth is known. Their leader has fallen.");
