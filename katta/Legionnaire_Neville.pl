...
if($text=~/Hail/i){
   ...
   plugin::Whisper("Ugh, I have not had such a cold as this since I was a boy. I have heard of a
...
if($text=~/tea maker/i){
   plugin::Whisper("ACHOO! Excuse me. It was some kind of root tea... saucy greyroot... sparkly
...
if(plugin::check_handin(\%itemcount,31772=>1)){
   plugin::Whisper("Thanks! $name, I hope this does the trick.");
   quest::ding();
   quest::exp(2000);
